...
<head>
    ...
    <link rel="icon" type="image/ico" sizes="16x16" href="../assets/images/TCP.png">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="../assets/images/users/<?php echo $_SESSION['em_image']; ?>" alt="Genit" class="profile-pic" style="height:40px;width:40px;border-radius:50px" /></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="" style="text-align: center;"><img src="../assets/images/users/<?php echo $_SESSION['em_image']; ?>" style="height: 100px;width: 100px;" alt="user"></div>
                                            <div class="u-text">
                                    ...
                                    <li><a href="../employee/view?I=<?php echo base64_encode($_SESSION['em_id']); ?>"><i class="ti-user"></i> My Profile</a></li>
                                    <?php //if($this->session->userdata('user_type')!='EMPLOYEE'){ ?>
                                    
                                    <li><a href="../settings/Settings"><i class="ti-settings"></i> Account Setting</a></li>
                                    <?php //} ?>
