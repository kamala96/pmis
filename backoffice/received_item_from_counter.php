      ...
      if (@$_GET['ask'] == "Bagclose") {
        ...
        if (empty($id)) {
          $warning = 'Please Select atleast one item to close in bag';
            ...
            $cat = "Domestic";
            $isBag = "isBag";
           $sqlsave = "INSERT INTO `bags` (`bag_number`, `bag_region`, `bag_branch`, `date_created`, `service_type`, `bag_region_from`, `bag_branch_from`, `despatch_no`, `bags_status`, `qr_image`, `bag_weight`, `bag_created_by`, `bag_received_by`, `ems_category`) VALUES ('".$bagsNo."','".$region."','','".date("Y-m-d h:i")."','EMS','".$_SESSION['o_region']."','".$_SESSION['o_branch']."','','".$status."','','".$weight."','".$_SESSION['em_id']."','','".$cat."')";
             $conn->query($sqlsave);
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <hr/>
                         <div class="row">
                        <div class="col-md-12">
                          <form action="search_item.php?em_id=<?php echo base64_encode($emid);?>&&ask=Received" method="POST">
                        ...
                        ?>
                         ...
                         <div class="table-responsive" style="">
                          <!-- <?php if(!empty($warning)){ ?>
                            ...
                            <?php } ?> -->
           <form method="POST" action="received_item_from_counter.php?em_id=<?php echo base64_encode($emid);?>&&ask=Bagclose">
                		...
                		<tbody>
                			<?php include_once('received_item_from_counter_action.php'); ?>
                		</tbody>
                		<!-- <tfoot>
                      <tr>
                        
                          <td colspan="5"></td>
                         <td colspan="" style="width: 10%"><input type="text" name="bag_weight" class="form-control" placeholder="Bag Weight" required=""></td>
                           
                        <td colspan=""><button class="btn btn-success form-control" style="color: white;" name="closebag" value="closebag">Close Bag</button></td>
                      </tr>
                    </tfoot> -->
                  		</table>
