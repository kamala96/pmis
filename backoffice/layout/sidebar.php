      ...
      //                   }else{}
                ...
                <div class="user-profile">
                    <!-- User profile image -->
                    <div class="profile-img"> <img src="../assets/images/users/<?php echo $basicinfo->em_image ?>" alt="user" />
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><span class="hide-menu">
                                            <img src="../assets/images/expend.png" width="20">  &nbsp;Kpi</span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="../employee/Disciplinary">Discharge </a></li>
                                <!--<li><a href="../employee/Inactive_Employee">Inactive Employees </a></li>-->
                                <li><a href="../employee/Retired_Employee">Retired Employee </a></li>
                                <li><a href="../employee/Agency_Employee">Agent Employee </a></li>
                            </ul>
                            ...
                            <ul aria-expanded="false" class="collapse">
								<li><a href="../leave/Holidays"> Holiday </a></li>
								<li><a href="../leave/leavetypes"> Leave Type</a></li>
								<li><a href="../leave/Application"> Leave Application </a></li>
<!--								<li><a href="--><?php //echo base_url(); ?><!--leave/Earnedleave"> Earned Leave </a></li>-->
								<li><a href="../leave/Leave_report"> Report </a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <!-- <li><a href="../leave/Holidays"> Holiday </a></li> -->
                                <li><a href="../Payroll/Salary_Payslip"> Salary Payslip </a></li>
                                <!-- <li><a href="../leave/EmLeavesheet"> Leave Sheet </a></li> -->
                    ...
                    <?php } ?>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="../employee/view?I=<?php echo base64_encode($basicinfo->em_id); ?>" aria-expanded="false">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><span class="hide-menu">
								...
								<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><span class="hide-menu">
                                            <img src="../assets/images/expend.png" width="20">  &nbsp;Imprest</span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li>
                                            <a href="<?php echo base_url('imprest/Expenditure_Application')?>">Add Imprest</a>
                                        </li>
                                        <li>
                                            <a href="../imprest/expenditure_List">Imprest List</a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <?php }  elseif($this->session->userdata('user_type') =='ADMIN'
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?php echo base_url();?>Notice/All_notice">Notice</a></li>
								<li><a href="<?php echo base_url();?>organization/Supervisor_attendence">Supervisor Attendence</a></li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="../employee/Employees">Employees </a></li>
                                <li><a href="../employee/Discharge">Discharge </a></li>
                                <li><a href="../employee/Retired_Employee">Retired Employee </a></li>
                                <li><a href="../employee/Agency_Employee">Agent Employee </a></li>
                            </ul>
                            <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-rocket"></i><span class="hide-menu">Leave </span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="../leave/leavetypes"> Leave Type</a></li>
                                <li><a href="../leave/Application"> Leave Application </a></li>
                                <li><a href="../leave/Leave_days"> Upate Leave Day </a></li>
                                <!-- <li><a href="../leave/Earnedleave"> Earned Leave </a></li> -->
                                <li><a href="../leave/Leave_report"> Report </a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-newspaper"></i><span class="hide-menu">Payroll </span></a>
                            <ul aria-expanded="false" class="collapse">
                                 <li><a href="../Payroll/Salary_Scale">Salary Scale </a></li>
                                <!-- <li><a href="../Payroll/Salary_Type"> Payroll Type </a></li> -->
                                <li><a href="../employee/Employees">Add Salary To Employee </a></li>
                                <li><a href="../Payroll/Salary_Slips">Salary Slips</a></li>
                                <li><a href="../Payroll/Salary_List"> Salary List </a></li>
                                <li><a href="../Payroll/Payed_Salary"> Payslip Report</a></li>
                                <li><a href="../Payroll/Payroll_Salary_list"> Payroll List</a></li>
                                  <li><a href="../Payroll/Payroll_report"> Payroll Report</a></li>
                                 <li><a href="../Payroll/Paye_Chart">Paye Chart</a></li>
                                 <li><a href="../Payroll/Pension_Chart">Pension Fund Chart</a></li>
                            </ul>
                        </li>
								<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><span class="hide-menu">
                                            <img src="../assets/images/expend.png" width="20">  &nbsp;Imprest</span></a>
                       ...
                       <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                                        <span class="hide-menu"><img src="../assets/images/slip.png" width="20"> &nbsp;My Payroll </span></a>
                                    <ul aria-expanded="false" class="collapse">
                                        <!-- <li><a href="../leave/Holidays"> Holiday </a></li> -->
                                        <li><a href="../Payroll/Salary_Payslip">
                                                Salary Payslip </a></li>
                                        <!-- <li><a href="../leave/EmLeavesheet"> Leave Sheet </a></li> -->
                                    </ul>
                                </li>
							...
							<?php }  elseif($this->session->userdata('user_type') =='RM' || $this->session->userdata('user_type') =='HOD' ){ ?>
								<li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Employees </span></a>
									<ul aria-expanded="false" class="collapse">
										<li><a href="../employee/Employees">Employees </a></li>
										<li><a href="../employee/Disciplinary">Disciplinary </a></li>
										<li><a href="../employee/Inactive_Employee">Inactive User </a></li>
										<li><a href="../employee/Retired_Employee">Retired Employee </a></li>
									</ul>
								</li>
                                <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><span class="hide-menu">
                    ...
                    <?php } ?>
						<?php if ($this->session->userdata('user_type') == 'HR-PAY'){?>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="../Payroll/Payroll_Salary_list"> Payroll List</a></li>
                                 <li><a href="../Payroll/Payroll_report"> Payroll Report</a></li>
                                <!-- <li><a href="../Payroll/Non_PercentD">Non Percentage Deduction</a></li>
                                <li><a href="../Payroll/Percent_Deduction">Percentage Deduction</a></li>
                                <li><a href="../Payroll/Loan_Deduction">Loan  Deduction</a></li> -->
                                 <li><a href="../Payroll/Paye_Chart">Paye Chart</a></li>
                                 <!-- <li><a href="../Payroll/Pension_Chart">Pension Fund Chart</a></li> -->
                            </ul>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                        <span class="hide-menu"><img src="../assets/images/setting.png" > &nbsp;Posts Services </span></a>
                        <?php  $id = $basicinfo->em_id;
                            ...
                            if (@$basicinfo->dep_id == '7') {
                                foreach ($data1 as $value) {
								echo "<ul aria-expanded='false' class='collapse'>
								 <li><a href='"; echo base_url(); echo "Box_Application/$value->serv_name'>$value->description</a></li>
								</ul>";
                            ...
                            ?>
                            <ul aria-expanded="false" class="collapse">
                             <li><a href="../Box_Application/<?php echo $value->serv_name ?>"><?php echo $value->description; ?></a></li>
                            </ul>
                            <?php
                            }
                            }
