                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="col-md-12">
                          ...
                          <form action="search_item.php?em_id=<?php echo base64_encode($emid);?>&&ask=Counter" method="POST">
                        ...
                        ?>
                         ...
                         <div class="table-responsive" style="">
                          <?php if(!empty($warning)){ ?>
                            ...
                            <?php } ?>
           <form method="POST" action="index.php?em_id=<?php echo base64_encode($_SESSION['em_id'])?>">
                    ...
                    <tbody>
                      ...
                      if ($_SESSION['role'] == 'EMPLOYEE' || $_SESSION['role'] == 'AGENT' || $_SESSION['role'] == 'SUPERVISOR') {
                                      ...
                                      $sql="SELECT * FROM `despatch` WHERE `despatch_status` = 'Sent' AND `region_from` = '$o_region' AND `branch_from` = '$o_branch' AND date(`datetime`) = '$date' ORDER BY `desp_id` DESC";

                                    }elseif ($_SESSION['role'] == 'RM') {

                                       $sql="SELECT * FROM `despatch` WHERE `despatch_status` = 'Sent' AND `region_from` = '$o_region'  AND  date(`datetime`) = '$date' ORDER BY `desp_id` DESC";

                                    }else {

                                       $sqld="SELECT * FROM `despatch` WHERE `despatch_status` = 'Sent' AND date(`datetime`) = '$date' ORDER BY `desp_id` DESC";

                                    }
                              
                      
                              $results = $conn->query($sqld);
                       ...
                       ?>
                       <tr>
                         <td><?php echo $rowd['desp_no'] ?></td>
                         <td><?php echo $rowd['region_to'] ?></td>
                         <td><?php echo $rowd['datetime'] ?></td>
                         <td><?php echo $rowd['transport_type'] ?></td>
                         <td><?php echo $rowd['transport_name'] ?></td>
                         <td><?php echo $rowd['registration_number'] ?></td>
                         <td><?php echo $rowd['despatch_status'] ?></td>
                    ...
                    <tfoot>
                      <tr>
                        <td colspan="7"></td>
                        <td colspan=""><button class="btn btn-success form-control" style="color: white;" name="receive" value="receive">Remove Item</button></td>
                      </tr>
                    </tfoot>
                      </table>
                  </form>
