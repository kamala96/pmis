...
public function Payslip_Create1(){
        ...
        for ($i=0; $i <@sizeof($id) ; $i++) {
            ...
            $data['othersDeductions'] = $this->payroll_model->Others_Employee_Deduction($salary_id,$emid);
            ...
            $PensionDeduction = $this->payroll_model->getPensionDeduction($salary_id,$emid);
            ...
            $this->payroll_model->insertPensionFundContributionPermonth($pension);
                ...
                if (!empty($lastInstallement)) {
                    ...
                    if ($lastInstallement->others_amount == 0) {
                     ...
                     $this->payroll_model->InsertLoansDeduction($data);
                        ...
                        //MWanzo wa nonTax code
                        $data['NonTaxDeductionInsert'] = $this->payroll_model->getNonPDeduction($salary_id,$id);
                    ...
                    foreach ($data['taxAddition'] as $value) {
                         ...
                         $dataTaxA = array(
                          ...
                          $this->payroll_model->addTaxAdditionPErMonth($dataTaxA);
                        }
                    //Mwisho

                    //Mwanzo NonTax Addition code
                    $data['NontaxAddition'] = $this->payroll_model->getNonTaxAddition($salary_id);

                    foreach ($data['NontaxAddition'] as $value) {
    ...
    public function Salary_Slip_Create(){
        ...
        $data['TaxAddition'] = $this->payroll_model->getTaxAddition($salary_id);
        //$data['NonTaxAddition'] = $this->payroll_model->getNonTaxAddition($salary_id);
        $data['Additional'] = $this->payroll_model->getAdditional($salary_id,$month,$year);
     ...
     foreach ($get as $value) {
        //echo $value->add_amount;
         ...
         $data = array(
          ...
          $this->payroll_model->Add_Emp_Fund($data);
     }
  }
