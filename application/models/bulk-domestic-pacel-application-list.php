                            ...
                            <tbody class="">
                               <?php foreach ($emslist as  $value) {?>
                                   <tr>
                                      ...
                                      <td> 
                                          <a href="#myModal234" class="btn btn-sm" data-toggle="modal" data-code='<?php echo $value->s_region; ?>'
                                              data-serial="<?php echo $value->serial; ?>" data-company="<?php echo $value->s_fullname; ?>"><?php echo $value->billid; ?></a>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" id="myModal234">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
...
$(function () {
  $('#myModal234').on('show.bs.modal', function (event) {
