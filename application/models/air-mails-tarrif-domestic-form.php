        ...
        <div class="row m-b-10">
                <div class="col-12">
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>parcel/air_mails_domestic_form" class="text-white"><i class="" aria-hidden="true"></i> Add Air Mails Transaction</a></button>
                     ...
                     <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>parcel/air_mails_tariff_domestic_form" class="text-white"><i class="" aria-hidden="true"></i> Add Air Mails Tarrif Transaction</a></button>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <div class="card">
                           <div class="card-body">
                           <form method="POST" action="<?php echo base_url()?>parcel/Save_air_mails_tariff_domestic">
                               <div id="div1">
                                <div class="row">
                         ...
                         <select name="StampDetails" value="" class="form-control custom-select StampDetails" required id="StampDetails">
                                        ...
                                        <option value="Aerogramme">Aerogramme & Post Cards</option>
                                          <option value="Printed Matter/Book Post">Printed matter & Book Post</option>
                                            <option value="News papers">News papers</option>
                                              <option value="Small packets/Sample/photocopy materials">Small packets,Sample,photocopy materials</option>
                                                <option value="Literature for the blind">Literature for the blind</option>
                                                <option value="Advertising">Advertising Mail</option>
                                    </select>
...
if (weight == '') {
    ...
    $.ajax({
                 type : "POST",
                 url  : "<?php echo base_url('Parcel/mailtarrif_price_vat')?>",
                 //dataType : "JSON",
                 data : {weight:weight,StampDetails:StampDetails},
