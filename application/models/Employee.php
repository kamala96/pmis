   ...
   public function GetDistrict(){
    ...
    public function Create_Salary()
    {
        if($this->session->userdata('user_login_access') != False) { 
            ...
            $data['sundry'] = $this->employee_model->GetSundryValue($sid);
    ...
    public function  Password_reset()
    {
        if($this->session->userdata('user_login_access') != False) {
           ...
           $data = array();
           $data = array('em_password'=>$password);
           ...
           echo json_encode($zone_id);
             ...
             for ($i=0; $i <@sizeof($zone_id) ; $i++) { 
                ...
                foreach ($get_region_byZone as $key => $value) {
                    $cs = array();
                    $cs = array('zone_id'=>$value->zone_id,'zone_regioncode'=>$value->region_code,'emid'=>$emid,'assign_to'=>$emid,'assign_status'=>'Assign');
