...
foreach ($query->result() as $row) {
	if (empty($result1)) {
		$output .= "&nbsp;<label>".$row->branch_name.'</label>  &nbsp;'."<input type='checkbox' id='vehicle1' name='branch[]' style='text-transform:uppercase;height:25px;width:25px;' value='".$row->branch_name."';
			        padding: 10px;' >".'      ';
	} else {
