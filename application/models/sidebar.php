...
<!--								<li><a href="--><?php //echo base_url(); ?><!--leave/Earnedleave"> Earned Leave </a></li>-->
                        ...
                        <?php } else { ?>
                         ...
                         <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false">
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url();?>employee/Agency_Employee">Agent List</a></li>
                    ...
                    <?php } ?>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-newspaper"></i><span class="hide-menu">Payroll </span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="<?php echo base_url(); ?>Payroll/Payroll_Salary_list"> Payroll List</a></li>
                    ...
                    <?php } ?>
                        ...
                        <?php  $id = $basicinfo->em_id;
                            ...
                            ?>
                            <ul aria-expanded="false" class="collapse">
                             <li><a href="<?php echo base_url(); ?>Box_Application/<?php echo $value->serv_name ?>"><?php echo $value->description; ?></a></li>
                            </ul>
                            }
