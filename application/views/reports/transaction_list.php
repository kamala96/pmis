...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i>  Transaction List</h3>
        </div>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">  Transaction List
                        </h4>
                    </div>
                    <div class="card-body" >
                      <div class="col-md-12">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" name="controlno" class="form-control " placeholder="Select control number">
