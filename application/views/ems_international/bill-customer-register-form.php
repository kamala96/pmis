        ...
        <div class="row m-b-10">
                <div class="col-12">
                    ...
                    <?php }if($this->session->userdata('user_type') == "ADMIN" || $this->session->userdata('user_type') == "ACCOUNTANT"){ ?>
                       ...
                       <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Ems_International_Bill/bill_customer_form?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Add Bill Customer</a></button>
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Ems_International_Bill/bill_customer_list?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Customer List</a></button>
                                ...
                                <label>Services Type:</label>
                                   <select class="form-control custom-select" name="service_type" required="">
                                    ...
                                    <option value="">--Select Service Type--</option>
                                        <option>EMS INTERNATIONAL</option>
                                   </select>
                                </div>
                                <div class="form-group col-md-4">
