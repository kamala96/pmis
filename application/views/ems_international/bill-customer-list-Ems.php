...
<div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor"><b><i class="fa fa-university" aria-hidden="true"></i>  EMS INTERNATIONAL Bill Customer List</b></h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active"><b>EMS INTERNATIONAL Bill Customer List</b></li>
                </ol>
            </div>
        </div>
        <div class="message">
                ...
                <div class="col-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white"><i class="fa fa-th-list" aria-hidden="true"></i><b>EMS INTERNATIONAL Bill Customer List </b><span class="pull-right " ></span></h4>
                        </div>
                        ...
                        <div class="input-group">
                           <input type="text" name="AskFor" class="form-control" value="EMS INTERNATIONAL" hidden="hidden">
                        ...
                        <tbody>
                           <?php if(isset($check) && ($check!==null)){?>
                            ...
                            <tr>
                                ...
                                <td><?php echo number_format($custprice->price,2);   ?></td>
                                <td>
                                <?php
                                ...
                                <?php if( $this->session->userdata('user_type') == "EMPLOYEE"|| $this->session->userdata('user_type') == "SUPERVISOR" || $this->session->userdata('user_type') == "AGENT"){ ?>
                                 ...
                                 <a href="<?php echo base_url()?>Ems_International_Bill/International_bulk_Ems?I=<?php echo base64_encode($value->credit_id)?>&AskFor=<?php echo $this->session->userdata('askfor')?>" class="btn btn-info"> Services</a>
                               ...
                               <?php } ?>
                                 ...
                                 <?php }else{ ?>
                                  ...
                                  <?php }else{?>
                                 <a href="<?php echo base_url()?>Ems_International_Bill/International_bulk_Ems?I=<?php echo base64_encode($value->credit_id) ?>" class="btn btn-info"> Services</a>
                               <?php } ?>
                                ...
                                <?php } ?>
                                |
                                  <a href="<?php echo base_url()?>Ems_International_Bill/bill_customer_form?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $this->session->userdata('askfor')?>" class="btn btn-info">Edit</a>
                                <?php }?> 
