...
<div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor"><b><i class="fa fa-university" aria-hidden="true"></i>  <?php echo $this->session->userdata('askfor');   ?> Bill Customer List</b></h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active"><b><?php echo $this->session->userdata('askfor');  ?> Bill Customer List</b></li> 
                </ol>
            </div>
        </div>
        <div class="message">
   ...
   <div class="card-body">
                        ...
                        <div class="input-group">
                           <input type="text" name="AskFor" class="form-control" value="<?php echo $this->session->userdata('askfor');  ?>" hidden="hidden">
                            ...
                            <tr>
                                ...
                                <?php if( $this->session->userdata('user_type') == "EMPLOYEE"|| $this->session->userdata('user_type') == "SUPERVISOR" || $this->session->userdata('user_type') == "AGENT"){ ?>
                                 ...
                                 <?php if($billtype == "Register" ){ ?>
                                    <a href="<?php echo base_url()?>Register_International/International_bulk_register?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $this->session->userdata('askfor'); ?>" class="btn btn-info">Services</a>
                                  <?php }elseif ($billtype == "Parcel") { ?>
                                      <a href="<?php echo base_url()?>Register_International/International_bulk_register?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $this->session->userdata('askfor'); ?>" class="btn btn-info">Services</a>
                                  <?php } else{?>

                                 <a href="<?php echo base_url()?>Register_International/International_bulk_register?I=<?php echo base64_encode($value->credit_id) ?>" class="btn btn-info">Services</a>
                               ...
                               <?php } ?>
                                ...
                                <?php } ?>
                                |
                                  <a href="<?php echo base_url()?>Register_International/bill_customer_form?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $this->session->userdata('askfor')?>" class="btn btn-info">Edit</a>
                                <?php }?> 
