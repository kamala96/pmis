        ...
        <div class="row m-b-10">
                <div class="col-12">
                    ...
                    <?php }if($this->session->userdata('user_type') == "ADMIN" || $this->session->userdata('user_type') == "ACCOUNTANT"){ ?>
                       ...
                       <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Register_International/bill_customer_form?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Add Bill Customer</a></button>
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Register_International/bill_customer_list?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Customer List</a></button>
