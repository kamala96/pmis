                ...
                <div class="col-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white"><i class="fa fa-th-list" aria-hidden="true"></i> Transactions List<span class="pull-right " ></span></h4>
                        </div>
                        <form action="transanctions" method="POST">
                            <table class="table-bordered" width="100%">
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <th>
                                            <button type="submit" class="btn btn-info form-control" style="color: white;">Search Report</button>
                                        </th>
                                </tr>
                            </table>
                            </form>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i; $i++;?></td>
                                <td><a href="vehicle_associated_with?controlno=<?php echo $value->billid;?>"><?php echo $value->billid;?></a></td>
