...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Stamp  Application Form</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Stamp  Application Form</li>
            </ol>
        </div>
    </div>
                ...
                <div class="col-12">
                    ...
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Stamp/Stamp_form" class="text-white"><i class="" aria-hidden="true"></i>Add Stamp Transaction </a></button>
                     <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>Stamp/Stamp_List" class="text-white"><i class="" aria-hidden="true"></i> Stamp Transaction List</a></button>
                       ...
                       <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Stamp/Franking_Stamp_form" class="text-white"><i class="" aria-hidden="true"></i>Add Franking  Machine Stamp </a></button>

                       <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Stamp/Franking_Stamp_List" class="text-white"><i class="" aria-hidden="true"></i>Franking  Machine Transaction List </a></button>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Stamp Form
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                           <div class="card-body">
                           <form method="POST" action="<?php echo base_url()?>Stamp/Save_stamp">
                               <div id="div1">
                                <div class="row">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="col-md-6">
                                <label>Stamp Details:<i style="color: blue;font-size:150%" >(No punctuation or special characters)</i></label>
                            <input type="text" name="StampDetails" class="form-control" id="StampDetails" pattern="[A-Za-z0-9]+" required="required">
