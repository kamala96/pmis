            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Stamp Cash List
                        </h4>
                    </div>
                    <div class="card-body" >
                      <div class="col-md-12">
                        <form action="Stamp_cash_List" method="POST">
                               ...
                               <tbody>
                                   <?php foreach ($list as $value) { ?>
                                       <tr>
                                           ...
                                           <td><?php echo $value->stamp_number; ?></td>
                                           ...
                                           <td>
                                            <?php 
                                                  ...
                                                  $total = intval(@$value->stamp_number) * intval(@$value->Customer_mobile);
