...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-shopping-bag" style="color:#1976d2"> </i> <?php echo @$productcode; ?> </h3>
		</div>
	...
	<div class="container-fluid">
		<div class="row m-b-10">
            ...
            <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>PostaStamp/products_dashboard" class="text-white"><i class="" aria-hidden="true"></i> Dashboard </a></button>
             ...
             <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>PostaStamp/stock_list?I=<?php echo base64_encode($categoryid); ?>" class="text-white"><i class="" aria-hidden="true"></i> List  <?php echo @$productcode; ?> </a></button>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i>   Add  <?php echo @$productcode; ?>  </h4>
                </div>
...
<input type="hidden" name="categoryid" value="<?php echo @$categoryid; ?>">
  ...
  <table class="table table-bordered">
    <thead>
       <tr>
           <th scope="col">  <?php echo @$productcode; ?>  </th>
