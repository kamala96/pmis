            ...
            <div class="card card-outline-info">
                           ...
                           ?>
                                    ...
                                    <tbody class="results">
                                     <?php $sn=1; foreach($list as $data){
                                        ...
                                        <a href="<?php echo site_url('PostaStamp/confirm_request');?>?I=<?php echo base64_encode($data->request_code);?>&status=<?php echo base64_encode('ApprovedByRM'); ?>" style="color:#fff"> <button class="btn btn-success"> Accept Request</a>
                                                     
                                        <a href="<?php echo site_url('PostaStamp/confirm_request');?>?I=<?php echo base64_encode($data->request_code);?>&status=<?php echo base64_encode('CanceledByRM'); ?>" style="color:#fff"> <button class="btn btn-info"> Cancel Request </a>

                                        <?php } ?>

                                        <?php if($this->session->userdata('user_type')=="SUPERVISOR"){ ?>

                                        <a href="<?php echo site_url('PostaStamp/confirm_request');?>?I=<?php echo base64_encode($data->request_code);?>&status=<?php echo base64_encode('ApprovedBySupervisor'); ?>" style="color:#fff"> <button class="btn btn-success"> Accept Request</a>
                                                     
                                        <a href="<?php echo site_url('PostaStamp/confirm_request');?>?I=<?php echo base64_encode($data->request_code);?>&status=<?php echo base64_encode('CanceledBySupervisor'); ?>" style="color:#fff"> <button class="btn btn-info"> Cancel Request </a>
                                        ...
                                        <a href="<?php echo site_url('PostaStamp/confirm_request');?>?I=<?php echo base64_encode($data->request_code);?>&status=<?php echo base64_encode('ApprovedByPMU'); ?>" style="color:#fff"> <button class="btn btn-success"> Accept Request</a>
                                                     
                                        <a href="<?php echo site_url('PostaStamp/confirm_request');?>?I=<?php echo base64_encode($data->request_code);?>&status=<?php echo base64_encode('CanceledByPMU'); ?>" style="color:#fff"> <button class="btn btn-info"> Cancel Request </a>
                                ...
                                <button title="Edit" class="btn btn-info waves-effect waves-light" data-toggle="modal" type="button" data-target="#pmu_update_modal<?php echo $data->request_code; ?>">  Issue Items </button>
                ...
                <?php $serial++; } ?>
                 ...
                 <!-- PMU Approve -->
                    ...
                    <form class="form-horizontal m-t-20" method="post" action="<?php echo site_url('PostaStamp/main_stock_approved_request');?>">
                    ...
                    <div class="col-md-2"> <strong> S/N </strong> </div> <div class="col-md-2"> <strong> Item </strong> </div> <div class="col-md-2"> <strong> Category </strong> </div>  <div class="col-md-2"> <strong> Quantity </strong> </div> <div class="col-md-2"> <strong> Available Qty </strong> </div> <div class="col-md-2"> <strong> New Quantity </strong> </div>
                     ...
                     <hr>
                    <?php $serial=1; foreach($listitems as $row){ 
                    $balance = $this->PostaStampModel->main_stock_details($row->stock_productid);
                    ?>
                ...
                <?php $serial++; } ?>
                    ...
                    <select class="form-control"  style="width:100%;" name="status" required>
                     <option value="Completed"> Confirm Request </option>
                      <option value="CanceledByStore"> Cancel Request </option>
                    </select>
                    </div>
                    </div>
