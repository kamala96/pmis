...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-wpforms" style="color:#1976d2"> </i>  Track Branch Stock  </h3> 
		</div>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                       ...
                       <form class="row" method="post" action="<?php echo site_url('PostaStamp/find_branch_stock_balance'); ?>">
                                    
                                    <div class="form-group col-md-6 m-t-10">
                                    <select name="branch" class="form-control" required>
                                    <option value=""> Choose Branch</option>
                                    <?php foreach($listbranch as $data){ ?>
                                    <option value="<?php echo $data->branch_name; ?>"> <?php echo $data->branch_name; ?> </option>
                                    <?php } ?>
                                    </select>
                                    </div>
