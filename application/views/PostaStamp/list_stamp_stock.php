	...
	<div class="container-fluid">
		<div class="row m-b-10">
         ...
         <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>PostaStamp/postastamp_dashboard" class="text-white"><i class="" aria-hidden="true"></i> Dashboard </a></button>
             ...
             <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>PostaStamp/stampstock" class="text-white"><i class="" aria-hidden="true"></i> Stamp (Stocks) </a></button>

             <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>PostaStamp/stampstock_list" class="text-white"><i class="" aria-hidden="true"></i> List Stock </a></button>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i>   Stamp List (Stock) </h4>
                </div>
                ...
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <button title="Edit" class="btn btn-sm btn-info waves-effect waves-light" data-toggle="modal" type="button" data-target="#update_modal<?php echo $data->stampstock_id; ?>">  <i class="fa fa-pencil-square-o"></i> </button>
                                              ...
                                              <a href="<?php echo base_url('PostaShop/delete_stock');?>?I=<?php echo base64_encode($data->stampstock_id); ?>" onclick='return del();' title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                    ...
                    <div class="col-6">
                    <label> Stamp </label>
                    <input class="form-control" type="number" name="qty" value="<?php echo @$data->stamp_name; ?>" required>
                    </div>
                    <div class="col-6">
                    <label> price </label>
                    <input class="form-control" type="number" name="purchaseprice" value="<?php echo @$data->price; ?>" required>
                    </div>
                    </div>
                    ...
                    <input class="form-control" type="number" name="price" value="<?php echo @$data->qty; ?>" required>
                    </div>
                     <div class="col-6">
                    <label> Total </label>
