...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
       ...
       <h3 class="text-themecolor"><i class="fa fa-money" style="color:#1976d2"></i> Sale Item </h3>
        </div>
...
<form  method="post" action="<?php echo site_url('PostaStamp/save_selling');?>">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('tbody').delegate('.productname', 'change', function () {
            ...
            $.ajax({
            type : "post",
            url  : "<?php echo site_url('PostaStamp/get_counter_stock_information');?>",
            data:'id='+id,
            dataType:'json',
