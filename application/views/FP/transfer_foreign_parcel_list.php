                ...
                <div class="row">
                   ...
                   <!-- <div class="card-header">
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Services/Despatch" class="text-white"><i class="" aria-hidden="true"></i> Despatch list </a></button>
                            ...
                            <form class="row" method="post" action="<?php echo site_url('FP_Application/item_foreign_parcel_transfer');?>">
 ...
 <div class="table-responsive" id="div1">
    ...
    <table  class="table table-hover table-bordered" cellspacing="0" width="100%">
        ...
        <tr style="font-size:12px ;">
            <th><b>Transfer from Foreign Parcel: </b><?php echo $info_assignedby->em_code; ?>  - <?php echo $info_assignedby->first_name.' '.$info_assignedby->middle_name.' '.$info_assignedby->last_name; ?> </th>
