            ...
            <div class="container-fluid">         
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <a href="<?php echo base_url(); ?>FP_Application/Receive" class="btn btn-primary waves-effect waves-light">Receive/Itemization</a>

                               <a href="<?php echo base_url(); ?>FP_Application/foreign_parcel_zone_pass?fromzone=Small_Packets" class="btn btn-primary waves-effect waves-light">Pass to Foreign parcel cage</a>
							...
							?>
                                  ...
                                  <form method="post" action="<?php echo base_url(); ?>FP_Application/print_foreign_parcel_reports">
...
function assignBagProcess(obj){
        ...
        if (rec_region && rec_branch && barcode) {
            ...
            if (barcode.length == 13) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>FP_Application/assign_item_general_process",
                    data:{
