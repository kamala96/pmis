                ...
                <div class="col-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white"><i class="fa fa-plus" aria-hidden="true"></i>  The Postmaster General Vs General Manager Corporate Resources Management <span class="pull-right " ></span></h4>
                        </div>
						...
						<!-- Contents -->
							...
							<div class="col-md-12">
							<div class="myBox">
							    <?php $this->load->view('contract/pmg_gmcrm/cover'); ?>
							</div>	
							...
							<div class="col-md-12">
							<div class="myBox">
							    <?php $this->load->view('contract/pmg_gmcrm/page1'); ?>
							</div>	
								...
								<strong style="color:#000;font-weight:bold;"> Page 1 out of 7 </strong>
                            </div> 
                            </div>
							<!-- Page 1 -->
							...
							<div class="col-md-12">
							<div class="myBox">
							    <?php $this->load->view('contract/pmg_gmcrm/page2'); ?>
							</div>	
								...
								<strong style="color:#000;font-weight:bold;"> Page 2 out of 7 </strong>
                            </div> 
                            </div>
							<!-- Page 2 -->
							...
							<div class="col-md-12">
							<div class="myBox">
							    <?php $this->load->view('contract/pmg_gmcrm/page3'); ?>
							</div>	
								...
								<strong style="color:#000;font-weight:bold;"> Page 3 out of 7 </strong>
                            </div> 
                            </div>
							<!-- Page 3 -->
							...
							<div class="col-md-12">
							<div class="myBox">
							    <?php $this->load->view('contract/pmg_gmcrm/page4'); ?>
							</div>	
								...
								<strong style="color:#000;font-weight:bold;"> Page 4 out of 7 </strong>
                            </div> 
                            </div>
							<!-- Page 4 -->
							...
							<div class="col-md-12">
							<div class="myBox">
							    <?php $this->load->view('contract/pmg_gmcrm/page5'); ?>
							</div>	
								...
								<strong style="color:#000;font-weight:bold;"> Page 5 out of 7 </strong>
                            </div> 
                            </div>
							<!-- Page 5 -->
							...
							<div class="col-md-12">
							<div class="myBox">
							    <?php $this->load->view('contract/pmg_gmcrm/page6'); ?>
							</div>	
								...
								<strong style="color:#000;font-weight:bold;"> Page 6 out of 7 </strong>
                            </div> 
                            </div>
							<!-- Page 6 -->
