...
<?php $this->load->view('backend/sidebar'); ?> 
         <div class="page-wrapper">
            ...
            <div class="container-fluid">         
										...
										?>
                                            <tr>
												...
												<?php if(!empty($data->attach_evidence)){?>
												 <button class="btn btn-success" data-toggle="modal" type="button" data-target="#view_attach_modal<?php echo $data->sub_activities_id; ?>"> <i class="fa fa-file"></i> View Evidence  </button>
												<?php } else {?>
												 <button class="btn btn-info" data-toggle="modal" type="button" data-target="#attach_modal<?php echo $data->sub_activities_id; ?>"> <i class="fa fa-file"></i> Attach Evidence  </button>
												<?php }?>
												</td>
				...
				<!-- Attach Assign Task -->
				        <div class="modal fade" id="attach_modal<?php echo $data->sub_activities_id; ?>" aria-hidden="true">
	                    <div class="modal-dialog modal-lg">
		                <div class="modal-content">
			                                   
                        <div class="modal-header">
                        <h5 class="modal-title mt-0" id="myLargeModalLabel"> Attach Evidence of <?php echo $data->sub_activity_name; ?> </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
		            ...
		            <input type="hidden" class="form-control"  name="subtaskid" value="<?php echo $data->sub_activities_id; ?>">
				 ...
				 <!-- VIEW Attached Assign Task -->
				        <div class="modal fade" id="view_attach_modal<?php echo $data->sub_activities_id; ?>" aria-hidden="true">
	                    <div class="modal-dialog modal-lg">
		                <div class="modal-content">
