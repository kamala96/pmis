         ...
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"> Employee General Performance Report  </h3>
                </div>
            ...
            <div class="container-fluid">         
                <div class="row">
					...
					<form class="row" method="post" action="<?php echo site_url('Contract/find_general_received_task_general_reports');?>">
                                    ...
                                    <table id="example4" class="display  table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										...
										?>
                                            <tr>
												...
												<td> 
                                                <a href="<?php echo site_url('Contract/view_find_receiver_task_performance_reports');?>?I=<?php echo base64_encode(@$empid);?>&F=<?php echo base64_encode(@$fromdate); ?>&T=<?php echo base64_encode(@$todate); ?>">
