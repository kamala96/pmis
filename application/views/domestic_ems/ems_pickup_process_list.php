...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Pick-up Office</h3>
    </div>
...
<script type="text/javascript">
    ...
    function getPassedItemsByOperator(obj){
        ...
        $.ajax({
            ...
            data:{
                ...
                removefunction:'removePickupPassedItem'},
            dataType:'json',
    ...
    function passToOperatorByzone(obj){
        ...
        if (operator) {
            ...
            if (barcode.length == 13) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>Box_Application/PassToOperatorByzone",
    ...
    function removePickupPassedItem(obj){
        ...
        $.ajax({
            type: "POST",
             url: "<?php echo base_url();?>Box_Application/removePickupPassedItem",
