...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Return letter office</h3>
    </div>
    ...
    <div class="col-md-2">
        <div class="col-md-12">
          <button type="button" class="btn btn-primary btn-block">
            ...
            <a href="<?php echo base_url() ?>Services/mails_zone_pass?fromzone=Return_letter_office" class="text-white"><i class="" aria-hidden="true"></i> Pass to zone</a>
        </button>
     </div>
    </div>
    <!-- <div class="col-md-2">
