...
<div class="page-wrapper">
   ...
   <div class="row page-titles">
      <div class="col-md-5 align-self-center">
         <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i>
      ...
      <div class="container-fluid">
         <div class="row m-b-10">
            <div class="col-12">
               <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a
                  href="<?php echo base_url() ?>Ems_Domestic/document_parcel" class="text-white"><i class=""
                  aria-hidden="true"></i> <?php echo $this->session->userdata('heading') ?> Transaction</a></button>
                  <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a
                     href="<?php echo base_url() ?>Box_Application/Ems_Application_List" class="text-white"><i class=""
                     aria-hidden="true"></i> <?php echo $this->session->userdata('heading') ?> Transactions
                  List</a></button>
                  <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a
                     href="<?php echo base_url() ?>Bill_Customer/bill_customer_list?AskFor=Ems" class="text-white"><i
                     class="" aria-hidden="true"></i> <?php echo $this->session->userdata('heading') ?> Bill
            ...
            <!--  <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Box_Application/Credit_Customer" class="text-white"><i class="" aria-hidden="true"></i> Create Bill Customer</a></button>
               ...
               <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a
                  href="<?php echo base_url() ?>Ems_Domestic/bulk_document_parcel" class="text-white"><i class=""
                  aria-hidden="true"></i> Bulk <?php echo $this->session->userdata('heading') ?> Transaction
               </a></button>
               <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a
                  href="<?php echo base_url() ?>Ems_Domestic/transfered_item_list" class="text-white"><i class=""
                  aria-hidden="true"></i> Transfered Item List </a></button>
               </div>
            </div>
            <div class="row">
               <div class="col-12">
                  <div class="card card-outline-info">
                     ...
                     <div class="card-body">
                        ...
                        <div style="display: none; font-size: 25px;background-color: #d22c19;color: white;" id="forMessage"
                        ...
                        <!-- <form action="document_parcel_save" method="POST" id="wixy"> -->
                           <div class="row col-md-12">
                              <div class="col-md-3">
                                 ...
                                 <input onchange="validateBarcode(this)" type="text" name="Barcode"
                                 class="form-control Barcode" id="Barcode" />
                              ...
                              <div id="div1">
                                 <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                       ...
                                       <select name="emsname" value="" class="form-control custom-select" required
                                       id="boxtype">
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <span id="selectEMSCat"></span>

                                 <!--    <select name="emscattype" value="" class="form-control custom-select catid"
                                    id="tariffCat" required="required" onChange="getEMSType();">
                                    <option value="0">--Select Category--</option>


                                    <m?Pkhpp foreach($ems_cat as $value): ?>
                                    <option value="<m?Pkhpp echo $value->cat_id ?>"><m?Pkhpp echo $value->cat_name ?></option><m?Pkhpp endforeach; ?>
                              </select> -->
                           ...
                           <div class="col-md-4">
                              ...
                              name="weight" class="form-control catweight" id="weight" onkeyup="getPriceFrom()" />
                           ...
                           <div id="div2" style="display: none;">
                              <div class="row">
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <select class="form-control custom-select address" id="addressselect"
                                    onchange="getAddress();" name="add_type_sender" required="required">
                              ...
                              <div class="col-md-3 virtual" style="display: none;">
                                 ...
                                 <input type="mobile" name="s_mobilev" id="sender_mobile"
                                 class="form-control pn1 s_mobilev" onkeyup="ShowDetails1();">
                           ...
                           <div id="div3" style="display: none;">
                              <div class="row">
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    <select class="form-control custom-select address1" id="addresrselect"
                                    onchange="getAddress1();" name="add_type_receiver">
                                    <option value="0">--Select Address--</option>
                                    <option value="physical">Physical Box</option>
                                    <option value="virtual">Virtual Box</option>
                                 </select>
                              ...
                              <div class="col-md-3 virtual1" style="display: none;">
                                 ...
                                 <input type="mobile" name="r_mobilev" id="r_mobile" class="form-control pn r_mobilev"
                                 onkeyup="ShowDetails();">
                              ...
                              <div class="col-md-3 physical1" style="display: none;">
                                 ...
                                 <span id="regionList"></span>


                             <!--     <select name="region_to" value="" class="form-control custom-select region_to"
                                 id="rec_region" onChange="getRecDistrict();">
                                 <option value="">--Select Region--</option>
                                 <s?phhp  foreach($regionlist as $value): ?>
                                 <option value="<s?phhp  echo $value->region_name ?>"><s?phhp echo $value->region_name ?>
                              </option>
                           <s?phhp endforeach; ?>
                        </select> -->
                     ...
                     <div class="col-md-3 physical1" style="display: none;">
                        ...
                        <select name="district" value="" class="form-control custom-select district"
                        id="rec_dropp">
               ...
               <div class="row">
                              <!--
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <button onclick="saveInformations()" class="btn btn-info disable" type="button"
                                    id="submitform">Save Information</button>
...
function saveInformations() {
   ...
   var addressselect = $('#addressselect').val();
         ...
         $.ajax({
            type: "POST",
            url: "<?php echo base_url('Ems_Domestic/ems_document_parcel_save')?>",
            dataType: "JSON",
            data: {
               Dpprice: Dpprice,
               Dpvat: dpvat,
      ...
      $(document).ready(function(){
       ...
       $.ajax({ 
         url: "<?php echo base_url();?>Ems_Domestic/document_parcel_ajax_select",
         type: 'GET',
         dataType: "html",
         success: function(response){
       ...
       $.ajax({ 
         url: "<?php echo base_url();?>Ems_Domestic/document_parcel_ajax_regionList",
         type: 'GET',
         dataType: "html",
         success: function(response){
