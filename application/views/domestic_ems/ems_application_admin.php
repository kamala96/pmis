 ...
 <div class="row">
    <div class="col-12">
        <div class="card card-outline-info">
            ...
            <?php  if($this->session->userdata('user_type') == "ADMIN") {?>
                                   <form action="Ems_application_admin" method="POST">
                                <tr>
                                    <th style="">
                                    ...
                                    <select name="region" value="" class="form-control custom-select" id="rec_region" onChange="getRecDistrict();">
                                      ...
                                      <select name="branch" value="" class="form-control custom-select"  id="rec_dropp" onChange="getEmployee();">
                                          <option value="">--Select Branch--</option>
                                      </select>

                                       <select name="empcode" value="" class="form-control custom-select"  id="empcode" >
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    var val = $('#rec_dropp').val();
     $.ajax({
     type: "POST",
      url: "<?php echo base_url();?>Box_Application/GetEmployee",
     data:'brandname='+ val,
     success: function(data){
         $("#empcode").html(data);
     }
