...
<div class="container-fluid">
    <div class="col-lg-12 col-md-12">
        <div class="row">
            <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Services/InWard_mails" class="text-white"><i class="" aria-hidden="true"></i> Mails InWard list</a></button>  
    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-success" href="<?php echo base_url();?>Services/InWard_mails" class="text-white"><i class="" aria-hidden="true"></i> Submit </a>
                  </td></tr>
                        </tbody>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    function getPassedItemsByOperator(obj){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>Box_Application/getMailsPassedItemsByOperator",
    ...
    function passToOperatorByzone(obj){
        ...
        if (operator) {
            ...
            if (barcode.length == 13) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>Box_Application/InwardMailsPassToOperatorByzone",
