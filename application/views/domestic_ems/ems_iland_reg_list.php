...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Inland registration Office</h3>
    </div>
...
<div class="container-fluid">
 ...
 <div class="row">
    <div class="col-md-7">
        <div class="row">
            <div class="col-md-2">
          <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Services/mails_zone_pass?fromzone=InLand_reg" class="text-white"><i class="" aria-hidden="true"></i> Pass to zone</a>
          </button>
        </div>
        <div class="col-md-2">
          <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Box_Application/item_mails_transfer?fromzone=InLand_reg" class="text-white"><i class="" aria-hidden="true"></i> Item transfer</a>
          </button>
        </div>
        </div>
        ...
        <div class="card card-outline-info">
            ...
            <div class="container-fluid">
                <div class="row m-b-10">
                    <div class="col-12">
                      <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Services/InLand_reg" class="text-white"><i class="" aria-hidden="true"></i> Back to list</a></button>
                 </div>
             </div>
