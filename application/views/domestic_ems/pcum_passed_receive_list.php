...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> PCUM receive Office</h3>
    </div>
...
<script type="text/javascript">
    function getListFromZone(operatorId){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo base_url();?>Box_Application/get_pcum_sentList",
            data: 'emid='+pfnumber,
            dataType:'json',
    ...
    function scanforReceive(obj) {
        ...
        if (barcode.length == 14) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>Box_Application/pcum_sent_receive",
