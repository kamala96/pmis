            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table id="example4" class="display nowrap table table-bordered fromServer2 receiveTable" cellspacing="0" width="100%">
                        ...
                        <tbody class="">
                            <tr><td colspan="7"></td><td style="float: right;">
                <a class="btn btn-success" href="<?php echo base_url(); ?>Services/Distributer" class="text-white"><i class="" aria-hidden="true"></i> Submit </a>
                    </td></tr>
                        </tbody>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    function getPassedItemsByOperator(obj){
        ...
        $.ajax({
            ...
            data:{
                ...
                forditributer:'yes',
                removefunction:'removeDistributerPassedItems'},
            dataType:'json',
    ...
    function passToOperatorByzone(obj){
        ...
        if (operator) {
            ...
            if (barcode.length == 13) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>Box_Application/DistributerPassToOperatorByzone",
    ...
    function removeDistributerPassedItem(obj){
        ...
        $.ajax({
            type: "POST",
             url: "<?php echo base_url();?>Box_Application/removeDistributerPassedItem",
