...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> <?php echo $this->session->userdata('service_type'); ?> Delivered</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active"><?php echo $this->session->userdata('service_type'); ?> Delivered </li>
        </ol>
    </div>
</div>
...
<div class="container-fluid">
    <div class="row m-b-10">
        <div class="col-12">
         <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url()?>Ems_Domestic/Incoming_Item?AskFor=<?php echo $this->session->userdata('service_type'); ?>" class="text-white"><i class="" aria-hidden="true"></i> Incomming Item</a></button>

                     <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url()?>Ems_Domestic/Assigned_Delivery_Item?AskFor=<?php echo $this->session->userdata('service_type'); ?>" class="text-white"><i class="" aria-hidden="true"></i> Assigned Item</a></button>

                      <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url()?>Ems_Domestic/Delivered_Item?AskFor=<?php echo $this->session->userdata('service_type'); ?>" class="text-white"><i class="" aria-hidden="true"></i> Delivered Item</a></button>
