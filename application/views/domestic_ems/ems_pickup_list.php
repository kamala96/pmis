...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> EMS Pickup list</h3>
    </div>
...
<div class="container-fluid">
    <div class="row m-b-10">
        <div class="col-2">
            <button type="button" class="btn btn-primary btn-block"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Services/Pickup_pass" class="text-white"><i class="" aria-hidden="true"></i> Pass to zone</a></button>
        </div>

        <div class="col-2">
            <button type="button" class="btn btn-primary btn-block"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Ems_Domestic/bill_dashboard" class="text-white"><i class="" aria-hidden="true"></i> Bill transaction</a></button>
        </div>    
 </div>
    ...
    <div class="col-12">
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="m-b-0 text-white"> Ems Bill Application (Pickup) List  <span style="float: right;">
