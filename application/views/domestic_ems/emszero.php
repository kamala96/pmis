                           ...
                           <form method="POST" action="<?php echo base_url()?>Ems_Domestic/Save_Emszero">
                            ...
                            <input type="text" name="custname" class="form-control" id="custname" >
                                ...
                                <span id="error1" style="color: red;"></span>
                                 ...
                                 <div class="col-md-3">
                                <label>Amount:</label>
                            <input type="number" name="Amount" class="form-control catweight" id="Amount" step="any">
                                <span id="weight_error" style="color: red;"></span>
                                 ...
                                 <div class="col-md-3">
                                    <label>Envoice Details</label>
                                    <input type="text" name="invoiced" id="invoiced" class="form-control">
                                    <span id="errinvoiced" style="color: red;"></span>
                                </div>
