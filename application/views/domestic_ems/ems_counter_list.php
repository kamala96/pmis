...
<div class="container-fluid">
    <div class="row m-b-10">
        <div class="col-12">
          ...
          <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Ems_Domestic/cash_dashboard" class="text-white"><i class="" aria-hidden="true"></i> Cash</a></button>

        <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Ems_Domestic/bill_dashboard" class="text-white"><i class="" aria-hidden="true"></i> Bill</a></button>

        <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Ems_International/Ems_International_Application_List" class="text-white"><i class="" aria-hidden="true"></i> International</a></button>
                                ...
                                <tr>
                                    <th style="">
                                         <div class="input-group">
                                            ...
                                            <input id="fromdate" type="text" name="fromdate" class="form-control  mydatetimepickerFull" placeholder="Fromdate">

                                            <input id="todate" type="text" name="todate" class="form-control  mydatetimepickerFull" placeholder="Todate">

                                            <button onclick="getApplicationList('fromdate','todate')" type="submit" class="btn btn-success" style="">Search Date<button>
            ...
            <!-- <form method="POST" action="<?php echo base_url();?>Box_Application/send_to_back_office"> -->
                ...
                <div class="table-responsive">
                    ...
                    <?php }else{ ?>
                        ...
                        echo "<input type='checkbox' name='transactions' class='form-check-input checkSingle' id='remember-me' value='$value->id'>
...
<tr>
    <td colspan="14"></td>
    <td>
        <span class="table2" style="display: block;">
            <button onclick="sendToDistributer(this)" class="btn btn-primary">Send to Distributer >></button>
        </span>
    </td>
</tr>
...
function getApplicationList(fromdate,todate){
    ...
    $.ajax({
        type:"POST",
        url:"<?php echo base_url();?>Box_Application/get_em_counter_searchList",
...
function sendToDistributer (obj){
    var transactions  = [];

     $.each($("input[name='transactions']:checked").not(":disabled"), function(){
     ...
     $.ajax({
        type:'post',
        url:"<?php echo base_url();?>Box_Application/send_to_distributer_office",
        data: {transData: transactions},
        dataType:'json',
        success:function(response){
            if (response['status'] == 'Success') {
                $('#loadingtext').html(response['msg']);
                ...
                //remove the
                $.each(response['trans'],function(index,data){
                    $('.tr'+data).remove();
                });
