      ...
      <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <a href="<?php echo base_url()?>Ems_Domestic/cash_dashboard" class="text-muted m-b-0">Cash</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <!--  -->
                                    <a href="<?php echo base_url()?>Ems_Domestic/bill_dashboard" class="text-muted m-b-0">Bill</a>
                                        </div>
                                </div>
                            </div>
                        </div>
...
FusionCharts.ready(function () {
            ...
            var chart = new FusionCharts({
                ...
                { label: "<?php echo $value->year; ?>", value: "<?php if($this->session->userdata('user_type') == "EMPLOYEE" || $this->session->userdata('user_type') == "AGENT"){
                 echo $value->value;
                }else{
                    echo $value->value;
                }  ?>" },
