         ...
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><?php echo str_replace('_', ' ', $fromzone); ?> Transfer/Passing  </h3>
                </div>
                ...
                <div class="row">
                   ...
                   <!-- <div class="card-header">
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Services/Despatch" class="text-white"><i class="" aria-hidden="true"></i> Despatch list </a></button>
                            ...
                            <form class="row" method="post" action="<?php echo site_url('Box_Application/item_mails_transfer');?>">

                                    <div class="form-group col-md-3 m-t-10">
                                        <input type="hidden" name="fromzone" value="<?php echo $fromzone;?>">
                                        <input type="hidden" name="print_status" value="<?php echo $print_status;?>">
                                    ...
                                    <?php foreach ($sectiondata as $key => $value){ ?>
                                        ...
                                        <?php } else if ($fromzone == 'InWard_open'){ ?>


                                            <?php if ($value['id'] != 7 && $value['id'] != 20 && $value['id'] != 21){ ?>
                                                <option value="<?php echo $value['id']?>"><?php echo $value['name']?></option>
                                            <?php } ?>
 ...
 <div class="table-responsive" id="div1">
    ...
    <table  class="table table-hover table-bordered" cellspacing="0" width="100%">
        ...
        <?php if ($fromzone == 'InLand_reg') {?>
            ...
            <th><b>Transfer from <?php echo $selected_section; ?>: </b><?php echo $info->em_code; ?>  - <?php echo $info->first_name.' '.$info->middle_name.' '.$info->last_name; ?> </th>
             <th><b>Office : </b><?php echo $info->em_branch;?> </th>
            </tr> 

            <tr style="font-size:12px ;">
                <th><b>Received By <?php echo $current_scetion;?>: </b><?php echo $info_assignedby->em_code; ?>  - <?php echo $info_assignedby->first_name.' '.$info_assignedby->middle_name.' '.$info_assignedby->last_name; ?> </th>
        ...
        <?php }else if($fromzone == 'mails_counters'){ ?>
            ...
            <tr style="font-size:12px ;">
                <th><b>Transfer from <?php echo $current_scetion;?>: </b><?php echo $info_assignedby->em_code; ?>  - <?php echo $info_assignedby->first_name.' '.$info_assignedby->middle_name.' '.$info_assignedby->last_name; ?> </th>
                 <th><b>Office : </b><?php echo $info_assignedby->em_branch;?> </th>
            </tr>

            <tr style="font-size:12px ;">; 
                <th><b>Received By <?php echo $selected_section; ?>: </b><?php echo $info->em_code; ?>  - <?php echo $info->first_name.' '.$info->middle_name.' '.$info->last_name; ?> </th>
                 <th><b>Office : </b><?php echo $info->em_branch;?> </th>
            </tr> 
