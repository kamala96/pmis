...
<style type="text/css">
            ...
            <div class="container-fluid">         
                <div class="row">
                   ...
                   <div class="card-header">
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Services/Distributer" class="text-white"><i class="" aria-hidden="true"></i> Distributer list </a></button>
                    </div>
                            ...
                            <form class="row" method="post" action="<?php echo site_url('Box_Application/item_transfer_distributer');?>">
 ...
 <div class="table-responsive" id="div1">
    ...
    <table  class="table table-hover table-bordered" cellspacing="0" width="100%">
        ...
        <?php if ($operator_zone == 1){ ?>


            <tr style="font-size:12px ;">
                <th><b>Transfer from Counter: </b><?php echo $info->em_code; ?>  - <?php echo $info->first_name.' '.$info->middle_name.' '.$info->last_name; ?> </th>
                 <th><b>Office : </b><?php echo $info->em_branch;?> </th>
            </tr> 

            <tr style="font-size:12px ;">
                <th><b>Received By Distributer: </b><?php echo $info_assignedby->em_code; ?>  - <?php echo $info_assignedby->first_name.' '.$info_assignedby->middle_name.' '.$info_assignedby->last_name; ?> </th>
        ...
        <?php }else{ ?>
             ...
             <tr style="font-size:12px ;">
                <th><b>Transfer from Distributer: </b><?php echo $info_assignedby->em_code; ?>  - <?php echo $info_assignedby->first_name.' '.$info_assignedby->middle_name.' '.$info_assignedby->last_name; ?> </th>
                 <th><b>Office : </b><?php echo $info_assignedby->em_branch;?> </th>
            </tr>
