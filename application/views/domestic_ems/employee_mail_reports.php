         ...
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"> MAILS Cash Transaction Report  </h3>
                </div>
            ...
            <div class="container-fluid">         
                <div class="row">
                   ...
                   <div class="card-header">
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Ems_Domestic/employee_mail_view_reports" class="text-white"><i class="" aria-hidden="true"></i>  Cash Transaction Report </a></button>
                    
                     <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Ems_Domestic/employee_trans_mail_bill_reports" class="text-white"><i class="" aria-hidden="true"></i>  Bill Transaction Report  </a></button>

                      <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Bill_Customer/bill_customer_list?AskFor=MAILS" class="text-white"><i class="" aria-hidden="true"></i>  Bill Receipt  </a></button>
                            ...
                            <form class="row" method="post" action="<?php echo site_url('Ems_Domestic/employee_report_mail_results');?>">
...
<br>
<h3> <strong> CASH TRANSACTIONS </strong> </h3>
</div>
