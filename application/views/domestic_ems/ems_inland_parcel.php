...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Inland parcel Office</h3>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row">
                        <div class="round align-self-center round-warning"><img src="<?php echo base_url()?>assets/images/box.png" width="40"></div>
                        <div class="m-l-10 align-self-center">
    ...
    <div class="col-md-2">
        <div class="col-md-12">
          <button type="button" class="btn btn-primary btn-block">
            ...
            <a href="<?php echo base_url() ?>Services/mails_zone_pass?fromzone=InLand_parcel" class="text-white"><i class="" aria-hidden="true"></i> Pass to zone</a>
        </button>
     </div>
    </div>
    <div class="col-md-2">
