         ...
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"> Delivery Registered (RDP,FPL) Report  </h3>
                </div>
                ...
                <div class="row">
                   ...
                   <div class="card-header">
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Ems_Domestic/employee_reports_dashboard" class="text-white"><i class="" aria-hidden="true"></i>  Report Dashboard </a></button>
                            ...
                            <form class="row" method="post" action="<?php echo site_url('Ems_Domestic/deliver_int_report_results');?>">
...
<br>
<h3> <strong> <?php echo strtoupper($status); ?> DELIVERY (RDP,FPL) REPORT  </strong> </h3>
</div>
