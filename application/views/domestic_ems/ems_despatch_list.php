...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Despatch Office</h3>
    </div>
...
<div class="container-fluid">
 ...
 <div class="row col-md-12">
    ...
    <div class="col-md-2">
        <a class="btn btn-primary" style="width:100%" href="<?php echo base_url() ?>Services/Despatch_pass" class="text-white"><i class="fa fa-list"></i> Pass to zone</a>
    </div>
    <div class="col-md-2">
        <a class="btn btn-primary" style="width:100%" href="<?php echo base_url() ?>Box_Application/passTodelivery?from=dispatch_section" class="text-white"><i class="fa fa-list"></i> Pass to delivery</a>
    </div>
 </div>
        ...
        <div class="card card-outline-info">
            ...
            <div class="container-fluid">
                <div class="row m-b-10">
                    <div class="col-12">
                      <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Services/Despatch" class="text-white"><i class="" aria-hidden="true"></i> <?php echo $this->session->userdata('heading') ?> Back to list</a></button>
                 </div>
             </div>
...
<script type="text/javascript">
    function getListFromZone(operatorId){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo base_url();?>Box_Application/get_despatch_sentList",
            data: 'emid='+pfnumber,
            dataType:'json',
    ...
    function scanforReceive(obj) {
        ...
        if (barcode.length == 13) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>Box_Application/despatch_receive",
