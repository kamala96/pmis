            ...
            <div class="container-fluid">         
                <div class="row">
                   ...
                   <div class="card-header">
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Services/InWard" class="text-white"><i class="" aria-hidden="true"></i> InWard list </a></button>
                    </div>
                            ...
                            <form class="row" method="post" action="<?php echo site_url('Box_Application/item_transfer_inward');?>">
 ...
 <div class="table-responsive" id="div1">
    ...
    <table  class="table table-hover table-bordered" cellspacing="0" width="100%">
        ...
        <tr style="font-size:12px ;">
            <th><b>Transfer from InWard: </b><?php echo $info_assignedby->em_code; ?>  - <?php echo $info_assignedby->first_name.' '.$info_assignedby->middle_name.' '.$info_assignedby->last_name; ?> </th>
