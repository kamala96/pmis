    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                     ...
                     <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>services/pcum_pass" class="text-white"><i class="" aria-hidden="true"></i> Pass to zone</a></button>
                        ...
                        <div class="card">
                           ...
                           <div class="card-body">
                            <div id="div1">
                                ...
                                <div class="col-md-6">
                               <input type="hidden" name="AgreedWeight" class="AgreedWeight" value="<?php echo @$credit->AgreedWeight; ?>">
                                <input type="hidden" name="Agreedprice" class=" Agreedprice" value="<?php echo @$credit->Agreedprice; ?>">
...
var Agreedprice  = $('.Agreedprice').val();
  ...
  var price  = Agreedprice;
    ...
    var result="<table style='width:100%;color:#c31f26;' class='table table-bordered'>"+
                ...
                "<tr><td><b>Total Price:</b></td><td>"+price+"</td></tr>"+
                "</table>";
    ...
    $(document).ready(function() {
        ...
        if ($('#boxtype').val() == 0) {
            ...
            if ($('#tariffCat').val() == 0) {
                ...
                $('#barcode_error').html('Please enter barcode');
            }
            else{
                $('#div2').show();
                $('#div1').hide();
