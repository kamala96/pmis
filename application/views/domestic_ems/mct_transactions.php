...
<?php $this->load->view('backend/sidebar'); ?> 
         ...
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"> Medical Council of Tanganyika (MCT) Transaction  </h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active"> MCT </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container-fluid">         
                <div class="row">
                    ...
                    <div class="card card-outline-info">
                            ...
                            <form class="row" method="post" action="<?php echo site_url('Ems_Domestic/mct_trans_results');?>">
 ...
 <?php if(isset($list)){ ?>
                    ...
                    <form class="form-horizontal m-t-20" method="post" action="<?php echo site_url('Box_Application/update_mct_trans'); ?>">
