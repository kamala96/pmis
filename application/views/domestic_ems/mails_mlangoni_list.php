...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> <?php echo $current_section; ?> Office</h3>
    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url('Posta_Mlangoni/bill_customer_list?AskFor=Posta Mlangoni')?>" class="text-muted m-b-0">Posta Mlangoni Bill</a>
                                    </div>
                                </div>
                            </div>
                        </div>
 ...
 <div class="row">
    <div class="col-md-7">
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="col-md-2">
              <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Box_Application/passTodeliveryMails?fromzone=<?php echo $current_section;?>" class="text-white"><i class="" aria-hidden="true"></i> Pass to delivery</a></button>
            </div>
            </div>
           ...
           <!--  <div class="col-md-2">
            ...
            <div class="col-md-2">
              <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Box_Application/item_mails_transfer?fromzone=mails_counters&print_status=IN" class="text-white"><i class="" aria-hidden="true"></i> Item transfer</a></button>
            </div>
 -->
            <?php if ($current_section == 'Counter parcel'){ ?>

                <div class="col-md-2">
                  <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Packet_Application/packet_cage?fromzone=Small_Packets" class="text-white"><i class="" aria-hidden="true"></i> Small packet Cage</a></button>
                </div>
