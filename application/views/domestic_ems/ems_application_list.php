...
<div class="page-wrapper">
    ...
    <!-- Container fluid  -->
    <!-- ============================================================== -->
    <!-- // <u?php $regionlist = $this->employee_model->regselect(); ?> -->
                                ...
                                <th>
                                  ...
                                  <!-- <select name="district_to" value="" class="form-control custom-select"  id="employeeattended" required="required">  
                                   ...
                                   <!--  <select class="form-control custom-select emname" >
                                      ...
                                      <option value="<g?php echo $value->em_id ?>"><g?php echo $value->first_name.'    '.$value->middle_name.'    '.$value->last_name ?></option>
                                    <g?php }?>
                                    </select> -->
                                </div>
                            </th>
                           <!--  <th>
                                 ...
                                 <div class="input-group">
                                    <select class="form-control custom-select agname">
                                      ...
                                      <g?php foreach($agselect as $value){?>
                                      <option value="<g?php echo $value->em_id ?>"><g?php echo $value->first_name.'    '.$value->middle_name.'    '.$value->last_name ?></option>
                                    <g?php }?>
                                    </select>
                                </div>
      ...
      <tr>
        ...
        <?php if($this->session->userdata('user_type') == 'SUPERVISOR'){?>
          ...
          <?php }else{ ?>
            ...
            <td colspan="12" style="text-align: right;"><button type="submit" class="btn btn-info">Back Office >>> </button>
            </td>
            <?php } ?></tr>
        </table>
    <?php }?>
...
<!-- <script type="text/javascript">
    $(document).ready(function(){
        $.ajax({ 
            url: "<g?php echo base_url();?>Box_Application/Ems_Application_List_ajax_regionList",
            type: 'GET',
            dataType: "html",
            success: function(response){
                $("#regionList2").html(response);
           // console.log(response);
       }
   });
    });
