...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Mails InWard Office</h3>
    </div>
 ...
 <div class="row">
    ...
    <div class="col-md-2">
        <div class="col-mdd-12">
            <button type="button" class="btn btn-primary">
                <i class="fa fa-list"></i>
                <a href="<?php echo base_url() ?>Packet_Application/Receive_passed_mails_item" class="text-white"><i class="" aria-hidden="true"></i> Receive passed Small packet</a>
            </button>
        </div>
    </div>
