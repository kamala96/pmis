...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Mails Zone passing Process</h3>
    </div>
                                  ...
                                  <select onchange="getOperatorByZone(this)" class="form-control custom-select js-example-basic-multiple zonetype bulk" id="zonetype" name="operator_zone">
                                    ...
                                    <?php foreach ($sectiondata as $key => $value){ ?>
                                        ...
                                        <?php } else if ($fromzone == 'mails_counters'){?>
                                             ...
                                             <?php if ($value['id'] == 14 || $value['id'] == 9){ ?>

                                            <option value="<?php echo $value['id']?>"><?php echo $value['name']?></option>

                                            <?php }else if($value['id'] == 15 || $value['id'] == 10 && $current_section == 'Counter parcel'){ ?>
                                                <option value="<?php echo $value['id']?>"><?php echo $value['name']?></option>
                                            <?php } ?>
                                        ...
                                        <?php } else if($fromzone == 'Return_letter_office') { ?>
                                        ...
                                        <?php } else if($fromzone == 'Foreign_letter') { ?>
    ...
    function passToOperatorByzone(obj){
        ...
        if (operator) {
            ...
            if (barcode.length == 13) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>Box_Application/MailsPassToOperatorByzone",
                    data:{
                        barcode:barcode,
                        operator:operator,
                        zonetype:zone,
