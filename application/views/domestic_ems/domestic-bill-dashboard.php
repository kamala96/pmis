                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>Bill_Customer/bill_customer_list?AskFor=EMS Postage" class="text-muted m-b-0">Document/Parcel</a>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>Ems_International_Bill/bill_customer_list?AskFor=EMS INTERNATIONAL" class="text-muted m-b-0">International</a>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row" >
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <?php if($this->session->userdata('user_type') == "SUPERVISOR" || $this->session->userdata('user_type') == "AGENT" || $this->session->userdata('user_type') == "EMPLOYEE" ){ ?>

                                           <a href="<?php echo base_url()?>Ems_Domestic/Pcum_Bill_Customer_List" class="text-muted m-b-0">Pcum</a>

                                        <?php }else{ ?>

                                           <a href="<?php echo base_url()?>Ems_Domestic/Pcum_Bill_Customer" class="text-muted m-b-0">Pcum</a>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url('Bill_Customer_tariff/dashboard');?>" class="text-muted m-b-0"> Special Customer Tariff </a>
                                    </div>
                                </div>
                            </div>
                        </div>
