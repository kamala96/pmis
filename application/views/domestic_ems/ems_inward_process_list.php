    ...
    <div class="col-lg-12">
        <div class="card card-outline-info">
                              ...
                              <div class="input-group">
                                  <select onchange="getOperatorByZone(this)" class="form-control custom-select js-example-basic-multiple zonetype bulk" id="zonetype" name="operator_zone">
                                    ...
                                    <?php foreach ($sectiondata as $key => $value){ ?>
                                        <?php if ($value['id'] == 2 || $value['id'] == 1 || $value['id'] == 4){ ?>
            ...
            <div class="card-body">
                ...
                <a class="btn btn-success" href="<?php echo base_url();?>Services/InWard" class="text-white"><i class="" aria-hidden="true"></i> Submit </a>
                  </td></tr>
                        </tbody>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    function getPassedItemsByOperator(obj){
        ...
        $.ajax({
            ...
            data:{
                ...
                removefunction:'removeInWardPassedItem'},
            dataType:'json',
    ...
    function removeInWardPassedItem(obj){
        ...
        $.ajax({
            type: "POST",
             url: "<?php echo base_url();?>Box_Application/removeInWardPassedItem",
