    ...
    <div class="col-12">
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="m-b-0 text-white"> Bulk Ems Application List</h4>
            </div>
            <div class="card-body">
                <div class="card">
                   <div class="card-body">
...
<form action="bulk_document_parcel_List" method="POST">
                                <tr>
                                    <th style="">
            ...
            <form method="POST" action="<?php echo base_url();?>Box_Application/send_to_back_office">
                ...
                <div class="table-responsive">
                            ...
                            <tbody class="">
                               <?php foreach ($emslist as  $value) {?>
                                   <tr>
                                      ...
                                      <td> 
                                        <!-- <a href="#myModal" class="myBtn btn btn-sm"><?php echo $value->billid; ?></a> -->
                                          <a href="#myModal" class="myBtn2 btn btn-sm" data-toggle="Modal" data-code='<?php echo $value->s_region; ?>'data-serial="<?php echo $value->serial; ?>" data-company="<?php echo $value->s_fullname; ?>" ><?php echo $value->billid; ?></a>
                    ...
                    <?php if($this->session->userdata('user_type') == "ACCOUNTANT"){?>
                        ...
                        <td style = "text-align:center;">
                        <a href="#" class="btn btn-info btn-sm getDetails" data-sender_id="<?php echo $value->sender_id ?>" data-s_fullname="<?php echo $value->s_fullname ?>" data-s_address="<?php echo $value->s_address ?>" data-sbranch="<?php echo $value->s_district ?>"  data-s_email="<?php echo $value->s_email ?>" data-s_mobile="<?php echo $value->s_mobile ?>" data-s_region="<?php echo $value->s_region ?>"   data-operator="<?php
                        $id = $value->operator;
...
<!-- <div class="modal2 fade" id="myModal2" role="dialog" style="padding-top: 100px;">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="mySmallModalLabel">
         <label >Sender Name: </label><input type="text" id="company" readonly style="border: none;" />  
...
$(function () {
  $('#myModal2').on('show.bs.modal', function (event) {
    ...
    $.ajax({
     type: "POST",
     url: "<?php echo base_url();?>Ems_Domestic/GetBulklist",
     data:'serial='+ serial,
