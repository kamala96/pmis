...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Distributer</h3>
    </div>
...
<div class="container-fluid">
    <!-- <div class="col-lg-12 col-md-12">
        <div class="row">
            <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Box_Application/Distributer_pass_view" class="text-white"><i class="" aria-hidden="true"></i> Pass process</a></button>  
        </div>
    </div> -->
    <div class="row">
        <div class="col-md-2">
            <a class="btn btn-primary" style="width:100%" href="<?php echo base_url() ?>Box_Application/Distributer_pass_view" class="text-white"><i class="fa fa-list"></i> Pass process</a>
        </div>
        <div class="col-md-2">
            <a class="btn btn-primary" style="width:100%" href="<?php echo base_url() ?>Box_Application/item_transfer_distributer" class="text-white"><i class="fa fa-list"></i> Item transfer</a>
        </div>
    </div>
 </div>
     ...
     <div class="row">
        ...
        <?php if (!empty($counter_list)){ ?>
            ...
            <?php foreach ($counter_list as $key => $list) { ?>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        <div onclick="getListFromCounter('<?php echo $key; ?>')" style="cursor: pointer;" class="card-body card-body-list card-body<?php echo $key; ?>">
        ...
        <div class="card card-outline-info">
            ...
            <div class="container-fluid">
                <div class="row m-b-10">
                    <div class="col-12">
                      <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Services/Distributer" class="text-white"><i class="" aria-hidden="true"></i> Back to list</a></button>
                 </div>
             </div>
...
<script type="text/javascript">
    function getListFromCounter(counterId){
        var pfnumber = counterId;
        ...
        $.ajax({
            type:'post',
            url:"<?php echo base_url();?>Box_Application/get_counter_sentList",
            data: 'emid='+pfnumber,
           dataType:'json',
    ...
    function scanforReceive(obj) {
        ...
        if (barcode.length == 13) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>Box_Application/distributer_receive",
                data:{barcode:barcode,transid:transactionid,passfrom:emid},
                dataType:'json',
                success:function(response){
