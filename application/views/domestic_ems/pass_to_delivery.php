                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="row col-md-12">
                            ...
                            <?php if ($fromsection == 'dispatch_section'){ ?>


                                <div class="">
                                    <a href="<?php echo base_url('Services/Despatch');?>" class="btn btn-info " style="padding-right: 10px;"><i class="fa fa fa-bars"></i> Dispatch</a>
                                </div>

                                <div style="margin-left:10px">
                                        <a href="<?php echo base_url('Box_Application/delivering?comefrom=dispatch_section');?>" class="btn btn-info " style="padding-right: 10px;"><i class="fa fa fa-bars"></i> Delivering</a>
                                    </div>
...
<script type="text/javascript">
    ...
    function checkPendingDelivering(obj){
        ...
        $.ajax({
            type:'POST',
            url:"<?php echo base_url();?>Box_Application/getOperatorPendingDelivering",
    ...
    function removeAssignedItem(obj){
        ...
        $.ajax({
            type: "POST",
             url: "<?php echo base_url();?>Box_Application/removeAssignedItemDelivering",
  ...
  function edValueKeyPress(barcodeBox,operatorname,type) {
    ...
    if(assignedoperator === ''){
        ...
        if (barcode.length == 13) {
            ...
            $.ajax({
                type: "POST",
                 url: "<?php echo base_url();?>Box_Application/passToDeliveringProcess",
