...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i>  Posta Shop </h3>
        </div>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body" >
                      ...
                      <form class="row" method="post" action="<?php echo site_url('PostaShop/find_transaction'); ?>">
                        ...
                        <div class="table table-responsive">
                           <table class="table table-bordered International text-nowrap" width="100%" style="text-transform: capitalize;">
                               ...
                               <tbody>
                                   ...
                                   $listitems = $this->PostaShopModel->get_selling_transaction_items($value->receipt);
                                    ?>
                                       <tr>
                                           <td><?php echo $sn; ?></td>
