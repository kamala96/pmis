...
<div class="page-wrapper">
   ...
   <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>PostaShop/stock_request" class="text-white"><i class="" aria-hidden="true"></i> My Requests </a></button>

   <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>PostaShop/send_stock_request" class="text-white"><i class="" aria-hidden="true"></i> Send Request </a></button>
...
<form  method="post" action="<?php echo site_url('PostaShop/save_stock_request');?>">
           ...
           <tr class="main_row">
             <td><select name="product_id[]" class="form-control productname" required="">
              ...
              <?php foreach ($list as $value){ ?>
                   <option value="<?php echo $value->productstock_id; ?>"> <?php echo @$value->product_name; ?></option>
              <?php } ?>
                     </select></td>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('tbody').delegate('.productname', 'change', function () {
            ...
            $.ajax({
            type : "post",
            url  : "<?php echo site_url('PostaShop/get_stamp_information');?>",
            data:'id='+id,
            dataType:'json',
...
'                                            <option value="<?php echo $data->productstock_id; ?>"><?php echo @$data->product_name; ?></option>\n' +
'                                        <?php } ?>\n' +
                '               </select></td>\n' +
                                 '<td><input type="number" name="price[]" class="form-control price" readonly></td>\n' +
'                                <td><input type="number" name="qty[]" class="form-control qty" required></td>\n' +
