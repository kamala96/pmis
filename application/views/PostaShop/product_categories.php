...
<div class="page-wrapper">
	...
	<div class="container-fluid">
		<div class="row m-b-10">
            ...
            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg">  <i class="fa fa-plus"></i> Add category </button>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i>   Product Categories </h4>
                </div>
                ...
                <div class="card-body">
                        ...
                        <form class="form-horizontal m-t-20" method="post" action="<?php echo site_url('PostaShop/save_category');?>">
                         ...
                         <!-- End -->
                                     ...
                                     <?php $sn=1; foreach($list as $data){ ?>
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <button title="Edit" class="btn btn-sm btn-info waves-effect waves-light" data-toggle="modal" type="button" data-target="#update_modal<?php echo $data->category_id; ?>">  <i class="fa fa-pencil-square-o"></i> </button>
                                                 
                                              <a href="<?php echo base_url('PostaShop/delete_category');?>?I=<?php echo base64_encode($data->category_id); ?>" onclick='return del();' title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                    ...
                                    <!-- Edit -->
                        <div class="modal fade" id="update_modal<?php echo $data->category_id; ?>" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                               
                        <div class="modal-header">
                        <h5 class="modal-title mt-0" id="myLargeModalLabel"> Edit Product Category  </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>             
                    <div class="modal-body"> 
                    <form class="form-horizontal m-t-20" method="post" action="<?php echo site_url('PostaShop/update_category');?>">
                    <input type="hidden" class="form-control"  name="itemid" value="<?php echo $data->category_id; ?>">
                    <div class="form-group row">
                    <div class="col-12">
                    <label> Category Name </label>
                    <input class="form-control" type="text" required="" name="name" value="<?php echo $data->category_name; ?>">
                    </div>
                    </div>
                    <div class="form-group row">
                    <div class="col-6">
