        ...
        <div class="col-12">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                           ...
                           ?>
                                    ...
                                    <tbody class="results">
                                     <?php $sn=1; foreach($list as $data){
                                        ...
                                        $listitems = $this->PostaShopModel->get_request_items($code);
                                        ?>
                                        <tr>
                                            <td> <?php echo $sn; ?> </td>                                           
                                            <td> <?php echo $data->request_code; ?> </td>
                                            <td> <?php echo $data->request_created_at; ?> </td>
                                            <td> <?php echo number_format(@$this->PostaShopModel->count_request_items($code)); ?> </td>
                        ...
                        <h5 class="modal-title mt-0" id="myLargeModalLabel"> Requested Products   </h5>
                    ...
                    <div class="col-md-4"> <strong> Required Quantity </strong> </div>  
                    </div>
                     <hr>
                ...
                <?php $serial++; } ?>
                 ...
                 <!-- PMU Approve -->
                        ...
                        <div class="modal-header">
                        <h5 class="modal-title mt-0" id="myLargeModalLabel"> Approve Requested   </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>             
                        <div class="modal-body"> 

                    <form class="form-horizontal m-t-20" method="post" action="<?php echo site_url('PostaShop/transfer_stock_to_counter_stock');?>">
                    ...
                    <div class="col-md-2"> <strong> Available Qty </strong> </div> 
                    <div class="col-md-2"> <strong> New Quantity </strong> </div>
                    </div>
                     <hr>
                    <?php $serial=1; foreach($listitems as $row){ 
                    $balance = $this->PostaShopModel->product_stock_details($row->productid);
                    ?>
                    ...
                    <?php echo number_format(@$balance->qty); ?>
                     ...
                     <div class="col-md-2">
                    <?php if(@$balance->qty>0){ ?>
                    <input type="number" class="form-control" min="1" name="qty[]" max="<?php echo $row->qty; ?>" placeholder="Enter Quantity">
                    <?php } else { ?>
                ...
                <?php $serial++; } ?>
                    ...
                    <select class="form-control"  style="width:100%;" name="status" required>
                     <option value="ApprovedBySupervisor"> Confirm Request </option>
                      <option value="CanceledBySupervisor"> Cancel Request </option>
                    </select>
                    </div>
                    </div>
