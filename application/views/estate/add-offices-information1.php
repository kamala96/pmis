                            ...
                            <form method="POST" action="<?php echo base_url()?>Realestate/Save_Tenant_Information">
                                ...
                                <div class="row" style="padding-left: 15px;padding-right: 20px;">
                                  <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="custname" class="form-control"required ="required">
                                  </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="square_meters" class="form-control"required ="required">
                                  </div>
                                ...
                                <div class="form-group col-md-4">
                                  ...
                                  <div class="form-group col-md-4">
                                    <input type="hidden" name="type" class="form-control" value="Offices">
                                  </div>
                                  </div>
                                  <div class="row">
                                  <div class="col-md-12" >
