                      ...
                      <div class="col-lg-4 col-md-6">
                       ...
                       <div class="col-lg-4 col-md-6">
                        <div class="card">
                         ...
                         <a href="<?php echo base_url(); ?>Realestate/Hall_list" class="text-muted m-b-0">Hall</a>
                        ...
                        <div class="card" style="">
                          <div class="">
                            ...
                            <div class="card-body">
                              ...
                              <br>
                              <div class="">
                                <form method="POST" action="<?php echo base_url()?>Realestate/Hall_list">
                                <table class="table table-bordered" width="100%">
                                  <tr>
                                    ...
                                    <td><select class="form-control custom-select district" name="disid">
                                       ...
                                       <!-- <input type="hidden" name="estatus" class="form-control" value="Occupied"> -->
                                    </td>
                                     ...
                                     <tbody>
                                      ...
                                      <?php $i=1; foreach ($tenant as $value) {?>
                                       <tr>
                                         ...
                                         <td>
                                             <a href="Tenant_informations?id=<?php $type="Residential"; echo $value->tenant_id; ?>&type=<?php echo $type; ?>" class=""><?php echo $value->customer_name?></a> 
                                         </td>
                                         ...
                                         <td>
                                            ...
                                            <?php $controlno = $value->billid;
                                         $sum = $this->dashboard_model->getsumPayment($controlno);
                                         $difff = $value->paidamount -$sum->sum_amount;
                                          ?>
                                         ...
                                         <td>
                                          ...
                                          <?php }else{ ?>
                                            <button class="btn btn-danger" disabled="disabled">Not Paid</button>
                                             ...
                                             <?php if(empty($value->billid)){ ?>

                                               <a href="javascript:{}" onclick="document.getElementById('repost').submit(); return false;" class="btn btn-warning">Repost</a>

                                               <form id="repost" action="<?php echo base_url()?>Realestate/billrepost"  method="POST">
                                               <input type="text" hidden="hidden" name="serial" value='<?php echo $value->serial; ?>' class="" >
                                               <input type="text" hidden="hidden" name="tenant_id" value='<?php echo $value->tenant_id; ?>' class="" >
                                              </form>

                                               <?php } ?>

                                             <?php }}else{ ?>
                                             <!-- <a href="getPaymentTrend?controlno=<?php echo $value->billid; ?>" class="btn btn-danger">Renew</a> -->
                                            <?php if($difff <=0 ){ ?>
                                           <!-- <button class="btn btn-success" disabled="disabled">Paid</button> -->

                                           <a href="#myModal" class="btn btn-danger" data-toggle="modal" data-code='<?php echo $value->estate_name; ?>'
                                                data-tenant_id="<?php echo $value->tenant_id; ?>"
                                                data-mobile="<?php echo $value->mobile_number; ?>"
                                                data-estate_id="<?php echo $value->estate_id; ?>"
                                                data-region="<?php echo $value->region; ?>"
                                                data-district="<?php echo $value->district; ?>"

                                                data-contarct_number="<?php echo $value->contract_number; ?>"
                                                data-currency_type="<?php echo $value->currency_type; ?>"
                                                data-amount="<?php echo $value->amount; ?>"
                                                data-start="<?php echo $value->end_date; ?>"


                                                 data-company="<?php echo $value->customer_name; ?>">Renew</a>
                                          ...
                                          <?php }else{ ?>
                                             ...
                                             <a href="#myModal2" class="btn btn-danger" data-toggle="modal" data-code='<?php echo $value->estate_name; ?>'
                                                data-tenant_id="<?php echo $value->tenant_id; ?>"
                                                data-mobile="<?php echo $value->mobile_number; ?>"
                                                data-estate_id="<?php echo $value->estate_id; ?>"
                                                data-region="<?php echo $value->region; ?>"
                                                ...
                                                data-currency_type="<?php echo $value->billid; ?>"
                                                data-amount="<?php echo $difff; ?>"
                                            ...
                                            <!-- <button class="btn btn-danger" disabled="disabled">Renew</button> -->
                                         ...
                                         <td>
                                           ...
                                           <a href="getPaymentTrends?controlno=<?php echo $value->tenant_id; ?>" class="btn btn-info">Payment Trend</a>
                                            <a href="printResidentialInvoice?billid=<?php echo $value->billid; ?>&&cuno=<?php echo $value->tenant_id ?>" class="btn btn-info">Print Invoice</a>
                                         </td>
                                         </tr>
                                       <?php } ?>
                                     </tbody>
