      ...
      <div class="col-lg-12 col-md-12">
                        <div class="card" style="">
                          <div class="">
                            ...
                            <div class="card-body">
                              <a href="<?php echo base_url();?>Realestate/Add_Land_Information" class="btn btn-info"><i class="fa fa-plus"></i>   Add Land Information</a>
                              <br>
                              <br>
                              <div class="">
                                     ...
                                     <tbody>
                                      ...
                                      <?php $i=1; foreach ($tenant as $value) {?>
                                       <tr>
                                         ...
                                         <td>
                                             <a href="Tenant_informations?id=<?php $type="Land"; echo $value->tenant_id; ?>&type=<?php echo $type; ?>" class=""><?php echo $value->customer_name?></a> 
                                         </td>
                                         ...
                                         $type="Land";
                                          ?>
                                           ...
                                           <?php if($diff >=0 ){ 
                                            ...
                                            $Totalamount = $value->amount * 3;
                                            
                                          }elseif ($payment_cycle == "Semi Annual") {
                                              $Totalamount = $value->amount * 6;
                                            
                                          }else{
                                              $Totalamount = $value->amount * 12;
                                         ...
                                         if ($difff <=0) {
                                           echo number_format($Totalamount * 0.10,2);
                                         } else {
                                            echo number_format($Totalamount * 0.10,2);
                                         }
                                         ...
                                         if ($difff <=0) {
                                            echo number_format($Totalamount * 0.18,2);
                                         } else {
                                          echo number_format($Totalamount * 0.18,2);
                                         }
                                          ...
                                          <?php } ?>
                                           ...
                                           <?php if($diff >=0 ){ 
                                            $rentalfee = (($Totalamount)-($Totalamount * 0.1));
