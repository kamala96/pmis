           ...
           <div class="col-lg-4 col-md-6">
                    ...
                    <?php 
                     $id = $this->session->userdata('user_login_id');
                      ...
                      $sub_role = $basicinfo->em_sub_role;
                        ?>
                <?php if($sub_role=='STRONGROOM' || $sub_role=='BRANCH' || $sub_role=='COUNTER' || $sub_role=='STORE'){ ?> 

                    <div class="col-lg-3 col-md-6">
                        <div class="card" style="background-color:rgb(93, 76, 200);">
                            <div class="card-body">
                                 <a href="<?php echo base_url(); ?>Box_Application/Estate" class="text-white">
      ...
      <div class="col-lg-12 col-md-12">
                        <div class="card" style="">
                          <div class="">
                            ...
                            <div class="card-body">
                              <div>
                                <a href="<?php echo base_url();?>Realestate/Add_Office_Information" class="btn btn-info"><i class="fa fa-plus"></i>  Add Office Information</a>
                              </div>
                              <br>
                            <div class="">
                                 ...
                                 <div class="table-responsiveness" style="overflow-x: auto;">
                                   <table class="residential-list table table-bordered table-striped text-nowrap" width="100%" style="text-transform: uppercase;">
                                     ...
                                     <tbody>
                                      ...
                                      <?php $i=1; foreach ($tenant as $value) {  $type="Offices";?>
                                       <tr>
                                         <td><?php echo $i; $i++; ?></td>
                                         <td><?php echo $value->estate_name;?></td>
                                         <td>
                                            <a href="Tenant_informations?id=<?php  echo $value->tenant_id; ?>&type=<?php echo $type; ?>" class=""><?php echo $value->customer_name?></a> 
                                         ...
                                         if ($difff <=0) {
                                           echo number_format($value->amount * 0.10,2);
                                         } else {
                                            echo number_format($value->amount * 0.10,2);
                                         }
                                         ...
                                         if ($difff <=0) {
                                            echo number_format($value->amount * 0.18,2);
                                         } else {
                                          echo number_format($value->amount * 0.18,2);
                                         }
                                          ...
                                          <?php } ?>
                                           ...
                                           <?php if($diff >=0 ){ 
                                            $rentalfee = (($value->amount)-($value->amount * 0.1));
                                        
                                              echo number_format($rentalfee);
                                         ...
                                         <td>
                                           ...
                                           <a href="printInvoice?billid=<?php echo $value->billid; ?>&&cuno=<?php echo $value->tenant_id ?>" class="btn btn-info">Print Invoice</a>
                                         </td>
                                     ...
                                     <input type="text" name="mobile" id="mobile" hidden="hidden" />
                                      <input type="text" name="estate_id" id="estate_id" hidden="hidden" />
                                       <input type="text" name="region" id="region" hidden="hidden" />
                                        ...
                                        <input type="text" name="type" id="type" hidden="hidden" />
