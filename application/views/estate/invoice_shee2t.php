  ...
  <table style="width: 100%;font-size: 14px;">
    <tr><td>
      ...
      <tr><td style="text-transform: uppercase;"><?php echo @$custinfo->customer_address . '  ' .@$custinfo->customer_region; ?></td></tr>
           ...
           <?php $word1 = 'resreal'; if(strpos($custinfo->serial, $word1) === false ){ ?>
 ...
 -->
  ...
  <table style="width: 100%;font-size: 14px;border-bottom: solid; 1px;border-top: solid;1px;">
     ...
     <tfoot>
      ...
      <tr><td>VAT: </td><td>Tsh.</td><td style="text-align: right;"><?php 
        echo number_format(@$vat,2);
      ?></td> </tr>
      
      <tr><td>TOTAL:</td><td>Tsh.</td><td style="text-align: right;"><b><?php
        echo number_format(@$total+@$vat,2); ?></b></td></tr>

       <tr><td>WITHOLDING: </td><td>Tsh.</td><td style="text-align: right;"><?php 
      ...
      ?></td></tr>
       ...
       <!-- <tr><td>TOTAL::</td><td>Tsh.</td><td style="text-align: right;"><b><?php
        echo number_format(@$total+@$witholding+@$vat,2); ?></b></td></tr> -->
     </tfoot>
  </table>
  <br>
  <table style="width: 100%;">
