                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    <div class="round align-self-center round-success"><i class="fa fa-building"></i></div>
                                    <div class="m-l-10 align-self-center">
                                        <h3 class="m-b-0">
                                    
                                     </h3>
                                     
                        <a href="<?php echo base_url(); ?>Realestate/Propertylist" class="text-muted m-b-0">Property</a>
                     ...
                     $id = $this->session->userdata('user_login_id');
                      ...
                      $sub_role = $basicinfo->em_sub_role;
                        ...
                        <div class="card">
                         ...
                         <a href="<?php echo base_url(); ?>Realestate/clients_tenants_dashboard" class="text-muted m-b-0">Clients/Tenants</a>
                        ...
                        <div class="card" style="">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                       <a href="<?php echo base_url(); ?>Box_Application/Estate" class="text-muted m-b-0">Payments</a>
                                        </div>
                                </div>
                                </a>
                            </div>
