...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Register Agreement</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Register Agreement</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Agreement Form                       
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                           <div class="card-body">
                            <?php if (!empty($serviceById->ag_id)) {?>
                            <form action="<?php echo base_url('Organization/Register_Agreement_Action')?>" method="POST">
                                <div class="row">
                                 <div class="form-group col-md-6">
                                    <label>Contract Type</label>
                                    <select name="cont_type" class="custom-select form-control" required="">
                                        <option value="<?php echo $serviceById->cont_id ?>"><?php echo $serviceById->cont_name ?></option>
                                ...
                                <input type="text" name="agreement_name" class="form-control" required="required" value="<?php echo $serviceById->agreement_name ?>">
                                </div>
                               </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                <div class="form-group">
                                    <input type="hidden" name="service_id" value="<?php echo $serviceById->ag_id ?>">
                                   <button class="btn btn-info btn-sm" type="submit">Save Agreement</button>
                                </div>
                                </div>
                                </div>
                        </form>
                            <?php }else{ ?>
                                ...
                                <div class="form-group">
                                    <label>Agreement Name</label>
                                <input type="text" name="agreement_name" class="form-control" required="required">
                                </div>
                               </div>
                        ...
                        <table id="example4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody class="results">
                                           <?php foreach($agreement as $value): ?>
                                            <tr>
                                                <td><?php echo $value->agreement_name;?></td>
                                                <td style="text-align: right;"><a href="agreement?I=<?php echo base64_encode($value->ag_id)?>" class="btn btn-warning btn-sm">Edit</a></td>
                                            </tr>
                                            <?php endforeach; ?>
