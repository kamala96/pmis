      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-braille" style="color:#1976d2"></i> Ems Dashboard</h3>
                </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>Ems_Domestic/Incoming_Item?AskFor=EMS" class="text-muted m-b-0">EMS</a>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                       ...
                                       <!--  <a href="<?php echo base_url()?>Ems_Domestic/Incoming_Item?AskFor=MAILS" class="text-muted m-b-0">MAILS</a> -->
                                       <a href="<?php echo base_url()?>unregistered/Mails_Delivery_Backoffice" class="text-muted m-b-0">MAILS</a>
