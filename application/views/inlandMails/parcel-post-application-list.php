...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Parcel Post Transaction List</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Parcel Post Transaction List</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
        ...
        <div class="row m-b-10">
                <div class="col-12">
                     <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>unregistered/parcel_post_domestic_form" class="text-white"><i class="" aria-hidden="true"></i> Add Parcel Post Transaction</a></button>
                       ...
                       <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>unregistered/parcel_post_domestic_bulk_form" class="text-white"><i class="" aria-hidden="true"></i> Add Bulk Parcel Post Transaction</a></button>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <h4 class="m-b-0 text-white"> Parcel Post Transaction List
                        </h4>
                    </div>
                    <div class="card-body">
                                    ...
                                    <td>
                                      <?php 
                                          if ($value->register_type == "Land") {
                                            ...
                                            echo "Parcel Subjected To Port Charges";
                                          }
                                        ?>
