...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i><?php echo @$askfor;?> Bulk Bill Customer Registration</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active"><?php echo @$askfor;?> Bulk Bill Customer Registration</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
        ...
        <div class="row m-b-10">
                <div class="col-12">
                    ...
                    <?php if($this->session->userdata('user_type') == "EMPLOYEE"){ ?>
                         ...
                         <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/mail_bulk_bill_customer_list?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i><?php echo @$askfor;?> Bulk Bill Customer  List</a></button>

                    <?php }if($this->session->userdata('user_type') == "ADMIN" || $this->session->userdata('user_type') == "ACCOUNTANT"){ ?>

                       <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Bill_Customer/bulk_bill_customer_form?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Add <?php echo @$askfor;?> Bulk Bill Customer</a></button>
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/mail_bulk_bill_customer_list?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> <?php echo @$askfor;?> Bulk Bill Customer List</a></button>

                      <!--  <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/bulk_bill_transactions_list?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i><?php echo @$askfor;?> Bulk Bill Transactions List</a></button> -->

                        <?php if(@$askfor == 'Latter'){?>
                        <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/latter_bulk_bill_transaction_list?AskFor=<?php echo $askfor;  ?>" class="text-white"><i class="" aria-hidden="true"></i> <?php echo $askfor;  ?> Bill Transactions Lists</a></button>

                       <?php }else{ ?>
                        <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/register_bulk_bill_transaction_list?AskFor=<?php echo $askfor;  ?>" class="text-white"><i class="" aria-hidden="true"></i> <?php echo $askfor;  ?> Bill Transactions Lists</a></button>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        ...
                        <?php echo @$askfor;?> Bulk Bill Customer Registration Form                 
                        </h4>
                    </div>
                ...
                <?php }?>
            <form method="post" action="Customer_bulk_Register?AskFor=<?php echo @$askfor;?>">
                                ...
                                <label>Services Type:</label>
                                   <select class="form-control custom-select" name="service_type" required="">
                                    ...
                                    <?php if(@$askfor == 'Latter'){ ?>
                                         <option>LATTER BULK POSTING</option>
                                        <?php }elseif(@$askfor == 'Register') { ?>
                                            <option>REGISTER BULK POSTING</option>
                                       <?php }  elseif(@$askfor == 'Parcel') { ?>
                                           <option>PARCEL BULK POSTING</option>
                                       <?php } else{} ?>
                            ...
                            <input type="text" name="cust_address" class="form-control" required="required" value="<?php echo @$edit->customer_address; ?>">
                                ...
                                <label>Region:</label>
                                    <select class="form-control custom-select" onChange="GetBranch();" id="regiono" name="">
                                        <option value="<?php echo @$edit->customer_region; ?>"><?php echo @$edit->customer_region; ?></option>
