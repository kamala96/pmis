        ...
        if ($('#trans').val() == 0) {
            ...
            $('#transerror').hide();
              ...
              if($('#weight').val() == ''){
                ...
                $('#Barcode_error').html('Please input Weight in Kg');
                ...
                if (address == 'physical') {
                    ...
                    //        // $('.disable').attr("disabled", true);
                        ...
                        var district         = $('#rec_dropp').val();
                            ...
                            $.ajax({
                             type : "POST",
                             url  : "<?php echo base_url('unregistered/bulk_parcel_post_sender_info')?>",
                             //dataType : "JSON",
                             data : {weight:weight,transport:transport,emsname:emsname,serial:serial,Barcode:Barcode,
