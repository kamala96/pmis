        ...
        $basicinfo = $this->employee_model->GetBasic($id); 
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <?php if (!empty($_GET['service_type_new']) == 'InLand_reg'){ ?>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                      <a href="<?php echo base_url()?>unregistered/close_bag_items?Ask_for=<?php echo $this->session->userdata('service_type'); ?>&service_type_new=<?php echo $this->session->userdata('service_type_new'); ?>" class="text-muted m-b-0">Bulk Bag Processing</a>
                      ...
                      <div class="card-body">
                        <div class="row">
                            <div class="col-md-8">
                             ...
                             <div id="changeMaster" class="col-md-2">
                                <select onchange="checkBagType(this)" class="form-control" name='bagtype'>
                                    <option selected="selected" disabled="disabled">--Choose type--</option>
                                    <option value='nill'>Nill</option>
                                    <option value='notnill'>Not Nill</option>
                                </select>
                            </div>
                            <div id="countingNumberContainer" class="col-md-2">
                         ...
                         <div class="row">
                            ...
                            <th style="text-transform: uppercase;" >
                              ...
                              <div>
                                  <a style="display: none;" href="<?php echo base_url(); ?>unregistered/delete_selected_bag" id='btnDeletebag' 
                                    onclick="return confirm('Je, una uhakika unataka kufuta mfuko huu ?')"><i class="fa fa-trash-o"></i> Delete Bag</a>
                              </div>
                          </th>
                           ...
                           <div class="input-group">
                            ...
                            <th id='bucketBox'>
                                <div class="input-group">
                                <input placeholder="Barcode" id="edValue" type="text" class="form-control edValue" onInput="assignBagProcess(this)">
                                </div>
                            </th>
                             <th style="display:none;" id='closeNillBag'>
                                <div class="input-group">
                                    <button onclick="closeNillBag()" class="btn btn-primary btn-block">Close Bag</button>
                                </div>
                            </th>
               ...
               <div class="row">
                    ...
                    <div id="tranDetails" class="col-md-12">
                        <table class="table table-bordered" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th>SN</th>
                            ...
                            <tbody class="">
                                <tr>
                                    <td colspan="7"></td><td style="float: right;">
                                        <a class="btn btn-success" href="<?php echo base_url();?>unregistered/total_numbers_of_bags?<?php echo $service_type ?>" class="text-white"><i class="" aria-hidden="true"></i> Close Bag </a>
                                      </td>
                                  </tr>
                            </tbody>
                        </table>
...
<script type="text/javascript">
    ...
    function checkBagType(obj){
        ...
        if (type == 'nill') {
            ...
            $('#bucketBox').hide();
            $('#closeNillBag').show();
            $('#countingNumberContainer').hide();
            $('#changeMaster').removeClass('col-md-2').attr('class','col-md-4');
        }else{
            $('#tranDetails').show();
            $('#bucketBox').show();
            $('#closeNillBag').hide();
            $('#countingNumberContainer').show();
            $('#changeMaster').removeClass('col-md-4').attr('class','col-md-2');
        }
    }
...
function getbagItems(obj){
    ...
    if (bagnoSelectedText) {
        ...
        $.ajax({
            type:'POST',
            url:"<?php echo base_url();?>Unregistered/get_bag_itemlist",
...
function closeNillBag(obj){
    var rec_region = $('#rec_region').val();
    var rec_branch = $('#rec_dropp1').val();
    var bagnoText = $('#bagss option:selected').text();

    $('#loadingtext').html('Please wait............');
    if (rec_region && rec_branch){
        $.ajax({
            type:'POST',
            url:"<?php echo base_url();?>Unregistered/createNillBag",
            data:{bagnoText:bagnoText,rec_region:rec_region,rec_branch:rec_branch},
            dataType:'json',
            success:function(response){
                //console.log(response)
...
function assignBagProcess(obj){
        ...
        if (rec_region && rec_branch && barcode) {
            ...
            if (barcode.length == 13) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>Unregistered/assign_item_bag_process",
                    data:{
