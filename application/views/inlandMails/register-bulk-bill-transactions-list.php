...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> <?php echo $askfor;  ?> Bill Transaction List</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active"><?php echo $askfor;  ?> Bill Transaction List</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
        ...
        <div class="row m-b-10">
                <div class="col-12">
                  ...
                  <?php if($this->session->userdata('user_type') == "EMPLOYEE" || $this->session->userdata('user_type') == "SUPERVISOR" || $this->session->userdata('user_type') == "AGENT"){ ?>
                      ...
                      <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/mail_bulk_bill_customer_list?AskFor=<?php echo $askfor;  ?>" class="text-white"><i class="" aria-hidden="true"></i>Bulk <?php echo $askfor;  ?> Bill Customer List</a></button>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <h4 class="m-b-0 text-white"> Bulk Posting Transaction List
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="table table-responsive">
                          ...
                          <?php }else{?>
                          <?php } ?>
                          <form action="register_bulk_bill_transaction_list" method="POST">
                            <table id="example4" class="display nowrap table table-hover  table-bordered" cellspacing="0" width="100%" style="text-transform: capitalize;">
                             ...
                             <!--  <th>Control No</th> -->
                              <th>Track No.</th>
                              <th>Item Status</th>
                              <?php if( $this->session->userdata('user_type') == "ACCOUNTANT"){}else {?>
                              <!-- <th>Pay Status</th> -->
                        ...
                        <?php if(empty($list)){ ?>
                        <?php }else{ ?>
                          <tfoot><?php if( $this->session->userdata('user_type') == "ACCOUNTANT"){ ?>
                            <td></td>
