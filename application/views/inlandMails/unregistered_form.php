                           ...
                           <div class="card-body">
                            <div id="div1">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="emsname" id="regtype" value="" class="form-control custom-select boxtype" required  onchange="functionParcel();">
                            ...
                            <select name="ad_fee" value="" class="form-control custom-select ad_fees" >
                               ...
                               <!--  <div class="col-md-3 physical" style="display: none;">
                                ...
                                <div class="col-md-3 physical" style="display: none;">
                                    <label><h4>Mobile Number:</h4></label>
                                    <input type="mobile" name="s_mobile" id="s_mobile" class="form-control s_mobile" onkeyup="myFunction()" value="<?php echo @$custinfo->cust_mobile; ?>">
                                     <span id="mobileerror" style="color: red;"></span>

                                    <input type="hidden" name="crdtid" id="" class="form-control" onkeyup="myFunction()" value="<?php echo @$custinfo->credit_id; ?>">
                                    <input type="hidden" name="price" id="" class="form-control" value="<?php echo @$custinfo->price; ?>">
                                    <input type="hidden" name="accno" id="" class="form-control" value="<?php echo @$custinfo->acc_no; ?>">
                              ...
                              <!--   <div class="col-md-3 physical1" style="display: none;">
                                ...
                                <div class="row"><!--
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <button onclick="saveInformations()" class="btn btn-info disable" type="button" id="submitform" >Save Information</button>
                                    </div>
                                </div>
                                </div>
...
function saveInformations(){
      ...
      $.ajax({
        type : "POST",
        url  : "<?php echo base_url('unregistered/register_sender_info')?>",
        dataType : "JSON",
        data : {
         Barcode:Barcode,
         emstype:emstype,
