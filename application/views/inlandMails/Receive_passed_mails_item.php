...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        ...
        Receive passed Small packet</h3>
    </div>
    ...
    <div class="col-md-2">
        <div class="col-mdd-12">
          <button type="button" class="btn btn-primary btn-block">
            ...
            <a href="<?php echo base_url() ?>Services/InWard_mails_pass" class="text-white"><i class="" aria-hidden="true"></i> Pass to zone</a>
        </button>
     </div>
    </div>
    <div class="col-md-2">
        <div class="col-m5d-12">
          <button type="button" class="btn btn-primary btn-block">
            <i class="fa fa-list"></i>
            <a href="<?php echo base_url() ?>Box_Application/item_mails_transfer?fromzone=InWard_open&print_status=IN" class="text-white"><i class="" aria-hidden="true"></i> Item transfer</a>
        </button>
     </div>
    </div>
    <div class="col-md-2">
     ...
     <!-- <div class="col-md-2">
        <div class="col-mdd-12">
            <button type="button" class="btn btn-primary">
                <i class="fa fa-list"></i>
                <a href="<?php echo base_url() ?>Box_Application/Receive_passed_mails_item" class="text-white"><i class="" aria-hidden="true"></i> Receive passed Small packet</a>
            </button>
        </div>
    </div> -->
...
<script type="text/javascript">
    function getListFromZone(operatorId){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo base_url();?>Packet_Application/get_small_packet_sentList",
    ...
    function scanforReceive(obj) {
        ...
        if (barcode.length == 13) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>Packet_Application/small_packet_receive",
                data:{
                    barcode:barcode,
    ...
    /*function scanforReceive(obj) {
        ...
        if (barcode.length == 13) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>Box_Application/inward_receive",
