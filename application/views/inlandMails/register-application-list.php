...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Register Transaction List</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Register Transaction List</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        ...
                        <tbody>
                            <?php  $totl= 0; foreach ($list as $value) {?>
                                <tr>
                                    ...
                                    <td><?php if( $value->status == "Paid"){?>
                                        ...
                                        <?php }else{ ?>
                                            ...
                                            <a href="<?php echo base_url('unregistered/updateControlNumber/'.$value->serial);?>" class="btn btn-danger btn-sm"><i class="fa fa fa-bars"></i> NOT PAID</a>
                           ...
                           <?php  $totl=$totl + intval(@$value->register_price);} ?>
                        </tbody>
                        <?php if(empty($list)){ ?>
                        <?php }else{ ?>
                          <tfoot>
                            ...
                            <td><?php echo number_format($totl,2);//number_format($sum->paidamount,2); ?></td>
                            <td colspan="8"></td>
