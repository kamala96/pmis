                      ...
                      <br>
                        ...
                        <div class="">
                         ...
                         <p style="margin-top: -60px;">Dispatching Office Date Stamp</p>
                          ...
                          <tr>
                          <th colspan="2">
                          From: <?php echo $getbags->bag_origin_region; ?>
                          </th>
                          <th>
                          To: <?php echo $getbags->bag_region_to; ?>
                          </th>
                          </tr>
                               ...
                               <?php foreach ($getInfo as  $value) {?>
                                   <tr>
                                     ...
                                     <td> <?php  echo $value->track_number; ?>  </td>
                                      ...
                                      <td> 
                                            <a href="
                                         <?php echo base_url()?>unregistered/mail_item_list_bags_remove?trck=<?php echo $value->senderp_id; ?>&bagno=<?php echo $bagno; ?>"data-bagno = "<?php echo $value->track_number; ?>" class="btn btn-danger">
                                         Remove     
                                          </a>
                                       </td>
