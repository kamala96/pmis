...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Ordinary Latter Bill Transaction List</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active"> Ordinary Latter Bill Transaction List</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <h4 class="m-b-0 text-white"> Ordinary Latter Bulk Posting Transaction List
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="table table-responsive">
                          ...
                          <?php }else{?>
                          <?php } ?>
                          <form action="latter_bulk_bill_transaction_list" method="POST">
