...
<div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor"><b><i class="fa fa-university" aria-hidden="true"></i>  <?php echo $billtype;  ?> Bill Customer List</b></h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                    <li class="breadcrumb-item active"><b><?php echo $billtype;  ?> Bill Customer List</b></li> 
                </ol>
            </div>
        </div>
        <div class="message">
            ...
            <div class="row m-b-10"> 
                <div class="col-12">
                    ...
                    <?php if($this->session->userdata('user_type') == "EMPLOYEE" || $this->session->userdata('user_type') == "AGENT" || $this->session->userdata('user_type') == "SUPERVISOR"){ ?>
                            ...
                            <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/register_bill_transaction_list?AskFor=<?php echo $billtype;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Transactions Lists</a></button>
                       
                         
                         <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/bill_customer_list?AskFor=<?php echo $billtype;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Customer List</a></button>
                    <?php }if($this->session->userdata('user_type') == "ADMIN" || $this->session->userdata('user_type') == "ACCOUNTANT"){ ?>

                       <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Bill_Customer/bill_customer_form?AskFor=<?php echo $billtype;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Add Bill Customer</a></button>
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/bill_customer_list?AskFor=<?php echo $billtype;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Customer List</a></button>
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/bill_transactions_list?AskFor=<?php echo $billtype;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Transactions List  </a></button>
                            ...
                            <tr>
                                ...
                                <?php if( $this->session->userdata('user_type') == "EMPLOYEE"|| $this->session->userdata('user_type') == "SUPERVISOR" || $this->session->userdata('user_type') == "AGENT"){ ?>
                                 ...
                                 <?php if($billtype == "Register" ){ ?>
                                    <a href="<?php echo base_url()?>unregistered/unregistered_bill_bulk_form?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $billtype; ?>" class="btn btn-info">Services</a>
                                  <?php }elseif ($billtype == "Parcel") { ?>
                                      <a href="<?php echo base_url()?>unregistered/parcel_bill_domestic_bulk_form?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $billtype; ?>" class="btn btn-info">Services</a>
                                  <?php } else{?>

                                 <a href="<?php echo base_url()?>Box_Application/Send?I=<?php echo base64_encode($value->credit_id) ?>" class="btn btn-info">Services</a>
                                 
                                 <a href="<?php echo base_url()?>Bill_Customer/Prepare_Customer_Bills?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $billtype;?>" class="btn btn-info">Bill Receipt</a>
                               ...
                               <?php } ?>
                                 ...
                                 <?php }else{ ?>
                                  <?php if($billtype == "Register"){ ?>
                                    <a href="<?php echo base_url()?>unregistered/unregistered_form?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $billtype; ?>" class="btn btn-info">Services</a>
                                    <?php }elseif ($billtype == "Parcel") { ?>
                                      <a href="<?php echo base_url()?>unregistered/parcel_bill_domestic_bulk_form?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $billtype; ?>" class="btn btn-info">Services</a>
                                  <?php }else{?>
                                 <a href="<?php echo base_url()?>Box_Application/Send?I=<?php echo base64_encode($value->credit_id) ?>" class="btn btn-info">Services</a>
                               <?php } ?>
                                ...
                                <?php if($value->customer_type == "PostPaid"){?>
                                    <?php if( $billtype == "Register" || $billtype == "Parcel"){ ?>
                                        <a href="<?php echo base_url()?>Bill_Customer/Prepare_Customer_Bills?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $billtype;?>" class="btn btn-info">Genarate Bill</a>
                                    <?php }else{?>
                                ...
                                <?php }else{ ?>
                                 ...
                                 <?php if (empty($getPay1)) {?>
                                   <!-- <a href="#" class="btn btn-info cont" id="cont" data-control="<?php echo $value->credit_id; ?>">Control Num.</a> --> 
