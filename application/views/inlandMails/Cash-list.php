...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Cash On Hand List</h3>
		</div>
		<div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>Stock/StockBoard" >Inventory</a></li>
                <li class="breadcrumb-item active"> Cash On Hand List 
                </li>
            </ol>
        </div>
	</div>
	...
	<div class="container-fluid">
		<div class="row m-b-10">
			<div class="col-12">
			<button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Stock/Add_cash" class="text-white"><i class="" aria-hidden="true"></i> Add  Cash On Hand</a></button>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                   <!--  <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i>  Cash On Hand List</h4> -->
                </div>
                                     ...
                                     <?php foreach($stock as $value): ?>
                                        <tr>
		                                   ...
		                                   <td class="jsgrid-align-center " style="text-align: right;">
		                                   	 <a href="<?php echo base_url(); ?>Stock/Cashlist" title="Edit" class="btn btn-sm btn-info waves-effect waves-light">Edit</a>
		                                   </td>
