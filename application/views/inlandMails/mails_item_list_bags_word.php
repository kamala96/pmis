                                ...
                                foreach ($getInfo as  $value) {
                                 $trlist=$trlist. '  <tr>
                                     ...
                                     <td style=" border: 1px solid black;"> '.$value->track_number.' </td>
                                      ...
                                      <td style=" border: 1px solid black;">'.$value->sender_region.'</td>
                                      <td style=" border: 1px solid black;" colspan="2">'.$value->sender_branch.'</td>
                                      <td style=" border: 1px solid black;">'. $value->receiver_region.'</td>
                                       <td style=" border: 1px solid black;" colspan="2">'.$value->reciver_branch.'</td>
             ...
             <link href="'.base_url().'assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
                 ...
                 <script src="'.base_url().'assets/plugins/jquery/jquery.min.js"></script>
                         ...
                         <p style="margin-right: 60px;">Dispatching Office Date Stamp</p>
                          ...
                          <tr>
                          <th colspan="3">
                          From: '.$getbags->bag_branch_origin.'
                          </th>
                          <th colspan="3">
                          To: '.$getbags->bag_branch_to.'
                          </th>
                          </tr>
