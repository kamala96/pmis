        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <form action="register_sender_info" method="POST">
                        <div class="card">
                           ...
                           <div class="card-body">
                            ...
                            <input type="text" name="weight" class="form-control catweight" id="weight" onkeyup="getPriceFrom()">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="s_fname" id="s_fname" class="form-control" onkeyup="myFunction()" value="<?php echo $bill->acc_no; ?>" readonly="readonly">
                                    <span id="errfname" style="color: red;"></span>
                                </div>
                                <div class="col-md-6">
                                    <label>Address:</label>
                                    <input type="text" name="s_address" id="s_address" class="form-control" onkeyup="myFunction()" value="<?php echo $bill->customer_address ; ?>" readonly="readonly">
                                    <span id="erraddress" style="color: red;"></span>
                                </div>
                                <div class="col-md-6">
                                    <label>Email:</label>
                                    <input type="email" name="s_email" id="s_email" class="form-control" onkeyup="myFunction()" value="posta@posta.go.tz" readonly="readonly">
                                    <span id="erremail" style="color: red;"></span>
                                </div>
                                <input type="text" name="amount" class="form-control" onkeyup="myFunction()" value="<?php echo $bill->price ; ?>" readonly="readonly">
                                <input type="text" name="custid" class="form-control" onkeyup="myFunction()" value="<?php echo $bill->customer_id ; ?>" readonly="readonly">

                                <div class="col-md-6">
                                    <label>Mobile Number</label>
                                    <input type="mobile" name="s_mobile" id="s_mobile" class="form-control" onkeyup="myFunction()" value="<?php echo $bill->customer_mobile ; ?>" readonly="readonly">
