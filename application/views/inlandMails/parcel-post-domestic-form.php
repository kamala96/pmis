                                ...
                                <div class="row"><!--
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- <button class="btn btn-info btn-sm disable" type="submit">Save Information</button> -->
                                         <button onclick="saveInformations()" class="btn btn-info disable" type="button" id="submitfodrm" >Save Information</button>
                                    </div>
                                </div>
                                </div>
...
function saveInformations(){
      ...
      $.ajax({
        type : "POST",
        url  : "<?php echo base_url('unregistered/parcel_post_sender_info')?>",
        dataType : "JSON",
        data : {
         transport:trans,
         Barcode:Barcode,
