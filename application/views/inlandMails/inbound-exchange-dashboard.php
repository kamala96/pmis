      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                   <h3 class="text-themecolor"><i class="fa fa-braille" style="color:#1976d2"></i> OFFICE OF INBOUND EXCHANGE DASHBOARD</h3>
                </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">
                            Inbound Exchange Office
                      </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>unregistered/inbound_Ems_Exchange" class="text-muted m-b-0">Ems Inbound Exchange</a>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>unregistered/inbound_mail_Exchange" class="text-muted m-b-0">Mail Inbound Exchange</a>
                                        </div>
                                </div>
                            </div>
                        </div>
