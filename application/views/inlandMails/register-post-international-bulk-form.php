                           ...
                           <div class="card-body">
                            ...
                            <input type="hidden" name="accno" id="accno" class="form-control" value="<?php echo @$custinfo->acc_no; ?>">
                              ...
                              <div id="div2" style="display: none;">
                                ...
                                <div class="col-md-12">
                                    <h3>Step 2 of 3  - Register Selection</h3>
                                </div>
        ...
        $('#div2').show();
         ...
         $('#submitform').on('click',function(){ 
            $('.disable').attr("disabled", true);
             ...
             $.ajax({
                             type : "POST",
                             url  : "<?php echo base_url('unregistered/save_register_sender_bulk_info')?>",
                             //dataType : "JSON",
                ...
                if (address == 'physical') {
                    ...
                    var catid  = $('.catid').val();
                        ...
                        var district         = $('#rec_dropp').val();
                            ...
                            $.ajax({
                             type : "POST",
                             url  : "<?php echo base_url('unregistered/international_register_sender_bulk_info')?>", 
                             //dataType : "JSON",
