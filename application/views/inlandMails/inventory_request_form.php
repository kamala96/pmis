...
<div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor"><i class="fa fa-university" aria-hidden="true"></i> Request Form</h3>
            </div>
        ...
        <div class="container-fluid">
            <div class="row m-b-10"> 
                ...
                <?php if($auth == "PMU"){?>
                    <button type="button" class="btn btn-info"><i class=""></i><a href="<?php echo base_url()?>inventory/dashboard" class="text-white"><i class="fa fa-list" aria-hidden="true"></i> Request From Region Strong Room</a></button>
            ...
            <form method="POST" action="<?php echo base_url()?>inventory/send_request"> 
            <div class="row">
                <div class="col-12">
                    ...
                    <table class="table" id="dynamic_field"> 
                        ...
                        <td>
                            ...
                            <select name="stock_type[]" class="custom-select form-control stid" onchange="getStampname();" required="required">
                        ...
                        <td>
                            ...
                            <select name="stock_name[]" class="custom-select form-control stockname" required="required">
                        ...
                        <td>
                            ...
                            <input type="text" name="quantity[]" class="form-control" required="required"></td>  
