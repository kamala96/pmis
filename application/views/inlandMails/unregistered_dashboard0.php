                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>unregistered/registered_international_form" class="text-muted m-b-0">Registered International</a>
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>unregistered/domestic_item_ready_to_deliver" class="text-muted m-b-0">Domestic Item Ready To Deliver</a>
                                        </div>
                                </div>
                            </div>
                        </div>
