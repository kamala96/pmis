      ...
      <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                   <h3 class="text-themecolor"><i class="fa fa-braille" style="color:#1976d2"></i> OFFICE OF EXCHANGE DASHBOARD</h3>
                </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>unregistered/inbound_Exchange" class="text-muted m-b-0">Inbound Exchange Office</a>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>unregistered/Outbound_Exchange" class="text-muted m-b-0">Outbound Exchange Office</a>
                                        </div>
                                </div>
                            </div>
                        </div>
