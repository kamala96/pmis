    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                   ...
                   <!-- 
                     <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>unregistered/parcel_bill_domestic_bulk_form?I=<?php echo base64_encode($custinfo->credit_id) ?>&&AskFor=<?php echo $askfor; ?>" class="text-white"><i class="" aria-hidden="true"></i> Add Parcel Bulk Bill  </a></button> -->
                   ...
                   <!--  <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>Bill_Customer/register_bill_transaction_list?AskFor=<?php echo $askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Register Bill Transactions List</a></button> -->
                    ...
                    <!--  <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>unregistered/parcel_post_application_list?AskFor=<?php echo $askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Parcel Post Transactions List</a></button> -->
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Parcel Bill Post Application Form
                        </h4>
                    </div>
                    <div class="card-body">
                         ...
                         <div class="row">
                              <div class="col-md-12">
                                ...
                                <label>Weight in kg:</label>
                                 ...
                                 <input type="number" readonly oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" name="weight" class="form-control catweight" id="weight" onkeyup="getPriceFrom()"  />
                                <span id="weight_error" style="color: red;"></span>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $('#div2').show();
         ...
         $('#submitformN').on('click',function(){
           ...
           $('#submitformOld').on('click',function(){ 
            $('.disable').attr("disabled", true);
             ...
             $.ajax({
                             ...
                             success: function(data){
                                ...
                                //   $('#div4').show();
                                  ...
                                  window.location.href = "<?php echo base_url() ?>unregistered/parcel_bill_domestic_bulk_form?I=<?php echo base64_encode($custinfo->credit_id) ?>&&AskFor=<?php echo $askfor; ?>";
                    ...
                    $('#divadd').hide();
                     ...
                     var district = $('.district').val();
                       if(name == ''){
                        ...
                        $.ajax({
                         type : "POST",
                         url  : "<?php echo base_url('unregistered/bulk_bill_parcel_post_sender_info')?>",
                         dataType : "JSON",
                         data : {
                            weight:weight,
                            transport:transport,
