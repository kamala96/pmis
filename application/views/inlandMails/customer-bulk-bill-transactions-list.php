    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?php echo $this->session->userdata('askfor')?> Bill Transactions List</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
        ...
        <div class="row m-b-10">
                ...
                <div class="col-12">
                     <?php if($this->session->userdata('user_type') == "EMPLOYEE"){ ?>
                          ...
                          <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/mail_bulk_bill_customer_list?AskFor=<?php echo $this->session->userdata('askfor')?>" class="text-white"><i class="" aria-hidden="true"></i><?php echo $this->session->userdata('askfor')?> Bulk Bill Customer List</a></button>


                    <?php }if($this->session->userdata('user_type') == "ADMIN" || $this->session->userdata('user_type') == "ACCOUNTANT"){ ?>

                      <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Bill_Customer/bulk_bill_customer_form?AskFor=<?php echo @$this->session->userdata('askfor');?>" class="text-white"><i class="" aria-hidden="true"></i> Add <?php echo $this->session->userdata('askfor')?> Bulk Bill Customer</a></button>
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/mail_bulk_bill_customer_list?AskFor=<?php echo @$this->session->userdata('askfor');?>" class="text-white"><i class="" aria-hidden="true"></i> <?php echo $this->session->userdata('askfor')?> Bulk Bill Customer List</a></button>
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/bulk_bill_transactions_list?AskFor=<?php echo @$this->session->userdata('askfor');?>" class="text-white"><i class="" aria-hidden="true"></i> <?php echo $this->session->userdata('askfor')?> Bulk Bill Transactions List</a></button>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"><?php echo $this->session->userdata('askfor')?> Bulk Bill Transactions List                       
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                           <div class="card-body">
                            <form action="bulk_bill_transactions_list" method="POST">
