                    ...
                    <div class="card">
                      <div class="card-body">
                         <div class="row">
                          ...
                          <?php }else{?>
                          <?php } ?>
                            <form action="item_list_by_bag_no?bagno=<?php echo base64_encode($bagno) ?>" method="POST">
                             ...
                             <!--  <th>Control No</th> -->
                              <th>Track No.</th>
                              <th>Item Status</th>
                            <?php if( $this->session->userdata('despatch') == "Despout"){ ?>
                        ...
                        <tbody>
                            ...
                            <?php } else{?>
                             <td >
                                        ...
                                        <?php if($value->sender_status == "Received"){ ?>
                                          <input type='checkbox'  class='form-check-input checkSingles' id='remember-me' value='' checked="checked" disabled="disabled">
                                        <?php }else{ ?>
                        ...
                        <?php }else{ ?>
                          ...
                          <?php if( $this->session->userdata('despatch') == "Despout"){ ?>
                            ...
                            <tr>
                              ...
                              <td colspan="9"></td>
                               <td><input type="text" name="bagno" class="form-control" placeholder="Bags Number" required=""></td>
                            <?php }else{?>
                              <td colspan="10"></td>
                            <?php }?>
                              <td>
