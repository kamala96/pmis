        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <form action="register_sender_info?AskFor=<?php echo $askfor; ?>" method="POST">
                        <div class="card">
                           ...
                           <div class="card-body">
                            ...
                            <select name="ad_fee" value="" class="form-control custom-select ad_fees" >
                                ...
                                <div class="col-md-6 physical" style="display: none;">
                                    <label><h4>Mobile Number:</h4></label>
                                    <input type="mobile" name="s_mobile" id="s_mobile" class="form-control" onkeyup="myFunction()" value="<?php echo @$custinfo->cust_mobile; ?>">
