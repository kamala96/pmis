                    ...
                    <div class="card">
                      <div class="card-body">
                         <div class="row">
                          ...
                          <?php }else{?>
                          <?php } ?>
                            <form action="close_item_in_bag" method="POST">
                        ...
                        <?php }else{ ?>
                          <tfoot>
                            <tr>
                              ...
                              <td colspan="3">
                                 <select name="branch_to" value="" class="form-control custom-select"  id="rec_dropp">
                                          <option value="">--Select Branch--</option>
                                      </select>
                              </td>
                              <td colspan="3">
                                <input type="text" name="number" class="form-control" placeholder="Bag Weight" required="required">
                              </td>
                              <td><button class="btn btn-sm btn-info">Close Item In Bag</button></td>
                            </tr>
                          </tfoot>
                        <?php }?>
                        </table>
