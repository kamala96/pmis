                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if( $this->session->userdata('user_type') == "EMPLOYEE"|| $this->session->userdata('user_type') == "SUPERVISOR" || $this->session->userdata('user_type') == "AGENT"){ ?>
                                 ...
                                 <a href="<?php echo base_url()?>Box_Application/Send?I=<?php echo base64_encode($value->credit_id) ?>&acc_no=<?php echo $value->acc_no;?>" class="btn btn-info">Services</a>
                               <?php } ?>
                               ...
                               <?php //}} ?>
                                 ...
                                 <?php }else{ ?>
                                  ...
                                  <?php }else{?>
                                 <a href="<?php echo base_url()?>Box_Application/Send?I=<?php echo base64_encode($value->credit_id)?>&AskFor=<?php echo $this->session->userdata('askfor')?>" class="btn btn-info">Services</a>
                               <?php } ?>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 id="loadingtext" style="color: red;"></h3>
         ...
         <!-- <label >Credit Number: </label>  <input type="text" id="serial" readonly /> -->
  ...
  $(".getnewcontrol").click(function(){
    ...
    var amount = $('#newamount').val();
      ...
      $.ajax({
       ...
       url: "<?php echo base_url();?>Bill_Customer/get_NewControlNo",
       method:"POST",
       data:'crdid='+ crdid +'&amount='+ amount,
       success: function(data){
