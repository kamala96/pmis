                            ...
                            <table id="example4" class="display nowrap table table-hover  table-bordered" cellspacing="0" width="100%" style="text-transform: capitalize;">
                             ...
                             <!--  <th>Track No.</th>
                              ...
                              <th><div class="form-check" style="text-align: center;" id="showCheck">
                                   ...
                                   <label class="form-check-label" for="remember-me">Check</label>
                                 </div></th>
                            </tr>
                          </thead>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      if(empty($check))
                                      {
                                                 ...
                                                 echo ' <span>Posts Cargo Type: </span> <span>'. 'Bulk'.'</span><br>';
                                                 echo ' <span>Item: </span> <span>'.$value->ems_type.'</span><br>';
                                                echo ' <span>Price: </span> <span class="box-owner">'.number_format($value->paidamount,2).'</span><br>';
                                  ...
                                  <!--   <td>
                                    ...
                                    <td >
                                        ...
                                        <?php if( $value->office_name == "Counter" && $value->status == "Paid"){?>
                                        <input type='checkbox' name='I[]' class='form-check-input checkSingles' id='remember-me' value='<?php echo $value->sender_id; ?>'>
