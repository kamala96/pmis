                    ...
                    <div class="card">
                      <div class="card-body">
                         ...
                         <div class="row">
                          ...
                          <?php }else{?>
                          <?php } ?>
                            <form action="total_combine_bags" method="POST">
                        ...
                        <tbody>
                            <?php if(!empty($list)){
                              $i = 1; foreach ($list as $value) {$value = (object)$value;?>
                                <tr>
                                  <td><?php echo $i++ ?></td>
                                   <td><?php echo $value->date_created; ?></td>
                                  <td>
                                    <a href="
                               <?php echo base_url()?>unregistered/combine_item_list_bags?trn=<?php 
                               $trs=$value->bag_number.'$'.$value->type;
                               echo $trs;  ?>"data-bagno = "<?php echo $value->bag_number; ?>" class="listitem">
                                <?php echo $value->bag_number;?>
                                  ...
                                  <td>
                                    <div class='form-check' style="text-align: center;">
                                     <input type="checkbox" hidden="hidden" class='form-check-input checkSingles' id='remember-me' name='C[]' value='<?php echo $value->type; ?>'>

                                        <input type='checkbox' name='I[]' class='form-check-input checkSingles' id='remember-me' value='<?php 
                                        $rst= $value->bag_id.'-'.$value->type;
                ...
                <div class="row" style="padding-left: 10px;padding-right: 35px; text-align: left;">
                    <div class="col-md-3">
                     ...
                     <select name="type" class="form-control custom-select actiontype" onChange="Type()">
                      ...
                      <option value="remove">Remove from combine</option>
                  </select>
              </div>
                </div>
