                        ...
                        <div class="card">
                           ...
                           <div class="card-body">
                              ...
                              <div id="div1" >
                                ...
                                <div class="col-md-12">
                                    <h3>Step 2 of 3  - Posts Cargo Selection</h3>
                                </div>
                                ...
                                <div class="row"><!--
                                    ...
                                    <div class="">
                                        <button class="btn btn-warning btn-md" id="1stepBack">Back Step</button>
                                         <a href="#"  class="btn btn-info btn-md" id="btn_saved">Add More</a>
...
<script type="text/javascript">
   ...
   function Deletevalue() {
     ...
     $.ajax({
         type : 'POST',
         url  : '<?php echo base_url('Box_Application/delete_cargo_bulk_info')?>',
...
$('#submitform').on('click',function(){ 
            $('.disable').attr("disabled", true);
             ...
             $.ajax({
                             type : "POST",
                             url  : "<?php echo base_url('Box_Application/save_cargo_info')?>",
                             //dataType : "JSON",
     ...
     //console.log('single obj from  ', myArray);
       //console.log('object from  array ', TotalOutstandingamount);
        ...
        //console.log('object from form array ', myArray2);
           ...
           $.ajax({
                 type : "POST",
                 url  : "<?php echo base_url('Box_Application/Register_Ems_Action_save_bulk')?>",
                 //dataType : "JSON",
                 data : { serial:serial,senderselect:senderselect,s_fname:s_fname,s_address:s_address,s_email:s_email,s_mobile:s_mobile,Barcode:Barcode,
