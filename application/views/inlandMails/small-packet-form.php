...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Small PAckets Application</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Small Packets Application</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>unregistered/small_packet_form" class="text-white"><i class="" aria-hidden="true"></i> Add Small Packets Transaction</a></button>
               
                     <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>unregistered/small_packets_application_list" class="text-white"><i class="" aria-hidden="true"></i> Small Packets Transactions List</a></button>
                </div>
        </div>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Small Packets Application Form
                        </h4>
                    </div>
                    <div class="card-body">
                        <form action="small_packet_sender_info" method="POST" id="wixy">
                        <div class="card">
                           ...
                           <div class="card-body">
                            <div id="div1">
                                ...
                                <div class="col-md-12">
                                    <h3>Step 1 of 4  - Register Selection</h3>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Small Packets Type</label>
                                    <select name="emsname" value="" class="form-control custom-select boxtype" required  onchange="functionParcel();">
                                            <option value="Bulky">E-Bulky</option>
                                            <option value="Good">E-Good</option>
                                        </select>
                            ...
                            <!-- <input type="text" name="weight" class="form-control catweight" id="weight" onkeyup="getPriceFrom()"> -->
                             ...
                             <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" name="weight" class="form-control catweight" id="weight" onkeyup="getPriceFrom()"  />
                                ...
                                <div class="col-md-6">
                                    <label>Full Name:</label>
                                    <input type="text" name="r_fname" id="r_fname" class="form-control r_fname" onkeyup="myFunction()">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if ($('#s_fname').val() == '') {
          ...
          $('#errfname').hide();
            $('#errmobile').html('Please Input Sender Mobile Number');
