...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Parcel Bulk Post Application</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Parcel Bulk Post</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                      ...
                      <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/mail_bulk_bill_customer_list?AskFor=<?php echo $askfor;  ?>" class="text-white"><i class="" aria-hidden="true"></i>Bulk Bill Customer List</a></button>
                   
                  
                   
                     <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>unregistered/parcel_bill_bulk_post_form?I=<?php echo base64_encode($custinfo->credit_id) ?>&&AskFor=<?php echo $askfor; ?>" class="text-white"><i class="" aria-hidden="true"></i> Add Parcel Bulk Bill Post  </a></button>

                  
                   
               
                     <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>unregistered/parcel_mail_bulk_post_application_list?AskFor=<?php echo $askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Parcel Bill Post Transactions List</a></button>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Parcel Bill Bulk Post Application Form
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <!-- <div id="div1">
                               ...
                               <!--  <div class="col-md-3">
                                ...
                                <label>Parcel Selection:</label>
                                 <select class="form-control custom-select trans" id="trans" name="transport" required>
                                   <option value="0">--Parcel Type--</option>
                                   <option value="InLand">INLAND PARCELS POST</option>
                                   <option value="Water">PARCEL SUBJECTED TO PORT CHARGES</option>
                                 </select>
                                 <span id="transerror" style="color: red;"></span>
                                </div>
                                ...
                                <span id="weight_error" style="color: red;"></span>
                                 ...
                                 <div class="col-md-3">
                                    ...
                                    onkeypress="return AvoidSpace(event);" onblur="this.value=removeSpaces(this.value);"
                        ...
                        Advice Fee <input type="checkbox" name="Advice" class="form-control Advice" onchange="getPriceFrom()"> <!-- style="padding-top: 200px;" -->
                        Pickup Charge <input type="checkbox" name="Pickup"  class="form-control Pickup" onchange="getPriceFrom()" >
                         Delivery Charge <input type="checkbox" name="Delivery"  class="form-control Delivery" onchange="getPriceFrom()">
                        ...
                        <br />
                              ...
                              <br />
                                ...
                                <div class="row"><!--
                                    <div class="col-md-6"></div> -->
                                    <div class="col-md-6">
                                    <input type="hidden" name="crdtid" id="" class="form-control crdtid" onkeyup="myFunction()" value="<?php echo @$custinfo->credit_id; ?>">
 ...
 <button id="submitform" type="button" class="btn btn-info disable"><a href="<?php echo base_url() ?>unregistered/parcel_bill_bulk_post_form?I=<?php echo $_GET['I']; ?>?AskFor=<?php echo $askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Save Information</a></button>
...
function getPriceFrom() {
 ...
 var weight = $('.catweight').val();
  ...
  var Pickup  = $('.Pickup').val();
   ...
   if($('.Delivery').is(':checked')){Delivery ='onn'; }
      if($('.Pickup').is(':checked')){Pickup ='onn'; }
         if($('.Advice').is(':checked')){Advice ='onn'; }
...
if (weight == '') {
    ...
    $.ajax({
                 type : "POST",
                 url  : "<?php echo base_url('unregistered/parcel_post_price_bulk')?>",
                 //dataType : "JSON",
                 data : {weight:weight,tariffCat:tariffCat,trans:trans,Advice:Advice,Pickup:Pickup,Delivery:Delivery,crdtid:crdtid},
                 success: function(data){
                    $('.price').html(data);
                 }
             });
...
<script type="text/javascript">
    ...
    function Deletevalue(obj) {
        ...
        var barcode= $(obj).attr('data-barcodeno');
        var registerid= $(obj).attr('data-registerid');
        ...
        $('#loadingtext').html('Deleting process, please wait............');
         ...
         $.ajax({
            type : 'POST',
            url  : '<?php echo base_url('unregistered/deleteRegisterSenderInfo')?>',
            data : {senderid:registerid},
            success: function(data){
                $('.'+barcode).remove();//remove on the View
                $('#totalAmount').val(totalAmount - parseFloat(itemAmount));  
                $('#loadingtext').html('');
            }
           });
    }
             ...
             $.ajax({
                             ...
                             success: function(data){
                                ...
                                //   $('#div4').show();
                                  ...
                                  window.location.href = "<?php echo base_url() ?>unregistered/parcel_bill_bulk_post_form?I=<?php echo base64_encode($custinfo->credit_id) ?>&&AskFor=<?php echo $askfor; ?>";
                ...
                if (address == 'physical') {
                    ...
                    //        // $('.disable').attr("disabled", true);
                       ...
                       $('#submitform').hide();
                        ...
                        $.ajax({
                         type : "POST",
                         url  : "<?php echo base_url('unregistered/bulk_bill_POST_parcel_post_sender_info')?>",
                         //dataType : "JSON",
                         data : {weight:weight,transport:transport,emsname:emsname,serial:serial,crdtid:crdtid,price:price,accno:accno,Barcode:Barcode,
                                  Advice:Advice,Pickup:Pickup,Delivery:Delivery,
