...
<div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor"><i class="fa fa-university" aria-hidden="true"></i> Return Stock Form</h3>
            </div>
        ...
        <div class="container-fluid">
            ...
            <form method="POST" action="<?php echo base_url()?>inventory/return_stock"> 
            <div class="row">
                <div class="col-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white"><i class="fa fa-plus" aria-hidden="true"></i>  Return Stock Form<span class="pull-right " ></span></h4>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                    <h3 style="color: red;">Are you Sure you want to return this stock</h3>
                    <table class="table" id="dynamic_field"> 
                    
                        <tr>  
                        <td>
                            <label> [ Stock Type ]</label>
                            <input type="text" name="stock_type" readonly="readonly" class="form-control" value="<?php echo $issued->stock_type; ?>">
                           
                        </td>
                        <td>
                            <label>[ Stock Name ]</label>
                            <input type="text" name="stock_name" readonly="readonly" class="form-control" value="<?php echo $issued->stampname; ?>">

                        </td>
                        <td>
                            <label>[ Quantity ]</label>
                            <input type="text" name="quantity" readonly="readonly" class="form-control" value="<?php echo $issued->quantity; ?>">
                            </td>  
                               <input type="hidden" name="id" readonly="readonly" class="form-control" value="<?php echo $issued->id; ?>">         
                        </tr> 
                        </table> 
