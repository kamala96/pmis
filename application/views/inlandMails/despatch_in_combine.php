                    ...
                    <div class="card">
                      <div class="card-body">
                         <div class="row">
                          ...
                          <?php }else{?>
                          <?php } ?>
                            <form action="despatch_in_combine" method="POST">
                             ...
                             <th><div class="form-check" style="text-align: center;" id="showCheck">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><a href="combine_bags_item_list_by_despatchno?despno=<?php echo base64_encode($value->desp_no ); ?>&& Ask_for=<?php echo $this->session->userdata('service_type') ?> && type=Despin" class="btn btn-info"><?php echo $value->desp_no ?></a></td>
                                  ...
                                  <td>
                                    <div class='form-check' style="text-align: center;">
                                        <input type='checkbox' name='I[]' class='form-check-input checkSingles' id='remember-me' value='<?php
                                        $rst= $value->desp_id.'-'.$value->type;
                                        echo $rst;?>' style="zoom:2px;">
                                        <label class='form-check-label' for='remember-me'></label>
