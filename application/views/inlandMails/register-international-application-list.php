...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Register International Transaction List</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Register International Transaction List</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                 <div class="col-12">
                  ...
                  <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>unregistered/registered_bulk_international_transaction_List" class="text-white"><i class="" aria-hidden="true"></i> Register International Transaction List</a></button>

            <?php }else{?>
                   <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>unregistered/international_bulk_registered_form" class="text-white"><i class="" aria-hidden="true"></i> Add Register International Transaction</a></button>
                ...
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <div class="table table-responsive">
                          ...
                          <?php }else{?>
                          <?php } ?>
                          <form action="registered_bulk_international_transaction_List" method="POST">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value->billid;
                                         if(empty($value->billid)){
                                                ...
                                                $id = $value->senderp_id;
                                                $this->Box_Application_model->getControlNumber1($serial,$amount,$id);
                                                //echo $value->billid;
                                            }
                                                $serial = $value->serial;
                                                $amount = $value->paidamount;
                                                $this->Box_Application_model->getUpdatePayment($serial,$amount);
                                     ?></td>
                                    ...
                                    <td >
                                        ...
                                        <label class='form-check-label' for='remember-me'></label>
                                        <?php }else{ ?>
                                          <input type='checkbox' class='form-check-input checkSingles' id='remember-me' disabled="disabled">
                                        <label class='form-check-label' for='remember-me'></label>
                                        <?php } ?>
