    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                    ...
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Bill_Customer/mail_bulk_bill_customer_list?AskFor=<?php echo $askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> <?php echo $askfor;?> Bill  Customer List</a></button>
                  ...
                  <!--    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>unregistered/unregistered_bill_bulk_post_form?I=<?php echo base64_encode($custinfo->credit_id) ?>&&AskFor=<?php echo $askfor; ?>" class="text-white"><i class="" aria-hidden="true"></i> Add Bulk Bill Register </a></button> -->

                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>Bill_Customer/register_bulk_bill_transaction_list?AskFor=<?php echo $askfor;?>" class="text-white"><i class="" aria-hidden="true"></i><?php echo $askfor;?> Bill Transactions List</a></button>
                   ...
                   <!-- 
                     <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>unregistered/unregistered_bill_bulk_post_form?I=<?php echo base64_encode($custinfo->credit_id) ?>&&AskFor=<?php echo $askfor; ?>" class="text-white"><i class="" aria-hidden="true"></i> Add Bulk Bill <?php echo $askfor;?> </a></button> -->
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Register Bulk Bill Application Form
                        </h4>
                    </div>
                    <div class="card-body">
                           ...
                           <h2 id="loadingtext"></h2>
                            ...
                            <select name="ad_fee" value="" class="form-control custom-select ad_fees" >
                                ...
                                <div class="col-md-3">
                                    ...
                                    onchange="validateBarcode(this)" onkeypress="return AvoidSpace(event);" onblur="this.value=removeSpaces(this.value);" type="text" name="Barcode" class="form-control Barcode" id="Barcode" required>
                   ...
                   <!-- <button  class='btn btn-info Delete' onclick=Deletevalue(); type='button' value="2"  id='Delete'>Delete </button> -->
                    ...
                    <a  class="btn btn-info" disable href="<?php echo base_url() ?>Bill_Customer/mail_bulk_bill_customer_list?AskFor=<?php echo $askfor;?>" class="text-white"><i class="" aria-hidden="true"></i><?php echo $askfor;?>Save Information</a>
                ...
                // }else{
                 ...
                 $.ajax({
                             ...
                             success: function(data){
                                ...
                                window.location.href = "<?php echo base_url() ?>unregistered/unregistered_bill_bulk_post_form?I=<?php echo base64_encode($custinfo->credit_id) ?>&&AskFor=<?php echo $askfor; ?>";
                ...
                if (address == 'physical') {
                    ...
                    var Barcode  = $('.Barcode').val();
                        ...
                        $('#loadingtext').html('Please wait............');
                            ...
                            $.ajax({
                             type : "POST",
                             url  : "<?php echo base_url('unregistered/register_bill_sender_bulk_post_info')?>",
                             //dataType : "JSON",
                             data : {weight:weight,emstype:emstype,ad_fee:ad_fee,crdtid:crdtid,price:price,accno:accno,Barcode:Barcode,
...
if (weight == '' || ad_fee == '') {
    ...
    $.ajax({
                 ...
                 //dataType : "JSON",
                 data : {weight:weight,tariffCat:tariffCat,ad_fee:ad_fee,crdtid:crdtid},
                 success: function(data){
                    $('.price').html(data);
                 }
             });
