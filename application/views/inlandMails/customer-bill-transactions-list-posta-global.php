...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                ...
                <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/bill_transactions_list_postal_global" class="text-white"><i class="" aria-hidden="true"></i> Bill Transactions</a></button>
