                                     ...
                                     <form id="from_counter" action="registered_domestic_dashboard?Ask_for=<?php echo $this->session->userdata('service_type'); ?>" method="POST">
                                      <input type="text" hidden="hidden" name="status" value="Back" class="" >
                                       <input type="text" hidden="hidden" name="type" value="Back" class="" >
                                        ...
                                        <a href="javascript:{}" onclick="document.getElementById('from_counter').submit(); return false;" class="text-muted m-b-0">Total Item from Counter</a>
                                      </form>
                      ...
                      <div class="card-body">
                        ...
                        <hr/>
                         ...
                         <div class="row">
                          ...
                          <?php }else{?>
                          <?php } ?>
                            <form action="registered_domestic_dashboard?Ask_for=<?php echo $this->session->userdata('service_type'); ?>" method="POST">
