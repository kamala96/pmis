                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>unregistered/parcel_domestic_dashboard" class="text-muted m-b-0">Parcel Post Domestic</a>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>parcel/international_parcel_form" class="text-muted m-b-0">Parcel Post International</a>
                                        </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>unregistered/domestic_item_ready_to_deliver?Ask_for=Parcels-Post" class="text-muted m-b-0">Domestic Item Ready To Deliver</a>
                                        </div>
                                </div>
                            </div>
                        </div>
