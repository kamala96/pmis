...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                                           <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>unregistered/posts_cargo_form" class="text-white"><i class="" aria-hidden="true"></i> Posts Cargo Transaction</a></button>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Posts Control Number Form
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
