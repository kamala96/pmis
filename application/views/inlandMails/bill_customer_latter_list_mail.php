...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Ordinary Latter Application List</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
            <li class="breadcrumb-item active">Ordinary Latter Application List</li>
        </ol>
    </div>
</div>
<!-- Container fluid  -->
    ...
    <div class="row m-b-10">
       <div class="col-12">
                   ...
                   <?php if($this->session->userdata('user_type') == "EMPLOYEE" || $this->session->userdata('user_type') == "SUPERVISOR" || $this->session->userdata('user_type') == "AGENT"){ ?>
                     ...
                     <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/latter_bulk_bill_transaction_list?AskFor=<?php echo $askfor;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Transactions Lists</a></button>
                   
                    <?php }if($this->session->userdata('user_type') == "ADMIN" || $this->session->userdata('user_type') == "ACCOUNTANT"){ ?>
                       <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Bill_Customer/bulk_bill_customer_form?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Add Bulk Bill Customer</a></button>

                   <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/latter_bulk_bill_transaction_list?AskFor=<?php echo $askfor;  ?>" class="text-white"><i class="" aria-hidden="true"></i>Ordinary Latter Bill Transactions Lists</a></button>
            ...
            <div class="card-body">
                <div class="card">
                   <div class="card-body">
                    <div class="row">
                        ...
                        <form method="POST" action="Credit_Customer_Prepare_bulk_Bill?I=<?php echo base64_encode($credit_id);?>&&AskFor=<?php echo $askfor; ?>">
             ...
             <form method="POST" action="send_to_back_office">
                <div class="table-responsive">
                  ...
                  <tfoot>
                    <tr><td colspan="5"></td><td style="font-size: 16px;">Total::</td><td style="font-size: 16px;"><b><?php echo number_format(@$sum->paidamount,2);?></b></td></tr>
