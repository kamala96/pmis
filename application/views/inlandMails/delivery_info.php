...
<div class="container-fluid">
    <div class="row m-b-10">
        <div class="col-12">
              ...
              <form id="waiting" action="<?php echo base_url()?>Unregistered/registered_domestic_Delivery?Ask_for=<?php echo $this->session->userdata('service_type'); ?>" method="POST" >
                                     ...
                                     <form id="assigned" action="<?php echo base_url()?>Unregistered/registered_domestic_Delivery?Ask_for=<?php echo $this->session->userdata('service_type'); ?>" method="POST">
                                      ...
                                      <form id="delivered" action="<?php echo base_url()?>Unregistered/registered_domestic_Delivery?Ask_for=<?php echo $this->session->userdata('service_type'); ?>" method="POST" >
