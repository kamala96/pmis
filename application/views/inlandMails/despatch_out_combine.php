                    ...
                    <div class="card">
                      <div class="card-body">
                         <div class="row">
                          ...
                          <?php }else{?>
                          <?php } ?>
                            <form action="despatch_out_combine?Ask_for=<?php echo $this->session->userdata('service_type'); ?>" method="POST">
                             ...
                             <table id="example4" class="display nowrap table table-hover  table-bordered" cellspacing="0" width="100%" style="text-transform: capitalize;">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <a href='Combine_list_delivery_bills_despatched?despno=<?php echo base64_encode($value->desp_no ); ?>' data-despno = '$value->desp_no' class='bagsList127'> <?php echo $value->desp_no;?> </a>
                                    </td>
