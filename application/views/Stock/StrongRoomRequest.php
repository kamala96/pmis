...
$(document).ready(function(){
    ...
    $(".add-new").click(function(){
      ...
      '</td>' +
            ...
            '<td><input type="number" class="form-control" name="QuantityReq['+ index + ']" >'+
 ...
 var index = 0;
                ...
                <div class="col-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white"><i class="fa fa-plus" aria-hidden="true"></i>  Request Form<span class="pull-right " ></span></h4>
                        </div>
  ...
  <div class="card-body">
    ...
    <div id="app" class="container invoice">
        <div class="row">
        <form class="row" method="post" action="Savestrongroomrequest" enctype="multipart/form-data">
            ...
            <div class="col-12 content py-4">
                ...
                <div align="left" style="font-size:0px;word-break:break-word;float:left;">
                                            ...
                                            <div align="center" style="font-size:0px;word-break:break-word;">
                                                ...
                                                <div align="right" style="font-size:0px;word-break:break-word;float:right;">
                                                       <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:24px;font-weight:;line-height:22px;text-align:left;color:#525252; "> S 64 </div>
                                                        <input type="text" class="input-label form-control" hidden name="formno" value="S64" />
                                                   </div>
                    ...
                    <div class="col-md-3" style="float:left;">
                                <div class="field">
                                    <input type="text" class="input-label form-control" placeholder="To" hidden name="issuedby" value="" />
                                    <input type="text" class="input-label form-control" placeholder="To" name="" value="" />
                             
                                </div>
                                <div class="value">
                                    <textarea class="form-control" placeholder="Issued Officer" readonly ></textarea>
                                </div>
                     </div>
...
<!-- 
                ...
                <div class="col-sm-10"></div>
                    <div class="col-md-2" style="float:right;">
                        <button type="submit" class="btn btn-info "><i class="fa fa-menu"></i> Send Request </button>
                    </div>
                </div>
            </div>
