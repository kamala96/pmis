...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		...
		<div class="col-md-7 align-self-center">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Counter Stock </li>
			</ol>
		</div>
	</div>
	<!-- Container fluid  -->
	...
	<div class="container-fluid">
		<div class="row m-b-10">
            ...
            <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Stock/StrongRoom" class="text-white"><i class="" aria-hidden="true"></i> Strong Room Reques</a></button>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i>Counter Stock List</h4>
                </div>
                                     ...
                                     <?php foreach($philatel as $value): ?>
                                        <tr>
                                           ...
                                           <td class="Hidden"><?php echo $value->releasedate; ?></td>
                                            ...
                                            <td><?php echo $value->Regionbranch; ?></td>
		                                   <!-- <td class="jsgrid-align-center " style="text-align: right;">
		                                   	 <a href="<?php echo base_url(); ?>Stock/StampBureau" title="Edit" class="btn btn-sm btn-info waves-effect waves-light">Issue Stamp</a>
		                                   </td> -->
