    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Stamp Bureau </li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
                   ...
                   <?php 
                     $id = $this->session->userdata('user_login_id');
                      ...
                      $sub_role = $basicinfo->em_sub_role;
                        ?>
                <?php if($sub_role=='STRONGROOM'){ ?> 

              <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Stock/StrongRoom" class="text-white"><i class="" aria-hidden="true"></i> Requisition Form</a></button>
  <?php  } ?>
                 <?php if($sub_role=='COUNTER'){ ?> 
            <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Stock/Counter_Request" class="text-white"><i class="" aria-hidden="true"></i> Counter Request</a></button>
<?php  } ?>
            <?php if($sub_role=='BRANCH'){ ?> 
            <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Stock/Branch_Request" class="text-white"><i class="" aria-hidden="true"></i> Branch Request</a></button>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i> Request</h4>
                </div>
                                ...
                                <table id="kiwi" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="display:none;">SellingPrice</th>
                                            <th style="display:none;">SellingValue</th>
                                            <th style="display:none;">AcCode</th>
                ...
                ?>      
                                        ...
                                        <tr style="text-align: center;">
                                             <td><?php echo $stockname; ?></td>
                                              <td><?php echo $value->RequestedBy; ?></td>
                                            <td>
                                            <?php echo  date('D', strtotime($value->RequestedDate)) .' - '.date('M', strtotime($value->RequestedDate)).' - '.date('Y', strtotime($value->RequestedDate)); ?>
                                                
                                            </td>
                                           
                                            <td><?php echo $value->QuantityReq; ?></td>
                                            <td><?php echo $value->ApprovedBy; ?></td>
                                            <td>
                                            <?php echo  date('D', strtotime($value->AppovedDate)) .' - '.date('M', strtotime($value->AppovedDate)).' - '.date('Y', strtotime($value->AppovedDate)); ?>
                                                
                                            </td>
                                            <td><?php echo $value->QuantitySupp; ?></td>
                                            <td style="display:none;"><?php echo $value->SellingPrice; ?></td>
                                            <td style="display:none;"><?php echo $value->SellingValue; ?></td>
                                            <td style="display:none;"><?php echo $value->AcCode; ?></td>
                                            <td><?php echo $value->ReceivedBy; ?></td>
                                            <td>
                                            <?php echo  date('D', strtotime($value->ReceivedDate)) .' - '.date('M', strtotime($value->ReceivedDate)).' - '.date('Y', strtotime($value->ReceivedDate)); ?>
                                          ...
                                          <a href="<?php echo base_url();?>Stock/viewrequest/<?php echo $value->serialno;?>" title="viewrequest" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-eye"></i></a>  
