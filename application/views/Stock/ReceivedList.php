...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Received</h3>
		</div>
		<div class="col-md-7 align-self-center">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a  href="<?php echo base_url(); ?>Stock/Requisition_Form">Received</a></li>
	...
	<div class="container-fluid">
		<div class="row m-b-10">
			<div class="col-12">
				<!-- <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#appmodel" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Received List </a></button> -->
			   
			<button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>Stock/Receive" class="text-white"><i class="" aria-hidden="true"></i> Back To UnReceived List </a></button> 
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i> Received List</h4>
                </div>
                ...
                ?>      
                                        ...
                                        <tr style="text-align: center;">
                                          ...
                                          <a href="<?php echo base_url();?>Stock/ViewReceived/<?php echo $value->serialno;?>" title="View Item" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-eye"></i></a>  
