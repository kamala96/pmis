                    ...
                    <?php 
                     $id = $this->session->userdata('user_login_id');
                      ...
                      $sub_role = $basicinfo->em_sub_role;
                        ?>
                <?php if($sub_role=='STORE'){ ?> 

			<div class="col-lg-3 col-md-6">
                        <div class="card" >
                            <div class="card-body">
                            	<a href="<?php echo base_url(); ?>Stock/StampBureau" class="text-white">
                ...
                <?php if($sub_role=='STORE' ){ ?> 
                    <div class="col-lg-3 col-md-6">
                        <div class="card" >
                        	<div class="card-body">
                        		 <a href="<?php echo base_url(); ?>Stock/Locklist" class="text-white">
                            
                                <div class="d-flex flex-row">
                                    <div class="round align-self-center round-info"><i class="fa fa-tasks"></i></div>
                                    <div class="m-l-10 align-self-center">
                                         <h3 class="m-b-0"> 
                                       <b>Private Box/Locks</b>
                                   </h3>
                                        </div>
                ...
                <?php if($sub_role=='STORE'){ ?> 
                    <div class="col-lg-3 col-md-6">
                        <div class="card" >
                            <div class="card-body">
                                <a href="<?php echo base_url(); ?>Stock/Cashlist" class="text-white">
                                <div class="d-flex flex-row">
                                    <div class="round align-self-center round-info"><i class="fa fa-bank"></i></div>
                                    <div class="m-l-10 align-self-center">
                                        <h3 class="m-b-0"> 
                    ...
                    <?php 
                     $id = $this->session->userdata('user_login_id');
                      ...
                      $sub_role = $basicinfo->em_sub_role;
                        ?>
                <?php if($sub_role=='STRONGROOM' || $sub_role=='BRANCH' || $sub_role=='COUNTER'){ ?> 

                    <div class="col-lg-3 col-md-6">
                        <div class="card" >
                            <div class="card-body">
                                 <a href="<?php echo base_url(); ?>Stock/StockRequest" class="text-white">
                            
                                <div class="d-flex flex-row">
                                    <div class="round align-self-center round-success"><i class="fa fa-tasks"></i></div>
                                    <div class="m-l-10 align-self-center">
                                         <h3 class="m-b-0"> 
                                       <b>Send Request</b>
                                   </h3>
                     ...
                     $id = $this->session->userdata('user_login_id');
                      ...
                      $sub_role = $basicinfo->em_sub_role;
                        ?>
                <?php if($sub_role=='STRONGROOM' || $sub_role== 'BRANCH' | $sub_role=='STORE'){ ?> 
                     <div class="col-lg-3 col-md-6">
                        <div class="card" >
                            <div class="card-body">
                     ...
                     $id = $this->session->userdata('user_login_id');
                      ...
                      $sub_role = $basicinfo->em_sub_role;
                        ?>
                <?php if($sub_role== 'BRANCH' || $sub_role=='STRONGROOM' || $sub_role=='COUNTER'){ ?> 
                      <div class="col-lg-3 col-md-6">
                        <div class="card" >
                            <div class="card-body">
                                 <a href="<?php echo base_url(); ?>Stock/Receive" >
                            
                                <div class="d-flex flex-row">
                                    <div class="round align-self-center round-danger"><i class="fa fa-tasks"></i></div>
                                    <div class="m-l-10 align-self-center">
                                       <h3 class="m-b-0"> 
                                       <b>Receive/Received </b>
                                   </h3>
                                        </div>
                     ...
                     $id = $this->session->userdata('user_login_id');
                      ...
                      $sub_role = $basicinfo->em_sub_role;
                        ?>
                <?php if($sub_role== 'BRANCH' || $sub_role=='STORE' || $sub_role=='STRONGROOM'|| $sub_role=='COUNTER' ){ ?> 
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card" >
                            <div class="card-body">
                                 <a href="<?php echo base_url(); ?>Stock/StockList" class="text-white">
