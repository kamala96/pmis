...
<div class="page-wrapper">
	...
	<div class="container-fluid">
		<div class="row m-b-10">
			...
			<button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Stock/Add_philatel" class="text-white"><i class="" aria-hidden="true"></i> Add Philatelic Stamp</a></button>

			<button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Stock/Add_stamp" class="text-white"><i class="" aria-hidden="true"></i> Add Stamp</a></button>
			</div>
		</div>
                                     ...
                                     <?php foreach($stock as $value): ?>
                                        <tr>
		                                   ...
		                                   <td class="jsgrid-align-center " style="text-align: right;">
		                                   	 <a href="<?php echo base_url(); ?>Stock/StampBureau" title="Edit" class="btn btn-sm btn-info waves-effect waves-light">Edit</a>
		                                   </td>
