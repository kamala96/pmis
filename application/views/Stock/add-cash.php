    ...
    <?php $regvalue1 = $this->employee_model->branchselect(); ?>
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Stock/Cashlist" class="text-white"><i class="" aria-hidden="true"></i>  Back To Cash List</a></button>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-plus" aria-hidden="true"></i>  Add New Cash<span class="pull-right " ></span></h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="row" method="post" action="Savecash" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        ...
                                        <input type="text"  name="stampname" class="form-control form-control-line" value="" placeholder="Cash Name" > 
                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
                                        <label>Amount </label>
                                         <input type="number" id="" name="pricepermint" class="form-control form-control-line" value="" placeholder="Amount"  required> 
                                    </div>
                                   <div class="form-group col-md-3 m-t-20">
