...
$('#btn_save').on('click',function(){
            ...
            $('#error_district').html('This field is required');
             ...
             $.ajax({
                 ...
                 dataType : "JSON",
                 data : {emstype:emstype,emsCat:emsCat,weight:weight,s_fname:s_fname,s_address:s_address,s_email:s_email,Barcode:Barcode,s_mobile:s_mobile,r_fname:r_fname,r_address:r_address,r_mobile:r_mobile,r_email:r_email,rec_region:rec_region,rec_dropp:rec_dropp},
                 success: function(data){
