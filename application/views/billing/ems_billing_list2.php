                            ...
                            <div class="table-responsive">
                             <table id="example4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                 ...
                                 <?php foreach ($billing as  $value) {?>
                                      ...
                                      <td><a href="<?php echo base_url()?>Box_Application/invoice_sheet_last?acc_no=<?php echo base64_encode($accno)?>&&month=<?php echo $value->invoice_month ?>&&billid=<?php echo $value->billid ?>&&invoiceno=<?php echo $value->invoice_number ?>">Last Invoice</a></td>
                                    </tr>
                                 <?php } ?>
