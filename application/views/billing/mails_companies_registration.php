...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Mails Billing Registration</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Mails Billing Registration</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                    <a href="<?php echo base_url() ?>Box_Application/MAILS_Billing" class="btn btn-primary"><i class="fa fa-plus"></i> Add Company</a>
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>Box_Application/Mails_billing_list" class="text-white"><i class="" aria-hidden="true"></i> Mails BIlling Companies List</a></button>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Mails Billing Company Registration                       
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                           <div class="card-body">
                            <div id="div1"> 
                        <form method="post" action="Mails_billing_action"> 
                                <div class="row">
                            
                                <div class="form-group col-md-6">
                                    <label>Company Name</label>
                                    <input type="text" name="comp_name" class=" form-control" required="required" value="<?php echo @$custinfo->com_name; ?>">
                                </div>

                                <div  class=" form-group col-md-6">
                                <label>Company Address</label>
                                    <input type="text" name="comp_address" class=" form-control" required="required" value="<?php echo @$custinfo->com_address; ?>">
                                </div>
                                 <div class="form-group col-md-6">
                                <label>Company Phone</label>
                                    <input type="text" name="comp_phone" class=" form-control" required="required" onkeypress="myFunction()" id="day13" value="<?php echo @$custinfo->com_phone; ?>">
                                ...
                                <label>Tin Number</label>
                                    <input type="text" name="tin_number" class=" form-control" required="required" value="<?php echo @$custinfo->tin_number; ?>">
                                    
                                </div>
                                <div class="form-group col-md-6">
                                <label>Vrn</label>
                                    <input type="text" name="vrn" class=" form-control" required="required" value="<?php echo @$custinfo->vrn; ?>">
                                ...
                                <br>
                                <input type="hidden" name="comid" value="<?php echo @$custinfo->com_id; ?>">
                                <div class="row"><!-- 
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        if ($('#boxtype').val() == 0) {
            ...
            if ($('#tariffCat').val() == 0) {
                $('#error2').html('Please Select Mails tariff Category Type');
            }else if($('#weight').val() == ''){
...
$('#btn_save').on('click',function(){
            ...
            var Mailstype   = $('#boxtype').val();
            var MailsCat = $('#tariffCat').val();
            ...
            $('#error_district').html('This field is required');
             ...
             $.ajax({
                 type : "POST",
                 url  : "<?php echo base_url('Box_Application/Register_Mails_Action')?>",
                 dataType : "JSON",
                 data : {Mailstype:Mailstype,MailsCat:MailsCat,weight:weight,s_fname:s_fname,s_address:s_address,s_email:s_email,s_mobile:s_mobile,regionp:regionp,branchdropp:branchdropp,r_fname:r_fname,r_address:r_address,r_mobile:r_mobile,r_email:r_email,rec_region:rec_region,rec_dropp:rec_dropp},
