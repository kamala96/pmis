...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Mails Billing Companies List</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Mails Billing Companies List</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Mails BIlling Company List                       
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                            ...
                            <div class="table-responsive">
                             <table id="example4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                 ...
                                 <?php foreach ($company as  $value) {?>
                                      ...
                                      <td style="">
                                        <a href="get_bill_Mails?id=<?php echo $value->com_id;?>&& services=MAILSBILLING" class="btn btn-info">Payment Status/Trend</a> 
                                      </td>
...
<!-- 
                                      ...
                                      <a href="issuedpayment_mails_billing_view?I=<?php echo base64_encode($value->com_id);?>" class="btn btn-info">Issue Payment</a> 
                                      <a href="MAILS_Billing?I=<?php echo base64_encode($value->com_id);?>" class="btn btn-info">Edit</a> 
