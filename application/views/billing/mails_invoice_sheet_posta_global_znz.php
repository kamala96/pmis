...
<body style="text-align: center;font-family: monospace; background-size: 100%;">
  ...
  <table style="width: 100%;">
      ...
      <tr><td></td><td style="text-align: right;font-size: 12px;">VRN : 07000241K</td></tr>
      <tr><td style="font-size: 14px;">DR: TANZANIA POSTS CORPORATION</td><td style="text-align: right;font-size: 12px;">ZRB_NUMBER:Z0025280728</td></tr>
  ...
  <table style="width: 100%;font-size: 14px;border-bottom: solid; 1px;border-top: solid;1px;">
     ...
     <tbody>
         ...
         <tr>
           <td width="60%"><text><?php echo $invoiced; ?></text></td>
           <td>Tsh.</td>
           ...
           <td style="text-align: right;">
            ...
            echo number_format(($amount * 100)/115,2); ?></b>
     ...
     <tfoot>
      ...
      <tr><td colspan="2"></td></tr>
      <tr><td>VAT[VAT RATE = 15%]</td><td>Tsh.</td><td style="text-align: right;"><b><?php 
        echo number_format(@(($amount * 100)/115)*0.15,2);?>
      </b></td></tr>
  ...
  <br>
 <table style="width: 100%;">
      <tr><td><b>ZRB Verification Code</b>&nbsp;&nbsp;<?php echo $signature->desc;?></td><td><img src="assets/images/<?php echo $qrcodename;?>" width="50" height="50"></td></tr>
  </table>
  <br>
  <table style="width: 100%;">
