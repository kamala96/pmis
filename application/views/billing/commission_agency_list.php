...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Commission Agency List</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Commission Agency List</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
        ...
        <div class="row m-b-10">
                <div class="col-12">
                   ...
                   <?php  if ($this->session->userdata('user_type') == 'ADMIN' || $this->session->userdata('user_type') == 'SUPER ADMIN') { ?>
                    <a href="<?php echo base_url() ?>Box_Application/Commission" class="btn btn-primary"><i class="fa fa-plus"></i> Add Commission</a>
                  <?php } ?>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Commission Agency List                       
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                    ...
                    <?php 
                            ...
                            <div class="table-responsive">
                             <table id="example4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Commission Names</th>
                                                <th>Commission Address</th>
                                                <th>Commission phone Number</th>
                                                <th>Commission Region</th>
                                                <!-- <th>Payment Bill</th>
                                                <th>Bill Amount</th> -->
                                                <th style="">Action</th>
                                            </tr>
                                 ...
                                 <?php foreach ($company as  $value) {?>
                                      ...
                                      <td style="">
                                        <?php echo number_format($value->paidamount); ?>
                                      </td> -->
                                      <td style="text-align: right;">
                                        <div class="input-group">
                                       
                                       <input type="hidden" name="" class="leaveId" value="<?php echo $value->com_id;?>">
                                       <a href="get_commission_bill_list?id=<?php echo $value->com_id;?>&& services=COMMISSION" class="btn btn-info btn-sm">Payment Status/Trend</a> |
                                       <a href="commission_issuedpayment_view?I=<?php echo base64_encode($value->com_id);?>" class="btn btn-info btn-sm myBtn">Issue Payment</a> 
                                        <?php  if ($this->session->userdata('user_type') == 'ADMIN' || $this->session->userdata('user_type') == 'SUPER ADMIN') { ?> | 
                                       <a href="<?php echo base_url('Box_Application/delete_commission_agent_info');?>?I=<?php echo base64_encode($value->com_id); ?>" onclick='return del();' title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i> Delete </a>
                                      <?php } ?>
                                        </div>
                                      </td>
                                    </tr>
...
$(document).ready(function(){
  $(".myBtn").click(function(){
    ...
    $.ajax({
     type: "POST",
     url: "<?php echo base_url();?>Box_Application/GenerateBill",
     data:'comm_id='+ text1,
