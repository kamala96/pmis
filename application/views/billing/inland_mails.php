								...
								<div class="tab-pane active" id="login_details">
									...
									<table class="" style="width: 35.5%;" cellspacing="4" cellpadding="5">
										<tr><td>
												...
												<select name="pay_type" class="form-control col-md-4 custom-select pay_type" id="pay_type">
									...
									<table style="width: 100%;" cellpadding="4" cellspacing="5">
										<tr>
											<td>
												...
												<select class="form-control custom-select col-md-4 category" name="category" id="category" onchange="getCategory();">
											...
											<td>
												...
												<div class="input-group">
													<select name="measure"  id="measure" class="input-group-prepend measure">
													<option>gms</option>
													<option>kg</option>
												</select>
												<input type="number" name="item_weght" class="form-control weight" id="weight" placeholder="" onkeyup="getPriceFrom()">

												</div>
											</div>
											<div id="divshow" style="display: none;">
												<div class="input-group">
													<select name="measure1"  id="measure1" class="form-control custom-select m1" onChange = "getAdvatising();">
											...
											<div id="divshow2" style="display: none;">
												<div class="input-group">
													<select name="measure2"  id="measure2" class="form-control custom-select m2" onChange = "getAerogrammes();">
														<option value="">--Select Category Weight--</option>
										...
										<tr>
											<td>
												...
												<button type="submit" class="btn btn-info" id="item_info">Next Step</button>
											</td>
