...
<div class="container-fluid">
    <div class="row m-b-10">
        <div class="col-12">
		  ...
		  <a href="#" class="btn btn-primary"><i class="fa fa-plus"></i> Ems Application</a>
    ...
    <div class="col-12">
        <div class="card card-outline-info">
           ...
           echo "Employee Name :";
            ...
            <form method="POST" action="send_to_back_office_supervisor">
...
<!-- <footer>
<tr>
    <td colspan="" style="text-align: right;"><label>Total::</label></td>
    <td colspan=""></td>
    <td colspan="">
     <?php

     echo number_format($total->paidamount,2);
     ?>
 </td>          
