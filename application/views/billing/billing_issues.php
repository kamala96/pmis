...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Posta Giro Billing Amount</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Posta Giro Billing Amount</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Posta Giro Billing Amount                       
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <button type="submit" class="btn btn-info btn-sm myBtn"><span class="glyphicon glyphicon-remove"></span>Issue Billing</button>
