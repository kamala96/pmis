        ...
        $basicinfo = $this->employee_model->GetBasic($id); 
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="btn-group btn-group-justified">
                          <a href="<?php ?>" class="despatch btn btn-info" style="padding-right: 10px;">Despatch Out International</a>
                         
                        </div> 
                        <hr/>
                      </div>
                      <div class="card-body">
                        <div class="table-responsive ems2" style="display: none;">

                          <form method="POST" action="close_bags">
                            <table id="example42" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                              <thead>
                                <tr>
                                  <th colspan="7"></th>
                                  <th>
                ...
                <footer>
                  ...
                  <tr>
                    ...
                    <td colspan="">
                      <select class="form-control" name="region" style="height: 40px;">
                ...
                <div class="table-responsive mails" style="display: none;">
                  MAILS
                </div>
                    ...
                    <tr>
                      <th style="">
                       ...
                       <div class="input-group">
                        ...
                        <input type="button" name="" class="btn btn-success" style="" id="BtnSubmit" value="Search Date">
                      </div>
                    </th>
                    <th>
                     <label>Monthly:</label>
                     <div class="input-group">
                      <input type="text" name="" class="form-control mydatetimepicker">
                      <input type="button" name="" class="btn btn-success" style="" id="BtnSerchDate" value="Search Month">
                    </div>
                  </th>
                </tr>
              </table>
          ...
          <div class="fromServer1" style="display: none;">
         ...
         <form method="POST" action="despatch_action">
          <table id="despatchIn" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                                            ...
                                            <tbody>
                                              <?php foreach ($despatchIn as $value) {?>
                                                ...
                                                //echo $value->despatch_status;
                                                  ...
                                                  <?php }elseif ($value->region_to == $regionfrom && $value->despatch_status == 'Sent') {?>
                                          ...
                                          <footer>
                                            <tr><td colspan="9"></td><td style="text-align: center;"><button type="submit" class="btn btn-info">Receive Bag</button></td></tr>
                                          </footer>
                                        </table>
                                      </form>
                                    </div>
