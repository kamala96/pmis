                                 ...
                                 <?php foreach ($billing as  $value) {?>
                                    ...
                                    $serial=$value->serial;
                                     $this->Box_Application_model->getBillPayment($AppID,$serial,$paidamount);
                                      ...
                                      <td><a href="<?php echo base_url()?>Box_Application/invoice_sheet_postaglobal?cn=<?php echo $value->billid;?>&&cun=<?php echo $value->invcust_id; ?>&&invoiced=<?php echo $value->invoice_details; ?>&&amount=<?php echo $value->paidamount; ?>&&invoiceno=<?php echo $value->invoice_id; ?>" class="btn btn-primary">Invoice Sheet</a></td>
                                    </tr>
                                 <?php } ?>
