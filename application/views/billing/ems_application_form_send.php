        ...
        <div class="row">
            <div class="col-12">
                ...
                <?php }?>
                            ...
                            <input type="number" name="weight" readonly class="form-control catweight" id="weight" onkeyup="getPriceFrom()" required="required">
                                ...
                                <!-- </div> -->
                                 ...
                                 <div class="row col-md-12">
                                    <div class="col-md-6">
                                    <span class ="price" id="price" style="font-weight: 60px;font-size: 18px;">
                                 ...
                                 <div class="col-md-12">
                                    <h1 class="snTag" id="snTag" style="display: none;">0</h1>
                                </div>
                                ...
                                <div id="savingBox" class="row"><!-- 
                                    ...
                                    <a href="<?php echo base_url() ?>/Bill_Customer/bill_customer_list?AskFor=EMS Postage"  class="btn btn-info btn-md" id="submitformBtn">Save Information</a>
                                ...
                                <br>
                                 ...
                                 <br>
                                  <div id="div6" style="display: block;"></div>
                            </div>
                        </div>
...
function getPriceFrom() {
 ...
 var weight = $('#weight').val().replace(/\s/g, '');
...
<script type="text/javascript">
    ...
    function Deletevalue(obj){
        ...
        $.ajax({
            type: "POST",
             url: '<?php echo base_url('Ems_Domestic/delete_ems_document_bulk_info')?>',
             data:'barcode='+barcode+'&transid='+transid+'&senderid='+senderid+'&serial='+serial,
             // dataType:'json',
             success: function(response) {
                $('#snTag').html(parseInt(snTag) - 1);
