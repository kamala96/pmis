    ...
    <div class="col-12">
        <div class="card card-outline-info">
            <div class="card-header">
                <h4 class="m-b-0 text-white"> <?php echo $this->session->userdata('heading'); ?> Transactions List  <span style="float: right;">
...
<?php }} else{ ?>
  <tr>
<td colspan='14' style='color:red;text-align:center;'>No Data Found</td></tr>";
...
<div class="modal fade" id="myModal12" role="dialog" style="padding-top: 100px;">
