...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Mails Billing List</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Mails Billing List</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Mails Billing List                       
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                            ...
                            <div class="table-responsive">
                             <table id="example4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                 ...
                                 <?php foreach ($billing as  $value) {?>
                                    ...
                                    $serial=$value->serial;
                                     $this->Box_Application_model->getBillPayment($AppID,$serial,$paidamount);
                                     
                                      if ($value->billid == '' && ($value->bill_status == 'PENDING' || $value->bill_status == 'SUCCESS') ) {
                                                     $serial=$value->serial;
                                                     $paidamount=$value->paidamount;
                                                     $region=$value->region;
                                                     ...
                                                     $trackno = 9007;
                                                     $this->Box_Application_model->getBillGepgBillId_international($serial, $paidamount,$region,$district,$mobile,$renter,$serviceId,$trackno);
                                      ...
                                      <td><a href="<?php echo base_url()?>Box_Application/mails_invoice_sheet_postaglobal?cn=<?php echo $value->billid;?>&&cun=<?php echo $value->invcust_id; ?>&&invoiced=<?php echo $value->invoice_details; ?>&&amount=<?php echo $value->paidamount; ?>&&invoiceno=<?php echo $value->invoice_id; ?>" class="btn btn-primary">Invoice Sheet</a></td>
                                    </tr>
                                 <?php } ?>
