        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <form action="ems_cargo_sender_info" method="POST" id="wixy">
                        <div class="card">
                           ...
                           <div class="card-body">
                            <div id="div1">
                                ...
                                <div class="col-md-12">
                                 ...
                                 <div class="col-md-3 nodest">
                                <label>Weight in kgs:</label>
                            <!-- <input type="text" name="weight" class="form-control catweight" id="weight" onkeyup="getPriceFrom()"> -->
                             <input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" name="weight" class="form-control weight catweight" id="weight" onkeyup="getPriceFrom()" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control custom-select address" id="addressselect" onchange="getAddress();" name="add_type_sender">
...
function getPriceFrom() {
 ...
 var weight = $('.catweight').val();
  ...
  if( weight >= 50){
    ...
    $('#weight_error').html('Weight Minimum Limit is 50');
  }
