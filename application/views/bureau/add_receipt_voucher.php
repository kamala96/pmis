...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
       <div class="row m-b-10">
            ...
            <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>Bureau/receipt_voucher/" class="text-white"><i class="" aria-hidden="true"></i> Receipt Voucher Transactions List </a></button>
...
<input type="hidden" name="status" value="receipt_voucher">
  ...
  <table class="table table-bordered">
    <thead>
       <tr>
           <th scope="col"> Going To [Dr] </th>
           <th scope="col"> Received From [Cr] </th>
