...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
       ...
       <h3 class="text-themecolor"><i class="fa fa-money" style="color:#1976d2"></i> Add Stock </h3>
        </div>
...
<form  method="post" action="<?php echo site_url('Bureau/save_stock');?>">
    ...
    <thead>
       ...
       <tbody>
           <tr class="main_row">
            ...
            <td><input type="number" name="balance[]" class="form-control" required></td>
