...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-wpforms" style="color:#1976d2"> </i> Books of Account  </h3>
		</div>
	...
	<div class="container-fluid">
		<div class="row m-b-10">
            ...
            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg">  <i class="fa fa-plus"></i> Add Books of Account </button>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i>   Books of Account List </h4>
                </div>
                ...
                <div class="card-body">
                        ...
                        <h5 class="modal-title mt-0" id="myLargeModalLabel"> Add Books of Account </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <div class="modal-body">
                                                                    
                        <form class="form-horizontal m-t-20" method="post" action="<?php echo site_url('Bureau/save_books_of_account');?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                <input class="form-control" type="text" required="" name="name[]" placeholder="Enter Books of Account">
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <button title="Edit" class="btn btn-info waves-effect waves-light" data-toggle="modal" type="button" data-target="#update_modal<?php echo $data->bureau_account_list_id; ?>">  <i class="fa fa-pencil-square-o"></i> Edit </button>
                                              ...
                                              <a href="<?php echo base_url('Bureau/delete_books_of_accounts');?>?I=<?php echo base64_encode($data->bureau_account_list_id); ?>" onclick='return del();' title="Delete" class="btn btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i> Delete </a>
                        ...
                        <div class="modal-header">
                        <h5 class="modal-title mt-0" id="myLargeModalLabel"> Edit Books of Account  </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>             
                        <div class="modal-body"> 

                        <form class="form-horizontal m-t-20" method="post" action="<?php echo site_url('Bureau/update_books_of_account');?>">
...
<script>
    ...
    $('.add_more_button').click(function(e){ //click event on add more fields button having class add_more_button
        ...
        if(x < max_fields_limit){ //check conditions
            x++; //counter increment
            $('.input_fields_container').append('<div> <div class="form-group row">  <div class="col-8"><input class="form-control" type="text" required="" name="name[]" placeholder="Enter Books of Account"></div>  <button href="#" class="remove_field btn btn-primary" style="margin-left:10px;">  X  </button>   </div> </div>'); //add input field
        }
    });  
