...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-wpforms" style="color:#1976d2"> </i> Bureau De Change | Send Request </h3>
		</div>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                        ...
                        <form class="form-horizontal m-t-20" method="post" action="<?php echo site_url('Bureau/save_stock_request');?>">
                                     ...
                                     ?>
                                        <tr>
                                            ...
                                            <td> <?php echo $data->bclno; ?> </td>
                                             ...
                                             <td> <button title="Approve" class="btn btn-info waves-effect waves-light" data-toggle="modal" type="button" data-target="#pmu_update_modal<?php echo $data->request_code; ?>">  View Requested Currency   </button>
                                             </td>
