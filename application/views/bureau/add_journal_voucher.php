...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
       ...
       <h3 class="text-themecolor"><i class="fa fa-money" style="color:#1976d2"></i>  Journal Voucher </h3>
        </div>
    ...
    <div class="container-fluid">
       <div class="row m-b-10">
            ...
            <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>Bureau/journal_voucher/" class="text-white"><i class="" aria-hidden="true"></i>  Journal Voucher Transactions List </a></button>
...
<input type="hidden" name="status" value="journal_voucher">

  <table class="table table-bordered">
    <thead>
       <tr>
           <th scope="col"> Debit To [Dr] </th>
           <th scope="col"> Credit To [Cr] </th>
           ...
           <tr class="main_row">
            ...
            <select name="payingfrom[]" class="form-control custom-select payingfrom" required="">
              ...
              <?php foreach ($creditlist as $value){ ?>
                   <option value="<?php echo $value->account_name.'-'.$value->account_no; ?>"> <?php echo $value->account_name.'-'.$value->account_no; ?></option>
              <?php } ?>
            </select>
            </td>
            <td> 
...
'         <option value="<?php echo $data->account_name.'-'.$data->account_no; ?>"><?php echo $data->account_name.'-'.$data->account_no; ?></option>\n' +
'                                        <?php } ?>\n' +
                '               </select></td>\n' +
