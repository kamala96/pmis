...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
       ...
       <h3 class="text-themecolor"><i class="fa fa-money" style="color:#1976d2"></i> Bureau De Change | Buying </h3>
        </div>
    ...
    <div class="container-fluid">
       <div class="row m-b-10">
                <div class="col-12">
                    ...
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo site_url('Bureau/buying');?>" class="text-white"><i class="" aria-hidden="true"></i> Buying  </a></button>
                    
                     <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>Bureau/buying_transaction" class="text-white"><i class="" aria-hidden="true"></i> Buying Transaction </a></button>
...
<form  method="post" action="<?php echo site_url('Bureau/save_buy_transaction');?>">
  ...
  <table class="table table-bordered">
    ...
    <div >
       <button class="btn btn-primary submitbutton" type="submit" id="submitbutton">Submit</button>
    </div>
</form>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('tbody').delegate('.productname', 'change', function () {
            ...
            //var rate = tr.find('.qty').val();
            var dataId = {'id':id};

            $.ajax({
            type : "post",
            url  : "<?php echo site_url('Bureau/get_counter_buying_product_information');?>",
             data : {id:id},
            dataType:'json',
            success: function(data){
                ...
                tr.find('.qty').attr('max',data['maxprice']);
                tr.find('.qty').attr('min',data['minprice']);
                //tr.find('#submitbutton').removeAttr('disabled','disabled');
                ...
                $('#notifyMessageTwo').html(data['message']);
                    ...
                    $('.submitbutton').attr('disabled','disabled');
                     //tr.find('#submitbutton').attr('disabled','disabled');
                    $('#notifyMessageTwo').html(data['message']);
                }
