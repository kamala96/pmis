...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i>  Bureau De Change | Buying Transaction</h3>
        </div>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Buying Transaction List
                        </h4>
                    </div>
                    <div class="card-body" >
                      <div class="col-md-12">
                      ...
                      <form class="row" method="get" action="<?php echo site_url('Bureau/list_transaction_results'); ?>">

                                    <input type="hidden" name="status" class="form-control"  value="02">
                                    ...
                                    ?>
                                       <tr>
                                           ...
                                           <td>
                                             ...
                                             <?php if($value->bot_status!="POSTED"){ ?>
