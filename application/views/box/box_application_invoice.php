        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                  ...
                  <div class="col-md-12">
                        <form action="Box_Application_Invoice" method="POST">
                                           ...
                                           <?php foreach($box_renters as $value): ?>
                                            <tr>
                                             ...
                                             <?php if (!is_null($box_status) ){?>
                                                ...
                                                <?php } ?> 
                                                <?php if ($value->maxyear < date('Y')) {?>

                                                    <a href="<?php echo base_url('Box_Application/invoice_box')?>?I=<?php echo base64_encode($value->details_cust_id) ?>" class="btn btn-info btn-sm">
                                                                Print Invoice
                                                            </a>
