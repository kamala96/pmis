            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Virtue Box Application List                       
                        </h4>
                    </div>
                    <div class="card-body">

                  <div class="col-md-12">
                        <form action="Virtual_Box_Application_Search" method="POST">
                            ...
                            <table id="example41" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Payment Date</th>
                                                 ...
                                                 <th>Expire Date</th>
                                                <th style="text-align: right;">Box Status</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody class="results">
                                           <?php foreach($box_renters as $value): ?>
                                            <tr>
                                                <td><a href="Virtual_Box_Information?I=<?php echo base64_encode($value->virtuebox_id)?>"><?php echo $value->fname.' '.$value->mname.' '.$value->lname; ?></a></td>
                                                ...
                                                <td><?php 
                                                   ...
                                                   ?></td>
                                                    <?php //$box_status = null; ?>
                                                   <?php $box_status =$value->virtuebox_status;
                                                 ...
                                                 <?php   }?>
                                                   ...
                                                   <td><?php echo $value->virtueboxtype; ?></td>
                                             ...
                                             <?php if (!is_null($box_status) ){?>
                                                <?php if ($box_status == 'ACTIVE' ) {?>
                                                 
                                                         <button class="btn btn-success btn-sm" >
                                                            ACTIVE 
                                                        </button> | 
                                                        <a href="#"></a>
                                                      <?php }else{ echo $box_status;} ?>
                                                <?php }?>
