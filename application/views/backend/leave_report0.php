                              ...
                              <th style="">
                                 ...
                                 <div class="input-group">
                                    ...
                                    <input type="text" name="todate" placeholder="To date" class="form-control  mydatetimepickerFull col-md-4" id="todate">
                                     ...
                                     <select class="select2 form-control custom-select col-md-4" data-placeholder="Choose a Category" tabindex="1" id="emid" name="emid" required style="height: 45px;">
                                    ...
                                    <input type="button" name="" class="btn btn-success BtnSubmit" style="" id="BtnSubmit" value="Submit" required="required">
                                    <input type="submit" name="" class="btn btn-success " style="" id="" value="Print" required="required">
                                 </div>
                              </th>
                           </tr>
                        </table>
