                    ...
                    <form method="post" action="Add_Applications" id="leaveapply" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <label class="control-label" id="hourlyFix">To (Select Region)</label>
                                        ...
                                        <select name="to" value="" class="form-control custom-select" required id="region" onChange="getDistrict();" required  readonly>
                                             <option value="<?php echo $application->region_to ?>"><?php echo $application->region_to ?></option>
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <input type="text" name="district" class="form-control" value="<?php echo $application->district_to;?>" readonly>
                                </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                <label class="control-label" id="hourlyFix">Village To</label>
                                <input type="text" name="village" class="form-control" value="<?php echo $application->village_to;?>"  readonly>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" name="fare_amount" value="<?php echo $application->fare_amount;?>" class="form-control" id="fare_amount">
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                                           ...
                                           <?php if($application->leave_status =='Approve'){ ?>
                                             ...
                                             <?php } elseif($application->leave_status =='Not Approve'){ ?>
                                            <a href="" title="Edit" class="btn btn-sm btn-info waves-effect waves-light Status" data-employeeId=<?php echo $application->em_id; ?>  data-id="<?php echo $application->id; ?>" data-value="Approve" data-duration="<?php echo $application->leave_duration; ?>" data-type="<?php echo $application->typeid; ?>">Approve</a>       
                                            <a href="" title="Edit" class="btn btn-sm btn-info waves-effect waves-light  Status" data-id = "<?php echo $application->id; ?>" data-value="Rejected" >Reject</a>
                                            <br> 

                                            <?php } elseif($application->leave_status =='Rejected'){ ?>

                                            <?php } ?>
               <!--  <a href="" title="Edit" class="btn btn-sm btn-info waves-effect waves-light leaveapp" data-id="<?php echo $application->id; ?>" ><i class="fa fa-pencil-square-o"></i>Edit</a> -->
                        </div>
                    </form>
                                </div>
                            </div>
