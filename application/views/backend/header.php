...
<head>
    ...
    <link rel="icon" type="image/ico" sizes="16x16" href="<?php echo base_url(); ?>assets/images/TCP.png">
    <title> PMIS | Posta Management Information System </title>
    <!-- Bootstrap Core CSS -->
        ...
        <div id="main-wrapper">
            ...
            <div class="navbar-collapse">
                <ul class="navbar-nav mr-auto mt-md-0">
                    ...
                    <!-- <button class="btn btn-info btn-md" name="shiftend" value="shiftend" style="background-color:blue ;"> End Shift </button> -->

                    <!-- <a href="<?php echo base_url(); ?>Employee/EndShift" class="btn btn-info" style="background-color:blue ;">End Shift</a -->
