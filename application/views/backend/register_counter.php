...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Register Counter </h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Register Counter</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                    <a href="<?php echo base_url() ?>Organization/add_counters" class="btn btn-primary"><i class="fa fa-plus"></i> Create Counter</a>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Counter Form                       
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                           <div class="card-body">
                            <?php if (!empty($serviceById->counter_id)) {?>
                                 <form action="<?php echo base_url('Organization/add_counters_action')?>" method="POST">
                                <div class="row">
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label>Counter Name</label>
                                <input type="text" name="cname" class="form-control" required="required" value="<?php echo $serviceById->counter_name ?>">
                                </div>
                               </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                <div class="form-group">
                                    <input type="hidden" name="cid" value="<?php echo $serviceById->counter_id ?>">
                                   <button class="btn btn-info btn-sm" type="submit">Save counter</button>
                                </div>
                                </div>
                                </div>
                        </form>
                                           ...
                                           <?php foreach($service as $value): ?>
                                            <tr>
                                                ...
                                                <td style="">
                                                    ...
                                                    <a href="add_counters?I=<?php echo base64_encode($value->counter_id)?>" class="btn btn-warning btn-sm">Edit</a> 
                                                <form action="delete" method="post">
                                                    <input type="hidden" class="btn btn-danger" name="cid" value="<?php echo $value->counter_id;?>">
