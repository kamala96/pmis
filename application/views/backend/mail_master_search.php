 ...
 <div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-university" aria-hidden="true"></i> Mail Transaction search</h3>
        </div>
...
<script type="text/javascript">
    function searchTransaction(barcode,cnumber,mobile){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>Services/mail_search_transaction",
            data:{barcode:barcode,mobile:mobile},
            dataType:'json',
    ...
    function editingProcess(obj){
        ...
        if (barcode.length != 13) {
            ...
            if (reasonText == '') {
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo base_url();?>unregistered/editBarcodeprocess",
