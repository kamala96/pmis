                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-hourglass-start" aria-hidden="true"></i> Imprest Susistence Request Form Form
                                </h4>
                            </div>
                    <div class="card-body">
							<div class="tab-pane" id="ims" role="tabpanel" enctype='multipart/form-data'>
									<div class="card">
										<div class="card-body">
			<form class="" action="<?php echo base_url()?>Employee/Imprest" method="post" enctype="multipart/form-data">
												<div class="row">
													<div class="form-group col-md-4 m-t-5">
														<label>Subsistence Allowance Rate per day</label>
														<input type="hidden" name="imp_id" value="<?php echo $imp_id;?>" class="form-control form-control-line" placeholder="Rate Per Day" minlength="">

														<input type="text" name="subsistence_allowance" value="" class="form-control form-control-line" placeholder="Rate Per Day" minlength="">
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-md-4 m-t-5">
														...
														<input type="date" name="leaving_date" value="" class="form-control form-control-line" placeholder="Date Of Leaving" minlength="">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>Date Of Returning</label>
														<input type="date" name="date_returning" value="" class="form-control form-control-line" placeholder="Date Of Returning">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>Visited Place</label>
														<input type="text" name="place_visited" value="" class="form-control form-control-line" minlength="" placeholder="Place Visited">
													</div>
												</div>
												<div class="row">
													<div class="form-group col-md-12 m-t-5">
														<label>Reason</label>
														<textarea class="form-control" placeholder="Purpose of safari" name="safari_purpose"></textarea>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-md-4 m-t-5">
														...
														<input type="number" name="number0" class="form-control" style="" placeholder="Number of days">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>Subsistence Allowance Amount in Tsh.</label>
														<input type="number" name="number1" class="form-control" style="" placeholder="Amount Tshs.">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>Incidental Expenses Foreign 20%.</label>
														<input type="number" name="number2" class="form-control" style="" placeholder="Amount Tshs.">
													</div>
												</div>
												<div class="row">
													<div class="form-group col-md-4 m-t-5">
														<label>Bus/Train Fare.</label>
														<input type="number" name="number3" class="form-control" style="" placeholder="Amount in Tsh.">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>Air Ticket.</label>
														<input type="number" name="number4" class="form-control" style="" placeholder="Amount Tshs.">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>AC/Code/Vote to be charged</label>
														<input type="number" name="number5" class="form-control" style="" placeholder="ACC/Code/Vote.">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>AC/Code/Vote to be charged Amount</label>
														<input type="number" name="number6" class="form-control" style="" placeholder="Amount in Tsh.">
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-md-4 m-t-5">
														...
														<input type="number" name="number7" class="form-control" style="height: 45px;">
													</div>
													<div class="form-group col-md-4 m-t-5">
													...
													<div class="form-group col-md-4 m-t-5">
														...
														<br>
														<label id="ndio">&nbsp;&nbsp;<input type="checkbox" name="status" style="transform: scale(2);padding-top: 10px;" id="yes" value="Yes" />&nbsp;&nbsp; If Yes</label>&nbsp;&nbsp;
														<label id="sio"><input type="checkbox" name="status" style="transform: scale(2);padding-top: 10px;"  id="no" value="No" />&nbsp;&nbsp; If No</label>
													</div>
												</div>
