        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
					...
					<form method = "POST" action="Assign_Service_Action">
                        <div class="col-md-12">
                    ...
                    <div class="form-group col-md-12 m-t-30">
                        <label>Assign Sorting Zone</label>
                        <br>

                        <?php  $zones=$this->Box_Application_model->get_zone();
                              $id = $this->session->userdata('user_login_id');
                              $Assignedzones=$this->Box_Application_model->check_zone_employlist($emid);
                        foreach ($zones as $value3) {?>

                            <?php echo $value3->zone_name?> :
                            <input type="checkbox" name="zone_id[]" value="<?php echo $value3->zone_id?>" class="" style="padding-bottom: 50px;" 
                            <?php 
                            foreach ($Assignedzones as $vall){
                                if ($value3->zone_id == $vall->zone_id) {
                                    echo "checked";
                                    break;
                                }
                            }
