...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Sub Services </h3>
        </div>
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                    <a href="<?php echo base_url() ?>Organization/Services" class="btn btn-primary"><i class="fa fa-plus"></i> Create Sub Services</a>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Sub Services Form                       
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                           <div class="card-body">
                         <form action="add_subservices?I=<?php echo base64_encode($sid) ?>" method="POST">
                                <div class="row">
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label>Service Name</label>
                                <input type="text" name="sub_service" class="form-control" required="required">
                                <input type="hidden" name="sid" value="<?php echo $sid; ?>" class="form-control" required="required">
                                </div>
                               </div>
                                </div>
                                <div class="row">
                        ...
                        <table id="example4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody class="results">
                                           <?php foreach($service as $value): ?>
                                            <tr>
                                                <td><?php echo $value->sub_service_name;?></td>
                                                <td style="text-align: right;"><a href="Services?I=<?php echo base64_encode($value->sub_service_id)?>" class="btn btn-warning btn-sm">Edit</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
