...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i>Rejection</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Leave Rejection</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
                        ...
                        <form method="post" action="<?php echo base_url() ?>Leave/Leave_Application">
							...
							<div class="row m-t-20">
								...
								<div class="col-md-6">
									...
									<input type="number" name="enddate" class="form-control" id="" value="<?php echo $employee->leave_duration;?>" required="required">
								</div>
							</div>
							<div class="row m-t-20">
								<div class="col-md-6">
                            ...
                            <div class="row m-t-20">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="rejected_reason" id="message-text1" readonly="readonly"><?php echo $employee->rejected_reason?></textarea>
                                </div>
                            </div>
                            <?php if ($employee->name == 'Annual Leave') {?>
                                <div class="row m-t-20" style="" id="leaveFare">
                                <div class="col-md-6">
