      ...
      <div class="page-wrapper">
         ...
         <div class="container-fluid">
            <div class="row m-b-10"> 
                <div class="col-12">
                    <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#loanmodel" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Apply Loan </a></button>
        ...
        <div class="modal fade" id="loanmodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content ">
                    ...
                    <form role="form" method="post" action="Apply_For_Loan" id="btnSubmit" enctype="multipart/form-data">
...
<!--                            <div class="form-group row">
                    ...
                    <div class="modal-footer">
                       <input type="hidden" name="id" value="">
                        ...
                        <button type="submit" name="ApplyLoan" class="btn btn-primary">Approve Loan</button>
                        <?php }?>
                        <?php if ($this->session->userdata('user_type')=='EMPLOYEE' ){ ?>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="submit" name="ApproveLoan" class="btn btn-primary">Approve Loan</button>
                        <?php }?>
