...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Report List <?php echo @$Status;?></h4>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <!-- <form method="post" action="" id="salaryform" class="form-material row"> -->
                                         ...
                                         <div class="col-md-12">
                                             <!-- <form class="row" method="post" action="<?php echo site_url('leave/print_leave_report');?>"> -->
                                                 <form class="row" method="post" action="<?php echo site_url('leave/Get_LeaveDetailss');?>">
                        <table class="table table-bordered" style="width: 100%;">
                           <tr>
                              <th style="">
                                 <label>Select Date:</label>
                                 <div class="input-group">
                                    <input type="text" placeholder="From date" name="fromdate" class="form-control  mydatetimepickerFull col-md-3" id="fromdate">

                                    <input type="text" name="todate" placeholder="To date" class="form-control  mydatetimepickerFull col-md-3" id="todate">

                                   

                                     <select class="select2 form-control custom-select col-md-2" data-placeholder="Choose Status" tabindex="1" id="emid" name="emid" required style="height: 45px;">
                                   ...
                                   <!--  <input type="button" name="" class="btn btn-success BtnSubmit col-md-2" style="" id="BtnSubmit" value="Submit" required="required"> -->
                                     <input type="submit" name="check" class="btn btn-success BtnSubmit col-md-2" style="" id="BtnSubmit" value="Submit" required="required">
                                    <input type="submit" name="check" class="btn btn-success BtnSubmit012 col-md-2" style="" id="BtnSubmit012" value="Print" required="required">
                                 </div>
                              </th>
                           </tr>
                        </table>
                                       ...
                                       <!--  <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            <select class="select2 form-control custom-select col-md-8" data-placeholder="Choose a Category" tabindex="1" id="emid" name="emid" required style="height: 45px;">
                    ...
                    <div class="card-body">
                        <div class="table-responsive ">
                            <table id="example2345" class="table table-bordered International text-nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
      ...
      <!--   <script>
          ...
          <script>
            $(document).ready(function() {
                      $(".BtnSubmit01").on("click", function(event) {
                        //event.preventDefault();
                   ...
                   // console.log(todate)
                           ...
                           $.ajax({
                                  type: "POST",
                                  url: "<?php echo base_url();?>Leave/print_leave_report",
                                  data:{fromdate:fromdate,todate:todate,emid:emid},
                                  success: function(response) {
                                   //$('.leave').html(response);
                                            }
                                        });
    ...
    // });
          ...
          <script>
            $(document).ready(function() {
                      $(".BtnSubmits").on("click", function(event) {
                        //event.preventDefault();
                   ...
                   // console.log(todate)
                           ...
                           $.ajax({
                                  type: "POST",
                                  url: "<?php echo base_url();?>Leave/Get_LeaveDetails",
                                  data:{fromdate:fromdate,todate:todate,emp_id:emid},
                                  success: function(response) {
                                   $('.leave').html(response);
                                            }
                                        });
...
var table = $('.International').DataTable( {
    ...
    'copy', 'csv', 'excel'
        ...
        <script type="text/javascript">
            ...
            $(document).ready( function () {
  var table = $('#example234').DataTable({
        dom: 'Bfrtip',
        buttons: [
                 'copy', 'csv', 'excel',
