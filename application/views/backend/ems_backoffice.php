                                          ...
                                          <?php foreach ($despatch as $value) {?>
                                            ...
                                            <!--    <td><?php echo $value->region_to; ?></td> -->
                                              ...
                                              <?php 
                                                ...
                                                }elseif ($value->bag_region == $regionfrom && $value->despatch_status == 'Sent') {
                                                  
                                                  echo "<button class='btn btn-warning' type='button' disable>Pending Bag</button>";

                                                }elseif ($value->bag_region == $regionfrom && $value->despatch_status == 'Received') {
                                        ...
                                        <thead>
                                            <!-- <tr>
                                               ...
                                               <th style="padding-left: 60px;">
                                                    <div class="form-check" style="" id="showCheck">
                                             ...
                                             <td>
                                               ...
                                               <?php }elseif ($value->bag_region == $regionfrom && $value->despatch_status == 'Sent') {?>
                                                  ...
                                                  <div class='form-check' style="padding-left: 53px;">
                                                        ...
                                                        <input type='checkbox' name='I[]' class='form-check-input checkSingle4 checkd' id='remember-me' value='<?php echo $value->desp_id ?>'>
                                                 <label class='form-check-label' for='remember-me'></label>
                                                      
                                                 </div>

                                               <?php }elseif ($value->bag_region == $regionfrom && $value->despatch_status == 'Received') { ?>
