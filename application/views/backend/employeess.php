                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            ...
                            <form action="" method="post">
                                    <tr><td><input type="text" name="em_id" id="em_id" placeholder="PF Number" class="form-control"></td><td><select name="em_gender" class="form-control" id="em_gender">
                                        ...
                                        </select></td><td><button type="submit" class="btn btn-info" id="BtnSubmit">Search Here</button></td></tr>
                                    </form>
                                    </table>
