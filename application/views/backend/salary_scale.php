                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                               ...
                               <table id="employees123" class="display  table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($scalevalue as $value) { ?>
                                            <tr>
                                                <td><?php echo $value->scale_name;?></td>
                                                <td><?php echo $value->amount;?></td>
                                                <td><?php echo $value->increment;?></td>
                                                <td class="jsgrid-align-center ">
                                                    <a href="<?php echo base_url();?>payroll/Salary_Scale_Edit/<?php echo $value->scaleId;?>" title="Edit" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>
                                                    <a onclick="return confirm('Are you sure to delete this data?')" href="<?php echo base_url();?>payroll/Salary_Scale_Delete/<?php echo $value->scaleId;?>" title="Delete" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php }?>
                                        </tbody>
