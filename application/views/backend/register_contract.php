...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Register Contract</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Register Contract</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                    <a href="<?php echo base_url() ?>Organization/Contract" class="btn btn-primary"><i class="fa fa-plus"></i> Add Contract</a>
                    <!-- <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>Box_Application/Box_Application_List" class="text-white"><i class="" aria-hidden="true"></i> Services List</a></button> -->
                </div>    
        </div> 
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Contract Form                       
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                           <div class="card-body">
                            <?php if (!empty($serviceById->cont_id)) {?>
                            <form action="<?php echo base_url('Organization/Register_Contract_Action')?>" method="POST">
                                <div class="row">
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label>Contract Name</label>
                                <input type="text" name="service_name" class="form-control" required="required" value="<?php echo $serviceById->cont_name ?>">
                                </div>
                               </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                <div class="form-group">
                                    <input type="hidden" name="service_id" value="<?php echo $serviceById->cont_id ?>">
                                   <button class="btn btn-info btn-sm" type="submit">Save Contract</button>
                                </div>
                                </div>
                                </div>
                        </form>
                                        ...
                                        <tbody class="results">
                                           <?php foreach($service as $value): ?>
                                            <tr>
                                                ...
                                                <td style="text-align: right;"><a href="Contract?I=<?php echo base64_encode($value->cont_id)?>" class="btn btn-warning btn-sm">Edit</a></td>
                                            </tr>
                                            <?php endforeach; ?>
