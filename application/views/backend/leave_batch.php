            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white">Batch Application List
                        </h4>
                    </div>
                    <div class="card-body">
						<?php if ($this->session->userdata('user_type')== 'ACCOUNTANT') {?>
							...
							<?php
						}elseif ($this->session->userdata('user_type')== 'HR' || $this->session->userdata('user_type')== 'ADMIN') {?>
                            <form method="post" action="" id="salaryform" class="form-material row">
                                        <div class="form-group col-md-4">
                                         <input type="text" name="datetime" id="date_from" class="form-control mydatetimepicker" placeholder="Leave Date" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <select class="form-control custom-select col-md-8" data-placeholder="Choose a Category" tabindex="1" id="emid" name="emid" required style="">
                                                <option value="0">--Select Leave Type--</option>
                                                <?php foreach ($leavetypes as $value) {?>
                                                   <option value="<?php echo $value->type_id; ?>"><?php echo $value->name; ?>
                                                </option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <input type="submit" class="btn btn-info" value="Search List" name="submit" id="BtnSubmit">
                                        </div>
                                    </form>
                        <?php } ?>
                        <br>
                        <div class="form-check" style="padding-right: 75px;  text-align: right;display: none;" id="showCheck">
                        ...
                        <div class="table-responsive ">
                            <form method="POST" action="<?php echo base_url()?>Leave/Save_Batch">
                            <table class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%" style="">
                                <thead>
                                    <tr>
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="9"></th>
                                         ...
                                         <th >
                                            <div class="form-check" style="text-align: left;display: none;" id="showCheck2">
                                             <button   class="btn btn-info btn-sm">Send To GMCRM</button>
                                             </div>
                                         </th>
