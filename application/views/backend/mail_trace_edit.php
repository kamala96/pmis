 ...
 <div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-university" aria-hidden="true"></i> Mail Transaction Tracing</h3>
        </div>
        ...
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <div style="display: none;background-color: #d22c19;color: white;" id="forMessage" class="alert alert-danger alert-dismissible">
                            ...
                            <strong id="notifyMessage">sdfsd</strong>
                </div>
                    <div class="row">
                      <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function searchTransaction(obj){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>Services/mail_tracing_master",
