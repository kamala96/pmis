...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Payroll/Loan_Deduction" class="text-white"><i class="" aria-hidden="true"></i> Loan Deduction</a></button>
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Payroll/Percent_Deduction" class="text-white"><i class="" aria-hidden="true"></i> Percentange Deduction</a></button>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Percentage Deduction List  </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format($value->ded_amount,2); ?></td>
