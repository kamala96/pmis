...
<?php $this->load->view('backend/sidebar');
 ?>
      ...
      <div class="page-wrapper">
            ...
            <h3 class="text-themecolor"><i class="fa fa-braille" style="color:#1976d2"></i> Bill Summary Sheet   </h3>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-plus" aria-hidden="true"></i>  Bill Summary Sheet <span class="pull-right " ></span></h4>
                            </div>
    ...
    <!-- <img src="assets/images/tcp.png" width="130" height="80"> -->
      ...
      <b style="font-size: 20px;">BILL SUMMARY SHEET </b> <br>
       <hr>
