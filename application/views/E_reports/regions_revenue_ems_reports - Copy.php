         ...
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"> Search EMS Revenue Collection Report  </h3>
                </div>
            ...
            <div class="container-fluid">         
                <div class="row">
                   ...
                   <div class="card-header">
                      ...
                      <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>E_reports/regions_revenue_ems_reports" class="text-white"><i class="" aria-hidden="true"></i>  Search Reports </a></button>

                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>E_reports/list_revenue_reports" class="text-white"><i class="" aria-hidden="true"></i>  Download Reports </a></button>
                            ...
                            <form class="row" method="post" action="<?php echo site_url('E_reports/retrieve_region_ems_report');?>">
