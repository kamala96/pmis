    ...
    <?php $regvalue1 = $this->employee_model->branchselect(); ?>
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Stock/StampBureau" class="text-white"><i class="" aria-hidden="true"></i>  Back Philatelic Stamp List</a></button>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-plus" aria-hidden="true"></i>  Add New Philatelic Stamp<span class="pull-right " ></span></h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="row" method="post" action="Savephilatel" enctype="multipart/form-data">
