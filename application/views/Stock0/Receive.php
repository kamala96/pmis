...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Unreceived</h3>
		</div>
		<div class="col-md-7 align-self-center">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a  href="<?php echo base_url(); ?>Stock/Requisition_Form">Home</a></li>
	...
	<div class="container-fluid">
      ...
      <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>Stock/ReceivedList" class="text-white"><i class="" aria-hidden="true"></i>Received List </a></button> 
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i> Receive List</h4>
                </div>
                ...
                ?>      
                                        ...
                                        <tr style="text-align: center;">
                                          ...
                                          <a href="<?php echo base_url();?>Stock/acceptReceived/<?php echo $value->serialno;?>" title="View Item" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-eye"></i></a>  
