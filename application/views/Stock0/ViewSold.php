...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
            <div class="row m-b-10"> 
                <div class="col-12">
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Stock/Selling" class="text-white"><i class="" aria-hidden="true"></i>  Back To Sell Items</a>
                    </button>
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-header">
                            <h4 class="m-b-0 text-white"><i class="" aria-hidden="true"></i>Selling Item<span class="pull-right " ></span></h4>
                        </div>
   ...
   <!-- note -->
        ...
        <div class="">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php foreach($controlNo as $value):
                         //$numb = count($request2);
                ...
                ?>      
                                            ...
                                            <input type="text" class="input-label form-control"   name="StockId[<?php echo $stockname;?>]" hidden value="<?php echo $value->StockId ?> " /> 
                                        </td>
                                            <td style="text-align:center;"><?php echo $value->QuantitySupp; ?></td>
                                            <td style="text-align:center;"><?php echo $value->SellingPerValue ; ?></td>
...
<br/>
                       ...
                       <div class="col-md-8">
                                    <text>Sold by &nbsp;
                                        <input type="text" name="exp_sum" class="col-md-4" value="<?php echo $basicinfo->first_name.' '.$basicinfo->last_name; ?>"style="border-top: 0px;border-left: 0px;border-right: 0px;" required>
                                        </text>
                                        </div> 
                            <div class="col-md-4" style="float: right;">
                                    <text>
                                         <!-- Checked by &nbsp;<input type="text" class="" name="for" style="border-top: 0px;border-left: 0px;border-right: 0px; " required> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                                        Date &nbsp;<input type="text" class="" name="for" value ="<?php echo @$value->CreatedDate?>" style="border-top: 0px;border-left: 0px;border-right: 0px; " required><br><br>
                                        </text>
                                    </div>   
...
<form class="" method="post" action="<?php echo base_url();?>Stock/GenerateControlNo" enctype="multipart/form-data">
        ...
        <div class="col-md-2" style="float:right;">
                  ...
                  <button  class="btn btn-info " type="submit" ><i class="fa fa-check"></i>  GENERATE CONTROL NO:
