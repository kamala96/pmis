...
$(document).ready(function(){
    ...
    $(".add-new").click(function(){
       ...
       var name ="";
        ...
        var row = '<tr style="align:center; ">>' +
        
            '<td>'+
         
                                            '<select class="form-control custom-select" name="StockId['+ index + ']" onChange="getstock('+ index + ');" id="stocks'+ index +'"  required="required">'+
                                                 '<option value="">-- Select Stock--</option>'+
                                                <?php foreach ($stock as $value) {?>
                                                    '<option  value="<?php echo $value->StockId?>"><?php echo $value->stampname;?></option>'+
                                                    <?php  } ?>
      '</select> '+
      
      
      '</td>' +
            //'<td style="text-align:center;"><text class="form-control">5</text></td>' +
            '<td><input type="number" class="form-control" name="QuantitySupp['+ index + ']" >'+
            //'<input type="number" class="form-control" name="" id="numb" hidden value="'+ index + '">'+
            '</td>' +
            
            '<td id="price'+ index +'" style="text-align:center; "><text >0</text></td>' +
...
function getstock(index) {
 var index = index;
    var val = $('#stocks'+ index ).val();
     $.ajax({
     type: "POST",
     url: "<?php echo base_url();?>stock/stocklistid",
     data:'stock='+ val,
     success: function(data){
         $("#price"+ index ).html(data);
     }
 });
};
 ...
 var index = 0;
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor"><i class="fa fa-university" aria-hidden="true"></i> Selling</h3>
            </div>
        ...
        <div class="container-fluid">
            <div class="row m-b-10"> 
                <div class="col-12">
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Stock/UnpaidControlNo" class="text-white"><i class="" aria-hidden="true"></i>  Back Unpaid ControlNo </a></button>
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Stock/PaidControlNo" class="text-white"><i class="" aria-hidden="true"></i>  Back Paid ControlNo </a></button>
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Stock/ViewSold" class="text-white"><i class="" aria-hidden="true"></i>  Generate ControlNo</a></button>
                ...
                <div class="col-12">
                    <div class="card card-outline-info">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white"><i class="fa fa-plus" aria-hidden="true"></i>  Selling Form<span class="pull-right " ></span></h4>
                        </div>
  ...
  <div class="card-body">
    ...
    <div id="app" class="container invoice">
        <div class="row">
        <form class="row" method="post" action="SaveSelling" enctype="multipart/form-data">
            ...
            <div class="col-12 content py-4">
               ...
               <!--  <div align="left" style="font-size:0px;word-break:break-word;float:left;">
                                            ...
                                            <div align="center" style="font-size:0px;word-break:break-word;">
                                               ...
                                               <!--  <div align="right" style="font-size:0px;word-break:break-word;float:right;">
                                                       <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:24px;font-weight:;line-height:22px;text-align:left;color:#525252; "> P86 </div>
                                                        <input type="text" class="input-label form-control" hidden name="formno" value="P86" />
                                                   </div> -->
                    ...
                    <div class="col-md-3" style="float:left;">
                                <div class="field">
                                    <input type="text" class="input-label form-control" placeholder="Buyer's Name"  name="BuyerName" value="" />
                                    <input type="text" class="input-label form-control" placeholder="Buyer's Phone" name="BuyerPhone" value="" />
                             
                                </div>
                                <div class="value">
                                    <textarea class="form-control" name="Description" placeholder="Descriptions"  >
                                    </textarea>
                                </div>
                     </div>
                   ...
                   <div class="col-md-3" style="float:right;">
                                <div class="field">
                                <input type="text" class="input-label form-control"placeholder="From" readonly name="SoldBy" hidden value="<?php echo $basicinfo->em_id; ?>" />
                                    <input type="text" class="input-label form-control"placeholder="Officer" readonly name=""  value="" />
                                </div>
                                <div class="value">
...
<!-- 
                ...
                <div class="col-sm-10"></div>
                    <div class="col-md-2" style="float:right;">
                        <button type="submit" class="btn btn-info "><i class="fa fa-menu"></i> Save  </button>
                    </div>
                </div>
            </div>
