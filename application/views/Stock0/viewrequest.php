...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
            <div class="row m-b-10"> 
                <div class="col-12">
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Stock/StockRequest" class="text-white"><i class="" aria-hidden="true"></i>  Back to List</a>
                    </button>
            ...
            <div class="col-12 content py-4">
                ...
                <div align="left" style="font-size:0px;word-break:break-word;float:left;">
                    ...
                    <div class="col-md-3" style="float:left;">
                                ...
                                <div class="value">
                                <input type="text" class="input-label form-control" placeholder="" name="" value="" />
