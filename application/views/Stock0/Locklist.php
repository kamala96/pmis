...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i>Locks</h3>
		</div>
	...
	<div class="container-fluid">
		<div class="row m-b-10">
			...
			<button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>Stock/Add_lock" class="text-white"><i class="" aria-hidden="true"></i> Add  Lock</a></button>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i>  Lock List</h4>
                </div>
                                        ...
                                        <tr style="text-align:center;">
                                           ...
                                           <td class="Hidden"><?php echo $value->releasedate; ?></td>
 		                                   ...
 		                                   <td class="jsgrid-align-center " style="text-align: right;">
		                                   	 <a href="<?php echo base_url(); ?>Stock/Locklist" title="Edit" class="btn btn-sm btn-info waves-effect waves-light">Edit</a>
		                                   </td>
