...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Selling</h3>
		</div>
		<div class="col-md-7 align-self-center">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a  href="<?php echo base_url(); ?>Stock/Requisition_Form1">Selling</a></li>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i> Selling List</h4>
                </div>
                                ...
                                <table id="kiwi" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>StockId</th>
                                            <th>QuantitySupp</th>
                                            <th>SellingPerValue </th>
                                            
                                            
                                            <th>ReceiptNumber</th>
                                            <th>PaidDate</th>
                                           
                                            <th>GeneratedBillNumber</th>
                                            <th>Description </th>
                                             <th>Totalamount</th>
                                   ...
                                   $stockname = $this->Stampbureau->geStockname($value->StockId);
                                    $stockprice = $this->Stampbureau->geStockprice($value->StockId);
                                        ...
                                        <tr style="text-align: center;">
                                           ...
                                           <td><?php echo $value->BuyerPhone; ?></td>

                                           <td>
                                            <?php echo  date('D', strtotime($value->CreatedDate)) .' - '.date('M', strtotime($value->CreatedDate)).' - '.date('Y', strtotime($value->CreatedDate)); ?>
                                                
                                            </td>
                                             <td><?php echo $stockname; ?></td>
                                           
                                            <td><?php echo $value->QuantitySupp; ?></td>
                                            <td><?php echo $value->SellingPerValue; ?></td>
                                            
                                            <td><?php echo $value->ReceiptNumber; ?></td>

                                            <td>

                                            <?php echo  date('D', strtotime($value->PaidDate)) .' - '.date('M', strtotime($value->PaidDate)).' - '.date('Y', strtotime($value->PaidDate)); ?>
                                                
                                            </td>
                                            
                                            <td ><?php echo $value->GeneratedBillNumber; ?></td>
