...
<div class="page-wrapper">
	...
	<div class="container-fluid">
		<div class="row m-b-10">
			...
			<!-- <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>Stock/Add_philatel" class="text-white"><i class="" aria-hidden="true"></i> issued Requisition list</a></button> -->
