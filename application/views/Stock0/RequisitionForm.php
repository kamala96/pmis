...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		...
		<div class="col-md-7 align-self-center">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>Box_Application/StampBureauandStock">Inventory</a></li>
	...
	<div class="container-fluid">
		<div class="row m-b-10">
			...
			<button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url(); ?>Stock/IssuedList" class="text-white"><i class="" aria-hidden="true"></i> issued Requisition</a></button>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i>Un Issued Requisition List</h4>
                </div>
                ...
                ?>      
                                        ...
                                        <tr style="text-align: center;">
                                             <td><?php echo $stockname; ?></td>
                                              <td class="Hidden"><?php echo $value->RequestedBy; ?></td>
                                        	<td>
                                     ...
                                     <!--  <a href="<?php echo base_url();?>Stock/Counter_RequestEdit/<?php echo $value->serialno;?>" title="Issue" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a> -->


                                       <a href="<?php echo base_url();?>Stock/Counter_RequestEdit?k=<?php echo base64_encode($value->serialno); ?>" title="Issue" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-pencil-square-o"></i></a>  
