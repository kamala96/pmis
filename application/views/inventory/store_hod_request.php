                                    ...
                                    <tbody class="results">
                                     <?php $sn=1; foreach($list as $data){
                                        ...
                                        <tr>
                                            ...
                                            <a href="<?php echo base_url('Officialuse/print_hod_store_combine');?>?I=<?php echo base64_encode($data->request_code); ?>" class="btn btn-sm btn-info waves-effect waves-light"> <i class="fa fa-print"></i> Print </a>
                                            <?php }  ?>
