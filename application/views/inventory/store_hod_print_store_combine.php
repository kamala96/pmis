...
<body style="text-align: center;font-family: monospace; background-size: 100%;">
  ...
  <table class="table" style="width: 100%; text-align: center;">
    <tr><th> STORES COMBINED REQUISITION AND ISSUING NOTE (CRIN) </th>
                            ...
                            <tr>
                            <td colspan="4">  Please receive the following items:- </td>
                            </tr>
                           ...
                           <tr>
                            <td colspan="4"> <strong> Approved By StoreMan</strong> <br> Name:  <?php echo 'PF '.$storeinfo->em_code.'-'.$storeinfo->first_name.' '.$storeinfo->middle_name.' '.$storeinfo->last_name; ?> <br> Designation: <?php echo $storeinfo->des_name; ?> </td>
                            </tr>
