...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		<div class="col-md-5 align-self-center">
			<h3 class="text-themecolor"><i class="fa fa-shopping-bag" style="color:#1976d2"> </i> Official Use Add Stock </h3>
		</div>
	...
	<div class="container-fluid">
		<div class="row m-b-10">
            ...
            <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-xl">  <i class="fa fa-plus"></i> Add Stock  </button>
        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i>   Add Stock  </h4>
                </div>
...
<form  method="post" action="<?php echo site_url('Officialuse/save_stock');?>">
  ...
  <table class="table table-bordered">
    <thead>
       ...
       <tbody>
           <tr class="main_row">
             <td>
             <select name="itemid[]" class="form-control custom-select js-example-basic-multiple" required="">
             ...
             <td>
             <select name="unitid[]" class="form-control custom-select js-example-basic-multiple" required="">
                <option value=""> Choose </option>
            ...
            <td><input type="text" name="supplier[]" class="form-control supplier" required=""></td>
