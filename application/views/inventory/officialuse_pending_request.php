            ...
            <div class="card card-outline-info">
                                    ...
                                    <tbody class="results">
                                     <?php $sn=1; foreach($list as $data){
                                        ...
                                        <tr>
                                            ...
                                            <button title="Approve" class="btn btn-sm btn-info waves-effect waves-light" data-toggle="modal" type="button" data-target="#rm_update_modal<?php echo $data->request_code; ?>">  Approve </button>
                ...
                <?php $serial++; } ?>
                 ...
                 <!-- End -->
                  ...
                  <!-- RM Approve -->
                        <div class="modal fade" id="rm_update_modal<?php echo $data->request_code; ?>" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                    ...
                    <form class="form-horizontal m-t-20" method="post" action="<?php echo site_url('Officialuse/approvedbyrm');?>">
                    ...
                    <option value=""> Choose </option>
                     ...
                     <option value="ReceivedByRM"> Approve </option>
                    </select>
                    </div>
                    </div>
                 ...
                 <!-- RM Approved End -->
                  ...
                  <!-- PMU Approve -->
                    ...
                    <form class="form-horizontal m-t-20" method="post" action="<?php echo site_url('Officialuse/approvedbypmu');?>">
                    ...
                    <div class="col-md-2"> <strong> S/N </strong> </div> <div class="col-md-2"> <strong> Item </strong> </div> <div class="col-md-2"> <strong> Unit </strong> </div>  <div class="col-md-2"> <strong> Quantity </strong> </div> <div class="col-md-2"> <strong> Available Qty </strong> </div> <div class="col-md-2"> <strong> New Quantity </strong> </div>
                     ...
                     <hr>
                    <?php $serial=1; foreach($listitems as $row){ 
                    $balance = $this->OfficialuseModel->item_qty_balance($row->item_id);
                    ?>
                    ...
                    <div class="col-md-2">
                    <?php echo number_format(@$balance->balance_qty); ?>
                    </div>
                     <div class="col-md-2">
                ...
                <?php $serial++; } ?>
                    ...
                    <option value=""> Choose </option>
                     <option value="Canceled"> Cancel </option>
                     <option value="ReceivedByPMU"> Approve </option>
                    </select>
                    </div>
                    </div>
