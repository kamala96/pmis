...
?>
  ...
  <div class="col-md-12">
    ...
    <div class="col-md-4"> <b> INTIMATION </b></div>
    <div class="col-md-4" style=" text-align: right;"><img src="<?php echo $barcodegenerator;?>"/>  </div>
 ...
 <!--  <table class="table" style="width: 100%;">
    <tr>
      <th colspan="3"  style=" text-align: right;">  INTIMATION </th>
       <th  style="text-align: right;"> <img src="<?php echo $barcodegenerator;?>"/>    </th>
    </tr>
  </table> -->
  
     

   <table class="table" style="width: 100%; text-align: left; border-top: solid;font-size: 14px;">
  ...
  <div class="page-wrapper">
              ...
              <table class="table" style="width: 100%; text-align: left; border-top: dotted; 1px;font-size: 14px;">
               <!--   <tr>
                <th colspan="3" style="text-align: right;"> <img src="<?php //echo $barcodegenerator;?>"/>    </th>
                
              </tr> -->
               
              <tr><th>   Item Number :<?php echo @$report->FGN_number; ?>    </th>
                <th> Posted At   :<?php echo @$report->postedat; ?></th>
               <th>    Handling Charges   :<?php echo @$report->hndlcharges; ?>   </th>
              </tr>
                  <tr> <th colspan="2">   Addressed To  :<?php echo @$report->addressedto; ?> </th>
                 <th>   <!-- At <?php echo @$report->region.' '.@$report->branch; ?>  --> </th>
                
              </tr>
              <tr>
                <th> Delivery serial:<?php echo 'DP-'.@$report->serial; ?> </th>
                <th colspan="2">    Box Number   :<?php echo @$report->boxnumber.' Mobile:'.@$report->phone; ?>   </th>
                
              </tr>
            <!--   <tr><th colspan="2">    Box Number   :<?php echo @$report->boxnumber.' Mobile:'.@$report->phone; ?>   </th>
                <th>   At <?php echo @$report->region.' '.@$report->branch; ?>  </th>
              ...
              <!--  <tr><th>   Posted At     </th>
                ...
                <th>   </th>
                <th>    </th>
                <th>  <!-- <img src="<?php echo $FGN_number;?>"/>   </th>
                <th> </th> 
              </tr>
    ...
    <tr><th> Received in good condition the postal item described above </th>
                          ...
                          <table class="table" style="border-bottom: dotted; 1px;width: 100%;font-weight: bold ; font-size: 14px;">
    ...
    <tr> <th><br /> </th></tr>
      ...
      <tr>
          <td>Customer Name ........................</td>
          <td>Officer Name ........................</td><?php //echo @$staff; ?>
      </tr>

    <tr> <th><br /> </th></tr>
      <tr>
          <td>Customer ID ..........................</td>
          <td>PF No. ..........................</td><?php //echo @$pf; ?>
      </tr>
      <tr>
          <td>Date .................................</td>
          <td>Date Printed <?php echo @$dateprinted; ?></td>
      </tr>
