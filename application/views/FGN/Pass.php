                          ...
                          <a href="<?php echo base_url(); ?>Services/Small_Packets" class="btn btn-primary waves-effect waves-light">New Small Packet</a>
							...
							?>
                              ...
                              <div class="col-md-12">
                                                 ...
                                                 <form class="row" method="post" action="<?php echo site_url('Packet_Application/print_Packets_Passto_reports');?>">
...
<!-- 
                            <form method="post" action="<?php //echo base_url(); ?>Packet_Application/print_Packet_Passto_report">
							   <div class="table-responsive ">
                                    <table id="example4" class="display  table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
										...
										?>
                                            <tr>
                                                ...
                                                <td class="jsgrid-align-center ">
                                                   ...
                                                   <button type="submit" value="<?php echo $data->FGN_number; ?>" class="btn btn-info waves-effect waves-light" name="submitinfo"> <i class="fa fa-print"></i> Print </button>
...
function Submitvalue(obj) {
    ...
    $.ajax({
        type : 'POST',
        url  : '<?php echo base_url('Packet_Application/Itemized_Submitted')?>',
