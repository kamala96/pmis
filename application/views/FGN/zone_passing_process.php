...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Small packet passing Process</h3>
    </div>
...
<div class="container-fluid">
    <div class="col-lg-12 col-md-12">
        <div class="row">
           ...
           <div class="col-md-2">
                <button type="button" class="btn btn-primary btn-block"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Packet_Application/item_packet_transfer?fromzone=Small_Packets" class="text-white"><i class="" aria-hidden="true"></i> Item transfer</a></button>
            </div>
                                ...
                                <th colspan="3">
                                   <div class="input-group">
                                    <!-- oninput="passToOperatorByzone(this);" -->
                                      ...
                                      <br><br></div>
                                      <div class="input-group">
                                       <span id="lblValue" class="lblValue">FGN Number scan: </span><br></div>
                                </th>
                            </tr>
...
<script type="text/javascript">
    ...
    function getPassedItemsByOperator(obj){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>Packet_Application/getSmallPacketPassedItemsByOperator",
    ...
    function passToOperatorByzone(obj){
        ...
        if (operator) {
            ...
            if (barcode.length == 13) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>Packet_Application/SmallPacketPassToCage",
                    data:{
                        FGN_number:barcode,
                        operator:operator,
                        zonetype:zone,
