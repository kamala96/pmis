                ...
                <div class="row">
                   ...
                   <!-- <div class="card-header">
                    <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>Services/Despatch" class="text-white"><i class="" aria-hidden="true"></i> Despatch list </a></button>
                            ...
                            <form class="row" method="post" action="<?php echo site_url('Packet_Application/item_packet_transfer');?>">
 ...
 <div class="table-responsive">
    ...
    <table  class="table table-hover table-bordered" cellspacing="0" width="100%">
        ...
        <tr style="font-size:12px ;">
            <th><b>Transfer from Foreign Letter: </b><?php echo $info_assignedby->em_code; ?>  - <?php echo $info_assignedby->first_name.' '.$info_assignedby->middle_name.' '.$info_assignedby->last_name; ?> </th>
        ...
        <br>
            ...
            <table  class="table table-hover table-bordered" cellspacing="0" width="100%" style="font-size: 11px;">
                <thead>
                    <tr>
                        <th>S/No</th>
                        <th>Addresse</th>
                ...
                foreach ($listdata as $key => $value){ ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $value['addressedto'];?></td>
                        <td style="font-weight: 900"><strong><?php echo $value['FGN_number'];?></strong> </td>
                        <td><?php echo $value['serial'];?></td>
                        <td><?php echo $value['hndlcharges'];?></td>
