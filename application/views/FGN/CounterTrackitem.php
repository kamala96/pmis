                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                          ...
                          <a href="<?php echo base_url(); ?>Unregistered/small_packet" class="btn btn-primary waves-effect waves-light">Small Packet Dashboard</a>
...
function Submitvalue(obj) {
    ...
    $.ajax({
        type : 'POST',
        url  : '<?php echo base_url('Packet_Application/CounterTrackItem')?>',
        data : {fgn_no:fgn_no
               },
                dataType:'json',
