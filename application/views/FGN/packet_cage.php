...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Small Packet cage</h3>
    </div>
...
<script type="text/javascript">
    ...
    function getListFromZone(operatorId){
        ...
        $.ajax({
            type:'post',
            url:"<?php echo base_url();?>Packet_Application/get_Foreign_latter_sentList",
    ...
    function scanforReceive(obj) {
        ...
        if (barcode.length == 13) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url();?>Packet_Application/SmallPacket_cage_receive",
                data:{
                    barcode:barcode,
