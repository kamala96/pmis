...
<div class="container-fluid">
    <div class="row m-b-10">
        <div class="col-12">
         <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url()?>Ems_Domestic/Incoming_Item?AskFor=<?php echo $askfor; ?>" class="text-white"><i class="" aria-hidden="true"></i> Delivered Item</a></button>
               ...
               <!-- MAIL       <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>Ems_Domestic/Incoming_Item" class="text-white"><i class="" aria-hidden="true"></i> Incoming Item</a></button> -->
                  ...
                  <hr/>
                        <div class="row">
                          ...
                          <form   method="POST" action="<?php echo base_url()?>Ems_Domestic/Delivered_Item_Search?AskFor=<?php echo $askfor; ?>">
                         ...
                         <?php }else{ ?>
                           ...
                           <form  method="POST" action="<?php echo base_url()?>Ems_Domestic/Delivered_Item_Search?AskFor=<?php echo $askfor; ?>" >
                                ...
                                <th style="paddin-top:20px;">
                                  ...
                                  <input type="submit" name="" class="btn btn-info " style="" id="" value="Search Information">
                                </div>
                                </th>
                            </tr>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Items Delivered
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="card">
                        ...
                        <?php if ((@$value->item_status == "Derivered") || (@$value->sender_status == "Derivery")) {?>
                           <!-- <a href="get_delivery_info?senderid=<?php // echo @$value->sender_id;?>" class="btn btn-info">Show Info</a> -->
                            ...
                            <a href="get_delivery_info?senderid=<?php echo @$value->sender_id;?>&AskFor=<?php echo @$askfor;?>" class="btn btn-info">Show Info </a>
