    ...
    <div class="col-md-5 align-self-center">
      <h3 class="text-themecolor"><i class="fa fa-braille" style="color:#1976d2"></i>&nbsp 
        ...
        $basicinfo = $this->employee_model->GetBasic($id); 
          ...
          <div class="">
            <form method="POST" action="<?php echo base_url('Box_Application/despatch_action')?> ">
            ...
            <thead>
                                            ...
                                            <tbody>
                                              <?php foreach ($despatchIn as $value) {?>
                                                <tr>
                                                  <td><a href="bags_list_despatch?despno=<?php echo base64_encode($value->desp_no) ?>" data-despno = "<?php echo $value->desp_no; ?>" class=""><?php echo $value->desp_no; ?></a>
                                                  </td>
