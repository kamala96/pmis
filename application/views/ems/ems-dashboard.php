                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>Ems_Domestic/Domestic_Category_Dashboard" class="text-muted m-b-0">Domestic</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <a href="<?php echo base_url()?>Ems_International/Ems_International_Application_List" class="text-muted m-b-0">International</a>
                                        </div>
                                </div>
                            </div>
                        </div>
