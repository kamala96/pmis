    ...
    <div class="row m-b-10">
        <div class="col-12">
         <?php if($this->session->userdata('user_type') == "EMPLOYEE"){ ?>
                         <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/bill_customer_list" class="text-white"><i class="" aria-hidden="true"></i> Bill Transactions Lists List</a></button>
                    <?php }if($this->session->userdata('user_type') == "ADMIN" || $this->session->userdata('user_type') == "ACCOUNTANT"){ ?>
                       ...
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Bill_Customer/bill_customer_list" class="text-white"><i class="" aria-hidden="true"></i> Bill Customer List</a></button>
                        ...
                        <form method="POST" action="Credit_Customer_Prepare_Bill?I=<?php echo base64_encode($credit_id);?>&&AskFor=<?php echo $askfor; ?>">
                            <table class="table table-bordered" style="width: 100%;">
                                ...
                                <div class="input-group">
                                    <input type="text" name="datetime" class="form-control mydatetimepicker month1">
                  ...
                  <tfoot>
                    ...
                    <tr><td colspan="8"></td><td>
                      <?php if(!empty($emslist)){?>
                         <a href="<?php echo base_url()?>Box_Application/invoice_sheet?acc_no=<?php echo base64_encode($acc_no) ?>&&month=<?php echo $month;?>" class="btn btn-info">Print Invoice</a>
                     <?php  }?>
