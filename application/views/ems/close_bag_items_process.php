                            ...
                            <tbody class="">
                                <tr>
                                    <td colspan="7"></td><td style="float: right;">
                                        <a class="btn btn-success" href="<?php echo base_url();?>Box_Application/close_bag_items_process" class="text-white"><i class="" aria-hidden="true"></i> Close Bag </a>
                                      </td>
                                  </tr>
                            </tbody>
                        </table>
...
function getbagItems(obj){
    ...
    $('#btnDeletebag').attr('href',href+'?bagno='+bagno+'&returnto=close_bag_items_process');
...
function assignBagProcess(obj){
        ...
        if (rec_region && rec_branch && barcode) {
            ...
            if (barcode.length == 13) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>Box_Application/assign_item_bag_process",
                    data:{
