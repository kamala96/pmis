                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                          <form action="<?php echo base_url()?>Box_Application/received_item_from_counter_search" method="POST">
			...
			<?php }else{?>
                   ...
                   <td colspan="2">
                    ...
                    <select class="form-control custom-select" name="bagss" style="height: 40px;background-color: white;"  id="bagss"  onChange="getbags();">
                      ...
                      <td colspan="1"><input type="text" name="weight" class="form-control weight" id="weight" placeholder="bag weight" required="required"></td>
                    <td colspan="2">
