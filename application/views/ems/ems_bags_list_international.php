...
<div class="page-wrapper">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="">
                         <a href="<?php echo base_url('Box_Application/despatched_bags_list') ?>" class="btn btn-info " style="padding-right: 10px;"><i class="fa fa fa-bars"></i> Despatched Bags</a>
                          <a href="<?php echo base_url('Box_Application/pending_bags_despatch_list') ?>" class="btn btn-info" style="padding-right: 10px;"><i class="fa fa fa-bars"></i> Pending Despatched Bags</a>
  ...
  <strong> <?php echo $this ->session->userdata('message'); ?></strong> 
                ...
                <?php }?>
                        ...
                        <form method="POST" action="<?php echo base_url('Box_Application/bags_despatch')?>">
                      ...
                      <table id="example5" class="display nowrap table table-hover  table-bordered" cellspacing="0" width="100%">
                       ...
                       <tbody class="results">
                         <?php foreach ($emsbags as  $value) {?>
                           <tr>
                             <td>
                               <a href="<?php echo base_url()?>Box_Application/ems_item_list_bags?trn=<?php echo $value->bag_number; ?>" data-bagno = "<?php echo $value->bag_number; ?>" class="listitem"><?php echo $value->bag_number;?></a>
                           ...
                           <td>
                             ...
                             WHERE `isBagNo`='$bagno' AND `PaymentFor` = 'EMS_INTERNATIONAL'";
                             $query  = $db2->query($sql);
                             echo $query->num_rows();
