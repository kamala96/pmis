                    ...
                    <!--   <br> -->
                        ...
                        <div class="">
                         ...
                         <p style="margin-top: -60px;">Dispatching Office Date Stamp</p>
                          ...
                          <tr>
                          <th colspan="2">
                          From: <?php echo @$getbags->bag_region_from; ?>
                          </th>
                          <th>
                          To: <?php echo @$getbags->bag_region; ?>
                          </th>
                          </tr>
                          ...
                          <th colspan="3">
                          Despatch No: <?php echo @$getbags->despatch_no; ?>
                          </th>
                          </tr>
                               ...
                               <?php foreach (@$getInfo as  $value) {?>
                                   <tr>
                                     ...
                                     <td> <?php  echo @$value->Barcode; ?>  </td>
                                      ...
                                      <td> 
                                            <a href="
                                         <?php echo base_url()?>Box_Application/ems_item_list_bags_remove?trck=<?php echo @$value->track_number; ?>&bagno=<?php echo @$bagno; ?>"data-bagno = "<?php echo @$value->track_number; ?>" class="btn btn-danger">
                                         Remove     
                                          </a>
                                       </td>
