				...
				<div class="row despatched" style="padding-left: 10px;padding-right: 35px; text-align: left;" style="display:none">
                 ...
                 <div class="col-md-3">
                      <label>Despatch Branch</label>
                        <select name="district" required="required" class="form-control custom-select"  id="rec_dropp1" required="required">  
                  ...
                  <div class="col-md-3 " style="display: block;">
                    <label>Weight</label>
                    <input required="required" placeholder="Weight" type="text" name="weight" class="form-control" >
                  </div>
                            ...
                            $(document).ready(function(){
                                ...
                                $('#input_wrapper3').append(
                                    ...
                                    '<div id="'+x+'" class="form-group col-md-12" style="display:flex;">' +
                                     ...
                                     //  '</div>' +
                                      '<div>'+
                                      '<input type="text" id="'+x+'" onchange="preventDefaultInput(this);" class="form-control preventDefaultInput" name="ln[]"   placeholder=""/>'+
                                      '</div>' +
                                      '<div>'+
                              ...
                              $('#input_wrapper3').on('click', '.deleteBtn3', function(e) {
                               ...
                               $('.preventDefaultInput').on('onchange', function(e) {
                                e.preventDefault();
