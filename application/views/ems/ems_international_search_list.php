        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body" >
                      <div class="col-md-12">
                        <form action="Search_international" method="POST">
                        <div class="input-group">
                          
                          <input type="text" name="barcode" class="form-control " placeholder="Barcode/Control Number">
                               ...
                               <tfoot>
                                 <tr>
                                  <td colspan="" style="text-align: center;">
                                    <!-- <button  class="btn btn-info" name="endshift" value="endshift">End Shift >>></button> -->
                                  </td>
                                   <td colspan=""></td>
                                   ...
                                   <td colspan=""></td>
                                    <!-- <td colspan="" style="text-align: center;">
                                        <button class="btn btn-info">Back Office >>></button>
                                    </td> -->
