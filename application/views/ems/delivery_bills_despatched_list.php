...
<div class="col-lg-3 col-md-6">
                ...
                <div class="row" style="font-size:22px ;">
                  <div class="col-lg-12">
                    <div class="card">
                      ...
                      <!-- <a href="
                               <?php echo base_url()?>Box_Application/Waybill_download?despno=<?php echo $itemdata->despatch_no; ?>"data-bagno = "<?php echo $itemdata->despatch_no; ?>" class="btn btn-primary">Wordocument
                                </a> -->
                      <br>
          ...
          <div class="">
            ...
            <div id="div1">
      <table  class="display nowrap table table-hover table-bordered" cellspacing="0" width="100%" style="border:2px;color:#000;font-size: 26px;font-weight: bold;">
            <thead>
               ...
               <tr>
                         ...
                         <img src="<?php echo base_url(); ?>assets/images/tcp.png" height="100px" width="200px" style="display: block; margin-left: auto; margin-right: auto;"/>
                          ...
                          <tr>
                          <th colspan="7">
                          Despatch Number:   <?php echo $itemdata->despatch_no; ?>
                          </th>
                          </tr>

                          <tr>
                          <th colspan="2">
                          From: <?php echo $itemdata->bag_branch_from; ?>
                          </th>
                          <th colspan="5">
                          To: <?php echo $itemdata->branch_to; ?>
                          </th>
                          </tr>
...
<table  class="display nowrap table table-hover table-bordered" cellspacing="0" width="100%" style="border:2px;color:#000;font-size: 20px;font-weight: bold;">
  ...
  <?php $sn++; } ?>
    ...
    <tr>
    <td colspan="7">Total Weight: <?php  $total = array_sum($sum); echo $total; ?></td>
      <!-- <td colspan="4"> Remarks: <?php echo $itemdata->remark; ?> </td> -->
    </tr>
...
<table  class="display nowrap table table-hover table-bordered" cellspacing="0" width="100%" style="border:2px;color:#000;font-size: 20px;font-weight: bold;">
    <tr>
    <td> <br>  Dispatching Office Date Stamp      <br><br><br>     Despatched By................. </td>
    <td>         <br> <br><br><br>   Carried by..................        </td>
    <td>   <br> Receiving Office Date Stamp      <br><br><br>     Receiving By.......................  </td>
    </tr>
 </table>
