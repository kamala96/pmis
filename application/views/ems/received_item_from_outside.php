                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                          <form action="<?php echo base_url()?>Box_Application/received_item_from_outside_search" method="POST">
                                <table class="table table-bordered" style="width: 100%;">
                                  ...
                                  <?php if($this->session->userdata('user_type') == 'SUPERVISOR' || $this->session->userdata('user_type') == 'EMPLOYEE' || $this->session->userdata('user_type') == 'RM'){?>
                                    <tr>
                                        ...
                                        <input type="text" name="date" id="date" class="form-control  mydatetimepickerFull">
                                    ...
                                    <th>
                                 <div class="input-group">
                                    <input type="text" name="month" id="month" class="form-control  mydatetimepicker month2">
...
<?php }else{?>
  <?php } ?>
           ...
           <form method="POST" action="receive_action" enctype="multipart/form-data">
...
<!--                                     <div class="form-check" style="padding-left: 53px;" id="showCheck">
                          ...
                          <tbody class="results1">
                           ...
                           <!--  </td> -->
                             <td>
                                <a href="<?php echo base_url();?>Box_Application/get_qrcode_item2?code=<?php echo base64_encode($value->Barcode) ?>" target="_blank"><?php echo $value->Barcode;?></a></td>
                                <!-- <?php echo $value->Barcode;?></td> -->
                            <td>

                              <?php if($value->office_name == 'Back'){ ?>
                                <button type="button" class="btn  btn-success btn-sm" disabled="disabled">Backoffice</button>
                              <?php }?>
                               <?php if ($value->office_name == 'Received' ) {?>

                                <button type="button" class="btn  btn-info btn-sm" disabled="disabled">Successfull Received</button>
                            ...
                            <td style="padding-left:  65px;"><div class='form-check'>
                              <?php if ($value->office_name == 'Received' ) {?>
                                <!-- && $value->bag_status == 'isNotBag' -->


                                <input type='checkbox' name='I[]' class='form-check-input checkSingle <?php echo $value->Barcode;?>' id='remember-me' value='<?php echo $value->id ?>'>
                                <!-- <input type="text" name="destreg" value="<?php echo $value->r_region ?>"> -->
                                <label class='form-check-label' for='remember-me'></label>
                             
                              <?php }elseif($value->office_name == 'Back' ){ ?>
                                 <input type='checkbox' name='I[]' class='form-check-input checkSingle <?php echo $value->Barcode;?>' id='remember-me' value='<?php echo $value->id ?>'>
                  ...
                  <!--   <td>&nbsp;</td> -->
                    <td style="" colspan="2">
                     ...
                     <td style="" colspan="1">
                      ...
                      <button type="submit" class="btn btn-info form-control" name="catname" value="close" style="color: white;">Receive</button></td></tr>
				<?php }?>
...
$(document).ready(function() {
 // $('#example4 thead tr').clone(true).appendTo( '#example4 thead' );
    $('#example4 thead tr:eq(1) th').not(":eq(10),:eq(05),:eq(06),:eq(11)").each( function (i) {
        var title = $(this).text();
...
<script>
  ...
  function edValueKeyPress() {
    ...
    //$(barcodeClass).prop("checked", true);
