                      ...
                      <div class="card-body">
                        <div class="">
                          ...
                          <a href="pending_item_from_counter" class="btn btn-info" style="padding-right: 10px;"><i class="fa fa fa-bars"></i> Pending Item From Counter</a>
                            <a href="<?php echo base_url('Box_Application/Receive_scanned_item');?>" class="btn btn-info " style="padding-right: 10px;"><i class="fa fa fa-bars"></i> Bulk Delivered Scanned</a>
...
<?php }else{?>
  <?php } ?>
           <form method="POST" action="receive_item">
