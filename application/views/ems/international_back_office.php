                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="row">
                           <div class="col-md-12">
                          <a href="<?php echo base_url('Box_Application/received_item_from_counter')?>" class="btn btn-info " style="padding-right: 10px;"><i class="fa fa fa-bars"></i> Received Item From Counter</a>
                        ...
                        <div class="col-md-12">
                          ...
                          <!-- <form action="BackOffice" method="POST"> -->
                             <form   method="POST" action="<?php echo base_url()?>Ems_International/international_back_office">
