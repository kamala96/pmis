                    ...
                    <div class="card">
                      <div class="card-body">
                       ...
                       <!--  <div class="btn-group btn-group-justified">
                        ...
                        <div class="btn-group btn-group-justified">
                          <a href="<?php echo base_url('Box_Application/equaryItemList');?>" class="btn btn-info " style="padding-right: 10px;"><i class="fa fa fa-bars"></i> Equary Item</a>
                        </div> 
                         <div class="btn-group btn-group-justified">
                          <a href="<?php echo base_url('Box_Application/passTodelivery');?>" class="btn btn-info " style="padding-right: 10px;"><i class="fa fa fa-bars"></i> Pass to delivery</a>
                        </div>

                         <!-- for scanning non-bag -->

                         <div class="btn-group btn-group-justified">
                          <a href="<?php echo base_url('Box_Application/Receive_non_bag_item');?>" class="btn btn-info " style="padding-right: 10px;"><i class="fa fa fa-bars"></i> Receive non bag items</a>
                        </div>
                    ...
                    <input type="checkbox"  class="form-check-input" id="checkAll" style="">
                       <label class="form-check-label" for="remember-me">Select All</label>
                                            ...
                                            <tbody>
                                                ...
                                                <?php $no=0; foreach ($despatchIn as  $value) { $no=$no+1;;?>
                                                <tr>
                                                <td><?php echo $no;?></td>
                                                  <td>
                                                  ...
                                                  <td>
                                                    ...
                                                    if ( $value->despatch_status == 'Sent' ) { ?>
                                                     <div class='form-check' style="padding-left: 53px;">
                                                      <input type='checkbox' name='I[]' class='form-check-input checkSingle ' id='remember-me' value='<?php echo $value->desp_no; ?>'>
...
$(document).ready(function() {
    ...
    $(".BtnSubmit").on("click", function(event) {
     ...
     //console.log(datetime);
                ...
                $.ajax({
                 type: "POST",
                 url: "<?php echo base_url();?>Box_Application/Get_Despatch_In_ByDate",
 ...
 $(".checkSingle").each(function(){
    ...
    if($(this).prop("checked") == true){
      ...
      var despatch = $(this).val()
        ...
        $.ajax({
           type: "POST",
           url: "<?php echo base_url();?>Box_Application/receiveBags",
           data:'despno='+ despatch,
           success: function(response) {
