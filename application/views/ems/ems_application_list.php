...
<div class="container-fluid">
    <div class="row m-b-10">
        <div class="col-12">
          <?php if($this->session->userdata('user_type') == "SUPERVISOR" || $this->session->userdata('user_type') == "AGENT"){ ?>
                     <a class="btn btn-primary" href="<?php echo base_url() ?>Box_Application/Ems"> <i class="fa fa-plus"></i>  Ems Application</a>
		  ...
		  <?php if($this->session->userdata('status') != "Assign" && $this->session->userdata('user_type') == "EMPLOYEE"){?>
		                 ...
		                 <button type="button" class="btn btn-primary" disabled="disabled"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Box_Application/Ems"> Ems Application</a></button>
                     <button type="button" class="btn btn-primary" disabled="disabled"><i class="fa fa-bars"></i><a href="#" class="text-white"><i class="" aria-hidden="true" ></i> Ems Application List</a></button>
                     <button type="button" class="btn btn-primary" disabled="disabled"><i class="fa fa-plus"></i><a href="#" class="text-white"><i class="" aria-hidden="true"></i> Create Bill Customer</a></button>
                     <button type="button" class="btn btn-primary" disabled="disabled"><i class="fa fa-bars"></i><a href="#" class="text-white"><i class="" aria-hidden="true"></i> Ems Back Office List</a></button>
                     <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>Box_Application/Incoming_Item" class="text-white"><i class="" aria-hidden="true"></i> Incoming Item</a></button>
                     <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>Loan_Board/Loan_info" class="text-white"><i class="" aria-hidden="true"></i> LoanS Board(HESLB)</a></button>
      <?php }elseif($this->session->userdata('status') == "Assign" && $getInfo->date_assign != $date){?>
