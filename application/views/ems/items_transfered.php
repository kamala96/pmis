                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered" style="width: 100%;">
                                  ...
                                  <?php if($this->session->userdata('user_type') == 'SUPERVISOR' || $this->session->userdata('user_type') == 'EMPLOYEE'){?>
                                    <tr>
                                        <th style="">
                                         <form action="<?php echo base_url();?>Box_Application/Get_ems_transfered_items_In_ByDate?>" method="get">
                                         <label>Select Date:</label>
                                         <div class="input-group">
                                            <input type="date" name="tdate" class="form-control">
                                            <input type="button" name="search" class="btn btn-success" style="" id="" value="Search Date" required="required">
                                        </div>
                                        </form>
                                    </th>
                                  </tr>
          ...
          <?php if(isset($_GET['search'])){?>
           ...
           <form method="POST" action="close_bags" enctype="multipart/form-data">
			...
			<?php }else{?>
                   ...
                   <td colspan="2">
                      <select name="district" value="" class="form-control custom-select" style="background-color: white;"  id="rec_dropp1" required="required">
