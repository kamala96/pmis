...
<style type="text/css">
         ...
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"> Non-bag Item received  </h3>
                </div>
                ...
                <div class="row">
                   ...
                   <div class="card-header">
                    <button type="button" class="btn btn-primary"><i class="fa fa-list"></i><a href="<?php echo base_url() ?>Box_Application/despatch_in" class="text-white"><i class="" aria-hidden="true"></i> Despatch</a></button>  
                            ...
                            <form class="row" method="post" action="<?php echo site_url('Box_Application/item_received_non_bag');?>">
 ...
 <div class="table-responsive" id="div1">
    ...
    <div class="panel-footer text-center">
        ...
        <br>
        <h3> <strong> NON BAG ITEM RECEIVED </strong> </h3>
    </div>
