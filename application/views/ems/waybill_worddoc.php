    ...
    <div class="col-md-5 align-self-center">
     ...
     $trlist=$trlist. '  <tr>
                                     ...
                                     <td style=" border: 1px solid black;"> '.$value->bag_number.' </td>
                                      <td style=" border: 1px solid black;"> '.@$value->service_type.'  </td>
                                      <td style=" border: 1px solid black;">'.$value->bag_region_from.'</td>
                                      <td style=" border: 1px solid black;" colspan="2">'.$value->bag_branch_from.'</td>
                                      <td style=" border: 1px solid black;">'. $value->bag_region.'</td>
                                       <td style=" border: 1px solid black;" colspan="2">'.$value->bag_branch.'</td>
