                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                           <h2 id="loadingtext"></h2>
                            ...
                            <input onchange="validateBarcode(this)" type="text" name="barcode" class="form-control " id="barcode" >
                    ...
                    if(name == ''){
                        ...
                        $.ajax({
                             ...
                             data : {
                                ...
                                r_address:r_address,
                                r_mobile:r_mobile,
                                r_mobilev:r_mobilev,serial:serial},
                             success: function(response){
                                // console.log(response)
