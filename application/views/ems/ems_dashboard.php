...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Domestic EMS</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Domestic EMS</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
                ...
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <div class="card">
                           <div class="card-body">
                            <div id="div1"> 
                        <form method="post" action="commission_registration"> 
                                <div class="row">
