                            ...
                            <table class="table table-bordered" id=""> 
                                ...
                                ?>
                                    <tr><td><input type="text" name="addition_name1" class="form-control" value="<?php echo $value->add_name; ?>" style=""></td><td><input type="text" name="addition_amount1" class="form-control" value="<?php echo $value->add_amount; ?>" style="">
                                        ...
                                        <td>
                                        <input type="text" name="enddate1" class="form-control mydatetimepickerFull" value="<?php echo $value->end_month; ?>" style=""></td><td><input type="hidden" name="addid" value="<?php echo $value->add_id; ?>">
                                            <input type="hidden" name="emid" value="<?php echo $basic->em_id; ?>">
                                            <input type="hidden" name="sid" value="<?php echo $salaryvalue->id; ?>">
                ...
                <div class="row">
                      ...
                      <form action="<?php echo base_url() ?>Payroll/Save_Fund" method="post" enctype="multipart/form-data">
                                ...
                                ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                <input type="text" class="form-control" placeholder="Fund Percent" value="<?php echo number_format(@$value->fund_amount,2);?>" readonly="readonly">
                                                    </td>
                                                    <td>
                        ...
                        <form action="<?php echo base_url() ?>Payroll/Save_Assuarance" method="post" enctype="multipart/form-data">
                                            ...
                                            <table class="table table-bordered">
                                                <tr style="background-color: #FFFFE0;"><th colspan="3"><h3 class="card-title">Sanlam Insurance</h3></th></tr>
                                                <?php if(empty($AfricaAssurance)){ ?>
                                                <?php }else{?>

                                                     <?php foreach ($AfricaAssurance as $value) {?>

                                                    <tr>
                                                      
                                                    <td width="45%">
                                                        <input type="text" name="fund_name" class="form-control" required="required" placeholder="Fund Name" value="SANLAM INSURANCE" readonly="readonly">
                                                    </td>
                                                        <td width="45%">
                                                        <input type="text" name="fund_percent" class="form-control" required="required" value="<?php echo $value->ded_amount;?>">
                                                        <input type="hidden" name="assId" class="form-control" value="<?php echo $value->assur_id;?>">
                                                        </td>
                                                    ...
                                                    <input type="hidden" name="sid" value="<?php echo @$salaryvalue->id; ?>">
                                                    <input type="hidden" name="basic_amount" value="<?php echo @$salaryvalue->total; ?>">
                                                 <button class="btn btn-danger" name="remove" type="submit" value="remove">Remove</button>
                                                    </td>
                                                    </tr>
                                                     <?php }?>
                        ...
                        <form action="<?php echo base_url() ?>Payroll/Tax_relief" method="post" enctype="multipart/form-data">
                                    <table class="table table-bordered">
                                                ...
                                                <?php if (empty($TaxRelif)) {?>
                                                 <?php  }else{ ?>
                                                       <?php 
                                    foreach ($TaxRelif as $value) {
                                ?>
                                                <tr>
                                                    <td>
                                                        <input type="text" readonly="readonly" name="tax_relief" class="form-control" required="required" placeholder="Tax Relief" value="<?php echo $value->amount;?>">
                                                         <input type="hidden" name="trid" class="form-control" required="required" placeholder="Tax Relief" value="<?php echo $value->tr_id;?>">
                        ...
                        <?php }else{?>
                            <?php foreach ($TradeUnion as  $value) {?>
                            <tr><td width="45%"><input type="text" readonly="readonly" class="form-control" name="" value="<?php echo $value->ded_name; ?>"></td><td width="45%">
                            <input type="text" name="" class="form-control" readonly="readonly" value="<?php echo $value->ded_amount; ?>">
                        </td><td width="10%">
                            <input type="hidden" name="dedid" class="form-control" readonly="readonly" value="<?php echo $value->ded_id; ?>">
                            <button class="btn btn-danger" name="delete" value="delete">Remove</button>
                        </td> </tr>
                        <?php } ?>
                        <?php  
                    ...
                    <table class="table table-bordered" id="dynamic_field3">
                        <tr style="background-color: #FFFFE0;"><th colspan="4">
                            <h3 class="card-title">Makato ya mikopo <?php //echo date('M',strtotime("-1 month")); ?></h3>
                        </th></tr>
                        <?php foreach ($LoanDeduction as $value) {$word = 'KK '; ?>

                       <!--  strpos($value->other_names,  $word) !== true -->
                            <?php if($value->status != 'COMPLETE' && ($value->other_names == 'HESLB' || $value->other_names == 'ZHESLB' || $value->other_names == 'SALARY RECOVERY' ) ){?>
                    
                            <tr>  
                    <td>
                        <input type="hidden" name="id" class="form-control name_list" value="<?php echo $value->others_id; ?>"/><input type="text" name="others_names" placeholder="Enter Lander Name" class="form-control name_list"  value="<?php echo $value->other_names; ?>"/></td>
                        <td><input type="text" name="loan_amounts" placeholder="Enter Loan Amount" class="form-control name_list"  value="<?php echo $value->loan_amount ?>"/></td>
                        <td><input type="text" name="loan_deduction_amounts" placeholder="Enter Deduction Amount" class="form-control name_list" value="<?php echo $value->installment_Amount ?>" />
                            <input type="hidden" name="others_id" class="form-control name_list" value="<?php echo $value->others_id ?>" /></td><td colspan="2">
                                <button class="btn btn-danger" name="delete" value="delete">Remove</button>
                                <button class="btn btn-danger" name="update" value="update">Update</button>
                            </td>
                        </tr> 
                    ...
                    <td>
                        ...
                        <td><input type="text" name="loan_amounts" placeholder="Enter Loan Amount" class="form-control name_list"  value="<?php echo $value->loan_amount ?>"/></td>
                        <td><input type="text" name="loan_deduction_amounts" placeholder="Enter Deduction Amount" class="form-control name_list" value="<?php echo $value->installment_Amount ?>" />
                            <input type="hidden" name="others_id" class="form-control name_list" value="<?php echo $value->others_id ?>" /></td>
                            <td colspan="2">
                               <!--  <button disabled class="btn btn-danger" name="delete" value="delete">Remove</button>
                                <button disabled class="btn btn-danger" name="update" value="update">Update</button> -->
                            </td>
                        </tr> 
                      ...
                      <?php }} ?> 
                    <tr>
                    <td><select class="form-control name_list"  name="others_name"> 
                                       <option value="SALARY RECOVERY">SALARY RECOVERY</option>
                                        <option value="HESLB">HESLB</option>
                                        <option value="ZHESLB">ZHESLB</option>
                                        
                                    </select>

                        <!-- <input type="text" name="others_name" placeholder="Enter Lander Name" class="form-control name_list"  /> -->
                    </td>
                    ...
                    <form action="<?php echo base_url() ?>Payroll/Save_percent_comm" method="post" enctype="multipart/form-data">
                                  ...
                                  <!--   <div class="row">
                                      ...
                                      <div class="row">
                                        ...
                                        <table class="table table-bordered" style="width: 100%;">
                                            <tr style="background-color: #FFFFE0;"><th colspan="2"><h3 class="card-title">Pending PSSSF</h3></th></tr>
                                             <?php foreach ($commPensions as $value) {?>
                                              
                                            <tr>
                                            <td width="90%"><input type="text" name="" class="form-control" required="required" placeholder="Amount" value="<?php echo @$commPension; ?>" readonly="readonly"></td>
                                             <input type="hidden" name="fundid" value="<?php echo number_format($value->fund_id,2) ; ?>">
                                            <td width="10%">
                                                <button class="btn btn-danger" style="display: none;" name="remove" value="remove"> Remove</button>
                                            </td>
