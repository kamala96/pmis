                    ...
                    <div class="card-body">
                        <div class="table-responsive ">
                            <table id="example4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php foreach($payeChart as $value): ?>
                                    <tr>
                                         <td><?php echo number_format($value->income_min,2); ?></td>
                                         <td><?php echo number_format($value->income_max,2); ?></td>
                                        <td><?php echo number_format($value->tax_rate,2); ?></td>
                                        <td><?php echo $value->rate_percent ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
...
<script type="text/javascript">
    ...
    $('#example4 thead tr:eq(1) th').not(":eq(5),:eq(6)").each( function (i) {
        var title = $(this).text();
