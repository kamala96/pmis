...
<!--                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#TypeModal" data-whatever="@getbootstrap" class="text-white TypeModal"><i class="" aria-hidden="true"></i> Add Payroll </a></button>-->
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-info">
                            ...
                            <table class="table table-bordered" width="100%">
                                <form method="post" action="Salary_Slips">
                                <tr>
                    ...
                    <a href="<?php echo base_url() ?>payroll/Salary_Slip_Create?I=<?php echo base64_encode($individual_info->emp_id)?>&M=<?php echo base64_encode($individual_info->month)?>&Y=<?php echo base64_encode($individual_info->year)?>&S=<?php echo $individual_info->id?>" title="Generate" class="btn btn-sm btn-info waves-effect waves-light"><i class="fa fa-coy"></i>Generate Salary Slip</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
