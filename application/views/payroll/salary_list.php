                                    ...
                                    <table id="example4" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th>Department</th>
                                <?php if($this->session->userdata('user_type') == "SUPER ADMIN" || $this->session->userdata('user_type') == 'HR-PAY'){ ?>
                                                     <th colspan=""><button id="btn_save" type="submit" class="btn btn-info">Generate Salary</button></th>
                                                     <th class="hide"></th>
                                            ...
                                            <td colspan="">
                                                        ...
                                                        <input type="hidden" name="salary_id" value="<?php echo $individual_info->em_id; ?>" class="sid">
                                                         <?php if($this->session->userdata('user_type') == "SUPER ADMIN" ){ ?>
                                                            ...
                                                            <a href="delete_salary?I=<?php echo base64_encode($individual_info->emp_id) ?>" class="btn btn-info btn-sm" type="submit">Delete</a>
                                                   
                                                        <!-- <button class="btn btn-info btn-sm BtnDay" type="submit">Delete</button> | -->
                                                         <?php }?>
                                                         <a href="edit_bank_info?I=<?php echo base64_encode($individual_info->emp_id) ?>" class="btn btn-info btn-sm" type="submit">Edit</a>
                                                   
                                                </td>
                                                <td class="hide"></td>
                                         <?php }else{?>   <td colspan=""></td>
                                         <td class="hide"></td>
