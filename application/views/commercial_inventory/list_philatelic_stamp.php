        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"><i class="fa fa-list" aria-hidden="true"></i>   Philatelic Stamp List  </h4>
                </div>
                ...
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td> <?php echo  date('Y', strtotime($data->issuedate)) .' - '.date('Y', strtotime($data->enddate)); ?>  </td>
                                              ...
                                              <td> <?php echo number_format($data->pricepermint,2); ?> </td>
                                               <td> <?php echo number_format($data->pricepersouverantsheet,2); ?> </td>
                                               <td> <?php echo $data->priceperfdcover; ?> </td>
                    ...
                    <input class="form-control" type="text" name="denomination" value="<?php echo $data->denomination; ?>" required>
                    </div>
                    <div class="col-6">
                    ...
                    <input class="form-control" type="number" name="pricepersouverantsheet" value="<?php echo $data->pricepersouverantsheet; ?>" required>
                    </div>
                    <div class="col-6">
                    <label> Price Per F D Cover </label>
                    <input class="form-control" type="number" name="priceperfdcover" value="<?php echo $data->priceperfdcover; ?>" required>
                    </div>
                    </div>
