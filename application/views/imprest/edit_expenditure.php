                ...
                <div class="card card-outline-info">
					...
					<div class="card-body">
						<form action="<?php echo  base_url('imprest/add_expenditure')?>" method="post">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<input type="text" name="refference" class="form-control"
										   value="<?php echo $expenditure->refferences ?>" readonly="readonly">
								</div>
								<div class="col-md-6">
									<label>Date</label>
							...
							<div class="row m-t-40">
								<div class="col-md-12" style="padding-top: 15px;">
									<text>REF: <b>USER APPLICATION OF EXPENDITURE OF TSH.</b>
										<input type="number" name="amount_request" class="" style="border-top: 0px;border-left: 0px;border-right: 0px;width: 60%;font-size: 20px;" value="<?php echo $expenditure->app_exp; ?>">	</text>
								</div>

							</div>
							<div class="row m-t-20">
								<div class="col-md-12">
									<text style="font-size: 20px;">Kindly approve expendicture of the sum of &nbsp;
										<input type="number" name="exp_sum" class="" style="border-top: 0px;border-left: 0px;border-right: 0px;" value="<?php echo $expenditure->sum_exp; ?>">
										for &nbsp;<select name="expenditure_type" class="custom-select" style="border-top: 0px;border-left: 0px;border-right: 0px;width: 40%;"><option><?php echo $expenditure->exp_type; ?></option></option><option>Purchase</option><option>Travel</option></option><option>Cost</option></select>
										for &nbsp;<input type="text" class="form-control" name="for" style="border-top: 0px;border-left: 0px;border-right: 0px;font-size: 20px;" value="<?php echo $expenditure->exp_for; ?>"><br><br>
							...
							<div class="row">
								<div class="col-md-6">
									<text style="font-size: 20px;"><b>Regards</b></text><br><br>
