                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-hourglass-start" aria-hidden="true"></i> Imprest Susistence Request Form
                                </h4>
                            </div>
                    <div class="card-body">
							<div class="tab-pane" id="ims" role="tabpanel" enctype='multipart/form-data'>
									<div class="card">
										<div class="card-body">
			<form class="" action="save_imprest_request" method="post" enctype="multipart/form-data">
												<div class="row">
													<div class="form-group col-md-4 m-t-5">
														<label>Subsistence Allowance Rate per day</label>
														<input type="hidden" name="imp_id" value="<?php echo $imp_id;?>" class="form-control form-control-line" placeholder="Rate Per Day">

														<input type="number" name="subsistence_allowance" value="" class="form-control form-control-line" placeholder="Rate Per Day">
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-md-4 m-t-5">
														...
														<input type="text" name="leaving_date" value="" class="form-control form-control-line mydatetimepickerFull" placeholder="Date Of Leaving" required="required">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>Date Of Returning</label>
														<input type="text" name="date_returning" value="" class="form-control form-control-line mydatetimepickerFull" placeholder="Date Of Returning" required="required">
													</div>
													<div class="form-group col-md-4 m-t-5">
												...
												<div class="row">
													<div class="form-group col-md-12 m-t-5">
														<label>Reason</label>
														<textarea class="form-control" placeholder="Purpose of safari" name="safari_purpose" required="required"></textarea>
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-md-4 m-t-5">
														...
														<input type="number" name="days" class="form-control" style="" placeholder="Number of days" required="required">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>Subsistence Allowance Amount in Tsh.</label>
														<input type="number" name="sub_amount" class="form-control" style="" placeholder="Amount Tshs." required="required">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>Incidental Expenses Foreign 20%.</label>
														<input type="number" name="inc_amount" class="form-control" style="" placeholder="Amount Tshs." required="required">
													</div>
												</div>
												<div class="row">
													<div class="form-group col-md-4 m-t-5">
                                ...
                                <option>Air Ticket</option>              
													...
													<div class="form-group col-md-4 m-t-5">
														...
														<input type="number" name="fare_amount" class="form-control" style="" placeholder="Amount Tshs." required="required">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>AC/Code/Vote to be charged</label>
														<input type="number" name="vote_code" class="form-control" style="" placeholder="ACC/Code/Vote." required="required">
													</div>
													<div class="form-group col-md-4 m-t-5">
														<label>AC/Code/Vote to be charged Amount</label>
														<input type="number" name="vote_amount" class="form-control" style="" placeholder="Amount in Tsh." required="required">
													</div>
												</div>
												...
												<div class="row">
													<div class="form-group col-md-4 m-t-5">
														...
														<input type="number" name="letter_no" class="form-control" style="height: 45px;">
													</div>
													<div class="form-group col-md-4 m-t-5">
