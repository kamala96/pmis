...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row m-b-10">
                <div class="col-12">
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>parcel/air_mails_domestic_form" class="text-white"><i class="" aria-hidden="true"></i> Add Air Mails Transaction</a></button>
               
                     <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>parcel/air_mails_domestic_application_list" class="text-white"><i class="" aria-hidden="true"></i>  Air Mails Transactions List</a></button>
                </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <div class="card-body">
                        <form action="small_packet_sender_info" method="POST">
                        <div class="card">
                           ...
                           <div class="card-body">
                            <div id="div1">
                                ...
                                <div class="col-md-12">
                                    <h3>Step 1 of 4  - Air Mails Selection</h3>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="emsname" value="" class="form-control custom-select boxtype" required  onchange="functionParcel();">
                                            ...
                                            <option value="Aerogramme&Post  Cards">Aerogramme&Post  Cards</option>
                                            <option value="Printed Matter/Book Post">Printed matter & Book Post</option>
                                            <option value="News papers">News papers</option>
                                            <option value="Small packets/Sample/photocopy materials
">Small packets,  Sample,photocopy materials</option>
                                            <option value="Literature for the blind">Literature for the blind </option>
                                            <option value="Advertising Mail">Advertising Mail </option>
                                        </select>
                                <span id="error1" style="color: red;"></span>
                                </div>
                              <div class="col-md-6 weight1">
                                <label>Weight Step in gms:</label>
                            <input type="text" name="weight" class="form-control catweight" id="weight" onkeyup="getPriceFrom()">
                                ...
                                <div class="col-md-6 weight2" style="display: none;">
                                <label>Weight Step:</label>
                                <input type="text" name="weight" class="form-control" id="weight" value="Single without enclosure" readonly="readonly">
                                <span id="weight_error" style="color: red;"></span>
                                </div>
                                 <div class="col-md-6 weight3" style="display: none;">
                                <label>Weight Step:</label>
                                  <select name="weight" class="form-control custom-select">
                                    <option>Local delivery/unaddressed</option>
                                    <option>Local delivery/addressed</option>
                                    <option>Delivery in another town/unaddressed</option>
                                    <option>Delivery in another town/addressed</option>
                                  </select>
                                </div>
                                </div>
                                <br>
...
<script type="text/javascript">
  function functionParcel(){
    ...
    if( type == "Aerogramme&Post  Cards"){
      $('.weight2').show();
      $('.weight1').hide();
    }else if( type == "Advertising Mail"){
       $('.weight2').hide();
       $('.weight1').hide();
       $('.weight3').show();
    }else{
