...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
       <div class="row m-b-10">
                ...
                <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url() ?>parcel/air_mails_international_application_list" class="text-white"><i class="" aria-hidden="true"></i>  Air Mails Transactions List</a></button>

<?php }else{?>
                    <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>parcel/air_mails_international_form" class="text-white"><i class="" aria-hidden="true"></i> Add Air Mails Transaction</a></button>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Air Mail International Transaction List
                        </h4>
                    </div>
                    <div class="card-body" >
                      <div class="col-md-12">
                        <form action="air_mails_international_application_list" method="POST">
