                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="air_mails_tariff_domestic_form" class="text-muted m-b-0">Air Mails Domestic</a>
                                          <!-- <a href="air_mails_domestic_form" class="text-muted m-b-0">Air Mails Domestic</a> -->
                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="air_mails_international_form" class="text-muted m-b-0">Air Mails International</a>
                                        </div>
                                </div>
                            </div>
                        </div>
