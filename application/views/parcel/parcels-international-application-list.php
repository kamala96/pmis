...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Parcels International Transactions</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Parcels International Transactions</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> Parcels International Transactions List
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="table table-responsive">
                          ...
                          <?php }else{?>
                          <?php } ?>
                          <form action="international_parcel_list" method="POST">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value->billid;
                                      if(empty($value->billid)){
                                                ...
                                                $id = $value->senderp_id;
                                                $this->Box_Application_model->getControlNumberPAInter($serial,$amount,$id);
                                                echo $value->billid;
                                            }
                                     ?></td>
