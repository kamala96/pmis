                            ...
                            <div class="card-body">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <a href="<?php echo base_url()?>Ems_Domestic/Pcum" class="text-muted m-b-0">Cash</a>
                                ...
                                <div class="d-flex flex-row" >
                                    ...
                                    <div class="m-l-10 align-self-center">
                                        ...
                                        <?php if($this->session->userdata('user_type') == "SUPERVISOR" || $this->session->userdata('user_type') == "AGENT" || $this->session->userdata('user_type') == "EMPLOYEE" ){ ?>
                                           ...
                                           <a href="<?php echo base_url()?>Ems_Domestic/Pcum_Bill_Customer_List" class="text-muted m-b-0">Bill</a>

                                        <?php }else{ ?>

                                           <a href="<?php echo base_url()?>Ems_Domestic/Pcum_Bill_Customer" class="text-muted m-b-0">Bill</a>
