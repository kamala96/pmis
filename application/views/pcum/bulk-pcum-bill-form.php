        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-outline-info">
                    ...
                    <input type="hidden" name="AgreedWeight" id="AgreedWeight" class="form-control AgreedWeight" value="<?php echo @$custinfo->AgreedWeight; ?>">
                    <input type="hidden" name="Agreedprice" id="Agreedprice" class="form-control Agreedprice" value="<?php echo @$custinfo->Agreedprice; ?>">
                                ...
                                <div class="col-md-3 physical1" style="display: none;">
                                    <label><h4>Full Name:</h4></label>
                                     <input type="hidden" name="cust_id" class="form-control cust_id" id="cust_id" value="<?php echo @$custinfo->pcum_id; ?>">
                               ...
                               <!--  <div class="col-md-3 physical1" style="display: none;">
                                ...
                                <div class="row"><!--
                                    ...
                                    <div class="">
                                        ...
                                        <!-- <button class="btn btn-info btn-md disable" id="submitform" type="button">Save Information</button> -->
                                         ...
                                         <button type="button" class="btn btn-info btn-md"><a href="<?php echo base_url() ?>Ems_Domestic/Pcum_Bill_Customer_List" class="text-white"><i class="" aria-hidden="true"></i> Save Information</a></button>
                                ...
                                <div class="col-md-3 physical" style="display: none;">
                                    <label><h4>Full Name:</h4></label>
                                    <input type="text" name="s_fname" id="s_fname" class="form-control" value="<?php echo @$custinfo->cust_name; ?>">
                                     <span id="s_fnameerror" style="color: red;"></span>
                                </div>

                                <div class="col-md-3 physical" style="display: none;">
                                    <label><h4>Address:</h4></label>
                                    <input type="text" name="s_address" id="s_address" class="form-control"  value="<?php echo @$custinfo->cust_address; ?>">
...
var AgreedWeight  =  $('.AgreedWeight').val();
var Agreedprice  = $('.Agreedprice').val();
  ...
  var price  = Agreedprice;
  var vat = price * 18/100;
  var Total = +price + +vat;

    var result="<table style='width:100%;color:#c31f26;' class='table table-bordered'>"+
        ...
        $('#div2').show();
         ...
         $('#submitform').on('click',function(){ 
            $('.disable').attr("disabled", true);
             ...
             $.ajax({
                             type : "POST",
                             url  : "<?php echo base_url('Ems_Domestic/bil_save_bulk_pcum_info')?>",
                             //dataType : "JSON",
                     ...
                     // } 
                       ...
                       $('#submitform').hide();
                        $('#addmore').hide();
                            ...
                            $.ajax({
                             type : "POST",
                             url  : "<?php echo base_url('Ems_Domestic/pcum_bulk_bill_transactions_save')?>",
                             //dataType : "JSON",
                             data : {
                                weight:weight,
                                district1:district1,
                                ...
                                s_address:s_address,
                                s_mobile:s_mobile,
                                Agreedprice:Agreedprice,AgreedWeight:AgreedWeight,
                                s_mobilev:s_mobilev,
                                receiverselect:receiverselect,r_fname:r_fname,r_address:r_address,
                                    r_mobile:r_mobile,r_mobilev:r_mobilev,region_to:region_to,district:district,serial:serial,cust_id:cust_id},
                             success: function(data){
                                 $('#div6').show();
                                $('.list').html(data);
                                $('.price').html('');
                     ...
                     //$('.disable').attr("disabled", true);
                        ...
                        var district         = $('#rec_dropp').val();
                            ...
                            $.ajax({
                             ...
                             url  : "<?php echo base_url('Ems_Domestic/pcum_bulk_bill_transactions_save')?>",
                             //dataType : "JSON",
                             data : {weight:weight,district1:district1,zone:zone,city:city,Barcode:Barcode,
                senderselect:senderselect,s_fname:s_fname,s_address:s_address,s_email:s_email,s_mobile:s_mobile,Agreedprice:Agreedprice,AgreedWeight:AgreedWeight,
