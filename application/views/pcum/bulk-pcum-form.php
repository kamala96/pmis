                               ...
                               <!--  <div class="col-md-3 physical1" style="display: none;">
                                ...
                                <div class="row"><!--
                                    ...
                                    <div class="col-md-10">
                                     ...
                                     <div class="col-md-2">
                                        <h2>Counter: <span id="counterIterm">0</span></h2>
                                    </div>
                                </div>
                                </div>
                                <br>
                                    ...
                                    <div class ="list" style="font-weight: 60px;font-size: 18px;">
                                        <table style='width:100%;' class='table table-bordered'>
                                            <tr style='width:100%;color:#3895D3;'>
                                                ...
                                                <th><b>Destination District</b></th>
                                        ...
                                        <table style='width:100%;' class='table table-bordered'>
                                            <tr>
                                                <th style="text-align:right;" colspan="8">TSH 
                                                    <span id="totalAmount">0</span></th>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
...
function Deletevalue(obj) {
        ...
        $.ajax({
         ...
         data : {senderid:senderid,serial:serial,barcode:barcode,snTag:snTag},
         success: function(data){
...
$('#submitform').on('click',function(){
         ...
         $('#Oldsubmitform').on('click',function(){ 
            $('.disable').attr("disabled", true);
             $('#2stepBack').prop('disabled', true);
             $('#addmore').prop('disabled', true);
