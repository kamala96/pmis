                ...
                <div class="col-12">
                    ...
                    <table class="table" id="dynamic_field" style="height: 250px;"> 
                        ...
                        <td style="width: 400px;">
                            <label> [ Objective | KPA]</label>
                            <textarea name="Objective[]" class="form-control stid"  required="required" rows="10"></textarea>
                        </td>
                        <td style="width: 300px;">
                            <label>[ Goal | Target ]</label>
                            <textarea name="Goal[]" class="form-control stid"  required="required"  rows="10"></textarea>
                        ...
                        <td style="width: 400px;">
                            ...
                            <td>
                            <label>[ Weight ]</label>
                            <input type="text" name="Weight[]" class="form-control" required="required" style="width: 75px;"></td>
                            <td style="width: 300px;">
