...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> TAES SPECIAL TARIFF </h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">TAES SPECIAL TARIFF </li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> TAES SPECIAL TARIFF APPLICATION FORM                      
                        </h4>
                    </div>
                    <div class="card-body">
...
if (branch=="Tarakea(holoholo)" || branch=="Namanga" || branch=="Mtukula" || branch=="Tunduma" || branch=="Kyela" || branch=="Tanga-HPO"){
...
if (branch=="Tarakea(holoholo)" || branch=="Namanga" || branch=="Mtukula" || branch=="Tunduma" || branch=="Kyela" || branch=="Tanga-HPO" || branch=="Kyaka"){
