        ...
        <div class="row">
            <div class="col-12">
                ...
                <?php }?>
                            ...
                            <input type="number" name="weight" class="form-control catweight" id="weight" onkeyup="getPriceFrom()" required="required">
...
function getPriceFrom() {
  ...
  $.ajax({
                 type : "POST",
                 url  : "<?php echo base_url('Bill_Customer_tariff/embassy_italy_Ems_price')?>",
                 //dataType : "JSON",
                 data : {weight:weight,tariffCat:tariffCat,boxtype:boxtype},
...
<script type="text/javascript">
     ...
     $.ajax({
         type : 'POST',
         url  : '<?php echo base_url('Ems_Domestic/Olddelete_ems_document_bulk_info')?>',
                ...
                if (address == 'physical') {
                    ...
                    //  }
                        ...
                        var cbranch  = $('#cbranch').val();
                            ...
                            $.ajax({
                             type : "POST",
                             url  : "<?php echo base_url('Ems_Domestic/embassy_italy_document_parcel_bill_bulk_save')?>",
                             //dataType : "JSON",
