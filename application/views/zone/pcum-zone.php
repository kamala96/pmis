                    ...
                    <div class="card-body">
                        <div class="card">
                           ...
                           <!--  <?php if (!empty($zoneEdit->zone_id)) {?>
                            ...
                            <form action="<?php echo base_url('Organization/pcum_zone')?>" method="POST">
                                <div class="row">
                                <div class="col-md-6">
                                <div class="form-group">
                               ...
                               <div class="col-md-6">
                                <div class="form-group">
                                    <label>Tarrif</label>
                                    <input type="text" name="tarrif" class="form-control">
                                </div>
                               </div>
...
<script>  
 $(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td>'+' <input type="text" name="city[]" class="form-control">'+'</td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove1">Remove</button></td></tr>');  
      });  
