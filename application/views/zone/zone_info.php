...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Register Zones </h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Register Zones</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
                        ...
                        <div class="card">
                           ...
                           <div class="row">
                            ...
                            <?php if (!empty($zoneEdit->zone_id)) {?>
                                 <form action="<?php echo base_url('Organization/zone_info')?>" method="POST">
                                <div class="row">
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label>Ems Type</label>
                                    <select class="form-control custom-select" name="ems_type">
                                        <option><?php echo $zoneEdit->ems_type ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control custom-select" name="zone_name">
                                        <option><?php echo $zoneEdit->zone_name ?></option>
                                        <option>ZONE1</option>
                                        <option>ZONE2</option>
                                        <option>ZONE3</option>
                                        <option>ZONE4</option>
                               ...
                               <div class="col-md-6">
                                ...
                                <input type="text" name="weight_step" class="form-control" required="" value="<?php echo $zoneEdit->weight_step ?>">
                                </div>
                               </div>
                               <div class="col-md-6">
                                <div class="form-group">
                                    <label>Zone Tariff</label>
                                <input type="text" name="zone_tariff" class="form-control" required="" value="<?php echo $zoneEdit->zone_tariff ?>">
                                </div>
                               </div>
                               <div class="col-md-6">
                                <div class="form-group">
                                    <label>Zone Vat</label>
                                <input type="text" name="zone_vat" class="form-control" required="" value="<?php echo $zoneEdit->zone_vat ?>">
                                </div>
                               </div>
                               <div class="col-md-6">
                                <div class="form-group">
                                    <label>Zone Price</label>
                                <input type="text" name="zone_price" class="form-control" required="" value="<?php echo $zoneEdit->zone_price ?>">
                                </div>
                               </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                <div class="form-group">
                                    <input type="hidden" name="zone_id" value="<?php echo $zoneEdit->zone_id ?>">
                            ...
                            <form action="<?php echo base_url('Organization/zone_info')?>" method="POST">
                               ...
                               <div class="col-md-6">
                                <div class="form-group">
                                    <label>Weight Step (KG)</label>
                                <input type="text" name="weight_step" class="form-control" required="" >
                                </div>
                               </div>
                               <div class="col-md-6">
                                <div class="form-group">
                                    <label>Zone Tariff</label>
                                <input type="text" name="zone_tariff" class="form-control" required="">
                                </div>
                               </div>
                               <div class="col-md-6">
                                <div class="form-group">
                                    <label>Zone Vat</label>
                                <input type="text" name="zone_vat" class="form-control" required="">
                                </div>
                               </div>
                               <div class="col-md-6">
                                <div class="form-group">
                                    <label>Zone Price</label>
                                <input type="text" name="zone_price" class="form-control" required="">
                                </div>
                               </div>
                                </div>
                                <div class="row">
                                        ...
                                        <tbody class="results">
                                           <?php foreach($zone as $value): ?>
                                            <tr>
                                                ...
                                                <td><?php echo $value->weight_step;?></td>
                                                <td><?php echo $value->zone_tariff;?></td>
                                                <td><?php echo $value->zone_vat;?></td>
                                                <td><?php echo $value->zone_price;?></td>
                                                <td><?php echo $value->ems_type;?></td>
                                                <td style="text-align: right;"><a href="zone_info?I=<?php echo base64_encode($value->zone_id)?>" class="btn btn-warning btn-sm">Edit</a> | <a href="delete_zone?I=<?php echo base64_encode($value->zone_id)?>" class="btn btn-warning btn-sm">Delete</a> </td>
                                            </tr>
                                            <?php endforeach; ?>
