...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> Posta Mlangoni Bill Customer Registration</h3>
        </div>
        ...
        <div class="row m-b-10">
                <div class="col-12">
                    ...
                    <?php if($this->session->userdata('user_type') == "EMPLOYEE"){ ?>
                         <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Posta_Mlangoni/bill_customer_list?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Transactions Lists List</a></button>
                    <?php }if($this->session->userdata('user_type') == "ADMIN" || $this->session->userdata('user_type') == "ACCOUNTANT"){ ?>
                       ...
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Posta_Mlangoni/bill_transactions_list?AskFor=<?php echo @$askfor;?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Transactions List</a></button>
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        ...
                        Posta Mlangoni Bill Customer Registration Form                 
                        </h4>
                    </div>
            ...
            <form method="post" action="Customer_Register?AskFor=<?php echo @$askfor;?>">
                                ...
                                <div class="form-group col-md-4">
                                   ...
                                   <label>Services Type:</label>
								    <input type="text" name="service_type" class="form-control" required="required" value="<?php echo @$askfor;?>" readonly>
                                ...
                                <label>Payment Type:</label>
                                   <select class="form-control custom-select" name="payment_type" required="">
                                    <option value="<?php echo @$edit->customer_type; ?>"><?php echo @$edit->customer_type; ?></option>
