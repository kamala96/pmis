                    ...
                    <div class="card-body">
                        ...
                        <br />
                                ...
                                <div class="row"><!--
                                    <div class="col-md-6"></div> -->
                                    <div class="col-md-6">
                                    <input type="hidden" name="crdtid" id="crdtid" class="form-control crdtid" onkeyup="myFunction()" value="<?php echo @$custinfo->credit_id; ?>">
...
function validateBarcode(obj){
    ...
    if (barcode.length != 13) {
        ...
        $('#forMessage').show();
        $('#notifyMessage').html('Tafadhali barcode haijakamilika, Hakikisha Barcode inakuwa na tarakimu kumi na tatu (13)');
    }else{
        $.ajax({
            type : "POST",
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if ($('#trans').val() == 0) {
            ...
            $('#transerror').hide();
             ...
             if($('#boxtype').val() == 0){
                ...
                $('#r_addresserror').html('Please Input Reference');
            }
			else{
                $('#div2').show();
                $('#div1').hide();
        ...
        if ($('#boxtype').val() == 0) {
         $('#error1').html('Please Posta Mlangoni Category Type');
        }else{
            ...
            if ($('#tariffCat').val() == 0) {
               // $('#error2').html('Please Select Ems tariff Category Type');
                ...
                $('#r_addresserror').html('Please Input Reference is required');
            }
			else{
