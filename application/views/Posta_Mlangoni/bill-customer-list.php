            ...
            <div class="row m-b-10"> 
                <div class="col-12">
                    ...
                    <?php if($this->session->userdata('user_type') == "EMPLOYEE" || $this->session->userdata('user_type') == "AGENT" || $this->session->userdata('user_type') == "SUPERVISOR"){ ?>
                            ...
                            <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Posta_Mlangoni/register_bill_transaction_list?AskFor=<?php echo $billtype;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Transactions Lists</a></button>
                       
                         
                         <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Posta_Mlangoni/bill_customer_list?AskFor=<?php echo $billtype;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Customer List</a></button>
                    <?php }if($this->session->userdata('user_type') == "ADMIN" || $this->session->userdata('user_type') == "ACCOUNTANT"){ ?>

                       <button type="button" class="btn btn-primary"><i class="fa fa-plus"></i><a href="<?php echo base_url() ?>Posta_Mlangoni/bill_customer_form?AskFor=<?php echo $billtype;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Add Bill Customer</a></button>
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Posta_Mlangoni/bill_customer_list?AskFor=<?php echo $billtype;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Customer List</a></button>
                       <button type="button" class="btn btn-primary"><i class="fa fa-th-list"></i><a href="<?php echo base_url() ?>Posta_Mlangoni/bill_transactions_list?AskFor=<?php echo $billtype;  ?>" class="text-white"><i class="" aria-hidden="true"></i> Bill Transactions List  </a></button>
                            ...
                            <tr>
                                ...
                                <?php if( $this->session->userdata('user_type') == "EMPLOYEE"|| $this->session->userdata('user_type') == "SUPERVISOR" || $this->session->userdata('user_type') == "AGENT"){ ?>
                                 ...
                                 <?php if($value->customer_type == "PostPaid"){?>
                                  ...
                                  <a href="<?php echo base_url()?>Posta_Mlangoni/bill_domestic_bulk_form?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $billtype; ?>" class="btn btn-info">Services</a>
                                ...
                                <a href="<?php echo base_url()?>Posta_Mlangoni/Prepare_Customer_Bills?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $billtype;?>" class="btn btn-info">Genarate Bill</a>
                                ...
                                <?php } ?>
                                |
                                  <a href="<?php echo base_url()?>Posta_Mlangoni/bill_customer_form?I=<?php echo base64_encode($value->credit_id) ?>&&AskFor=<?php echo $this->session->userdata('askfor')?>" class="btn btn-info">Edit</a>
                                <?php }?> 
