...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <h3 class="text-themecolor"><i class="fa fa-clone" style="color:#1976d2"> </i> PostaMlangoni Post Domestic Application</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">PostaMlangoni Post Domestic</li>
            </ol>
        </div>
    </div>
    <!-- Container fluid  -->
            ...
            <div class="col-12">
                <div class="card card-outline-info">
                    <div class="card-header">
                        <h4 class="m-b-0 text-white"> PostaMlangoni Bill Post Application Form
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <!-- <div id="div1">
                               ...
                               <!--  <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                 ...
                                 <div class="form-group col-md-3">
                                    <label> PostaMlangoni Category Type</label>
                                    <select name="emsname" value="" class="form-control custom-select boxtype" id="boxtype" required  onchange="getPriceFrom();">
                                            <option value="0">--Select Category--</option>
								...
								<div class="form-group col-md-3">
                                    ...
                                    <select name="emsname" value="" class="form-control custom-select weighttype" id="weighttype" required  onchange="getPriceFrom();">
...
if (weight == '') {
    ...
    $.ajax({
                 ...
                 //dataType : "JSON",
                 data : {weight:weight,tariffCat:tariffCat,weighttype:weighttype},
...
if (weight == '') {
   ...
   $.ajax({
                 type : "POST",
                 url  : "<?php echo base_url('unregistered/postamlangoni_price')?>",
                 //dataType : "JSON",
                ...
                if (address == 'physical') {
                    ...
                    //        // $('.disable').attr("disabled", true);
                        ...
                        $.ajax({
                         ...
                         //dataType : "JSON",
                         data : {weight:weight,transport:transport,emsname:emsname,serial:serial,crdtid:crdtid,price:price,accno:accno,
