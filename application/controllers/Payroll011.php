  ...
  public function Save_Othersdecuction()
   ...
   public function Salary_List(){
    ...
    public function Payslip_Create1(){
        ...
        //Get Deductions
        $data['othersDeductions'] = $this->payroll_model->Others_Employee_Deduction($salary_id,$id);//others_deduction (float)$num
         ...
         foreach ($data['othersDeductions'] as $value) {
                ...
                $lastInstallement = $this->payroll_model->Others_Employee_Deduction_Permonth($installmentName,$salary_id);//loan_deduction
                    ...
                    if (!empty(@$lastInstallement) && intval(@$lastInstallement->others_amount)  <= 0 &&  @$lastInstallement->status != 'COMPLETE') {
                    ...
                    $this->payroll_model->update_others_amountDed($data,$salary_id,$installmentName);//others_id
                             ...
                             if(empty(@$lastInstallement->others_amount) &&  @$lastInstallement->status != 'COMPLETE'){
                             $dedu = array();
                    $dedu = array(
                    ...
                    'year'=>date('Y')
                        ...
                        else if(!empty(@$lastInstallement) && intval(@$lastInstallement->others_amount)  <= 0 &&  @$lastInstallement->status == 'COMPLETE')
                        {
                              $dedu = array(
                    ...
                    'year'=>date('Y')
                        ...
                        else if(!empty($lastInstallement->others_amount)&&  $lastInstallement->status != 'COMPLETE')
                        {
                             $dedu = array();
                    $dedu = array(
            ...
            if($lastInstallement->status != 'COMPLETE'){
                $this->payroll_model->insertOthersDeductionData($dedu);//loan_deduction
            }
...
public function Payed_Salary()
    ...
    public function Salary_Slip_Create(){
        ...
        $data['NonTaxAddition'] = @$this->payroll_model->getNonTaxAdditionss($id,$salary_id);
        ...
        //$data['LoanDeduction']= $this->payroll_model->getLoanDeduction2($salary_id,$month,$year);
         $data['LoanDeduction']= $this->payroll_model->getLoanDeduction21($salary_id,$month,$year,$id);
        ...
        $ded_type = $this->input->get('ded_type');
            ...
            if (!empty($ded_type)) {
             ...
             if (!empty($salary_info)) {
                ...
                <tr><th >S/N.</th><th>PF NO.</th><th>FULLNAME</th><th>Month</th><th>YEAR</th><th> EMPLOYEE CONTRIBUTION (5%)</th><th> EMPLOYER CONTRIBUTION (15%)</th></tr>
                </thead><tbody>";
                        $i=0;
                        $total = 0;
                  ...
                  echo "<tr><td></td><td></td><td></td><td></td><td></td><td><b>".number_format($total,2)."</b></td><td><b>".number_format($total*3,2)."</b></td></tr>";
                  echo "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
                 echo "<tr><td></td><td><b>Total ::</b></td><td><b>".number_format($total*4,2)."</b></td><td></td><td></td><td></td><td></td></tr>";
                  echo "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
                  echo "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
                  echo "<tr><td></td><td>Signature</td><td>-----------------------------</td><td></td><td></td><td></td><td></td></tr>";
                ...
                <thead>
                <tr><th></th><th></th><th  colspan=2> $ded_type REPORT</th><th></th><th> </th></tr>
                <tr><th >S/N.</th><th>PF NO.</th><th>FULLNAME</th><th>Month</th><th>YEAR</th><th> EMPLOYEE CONTRIBUTION (3%)</th><th> EMPLOYER CONTRIBUTION (3%)</th></tr>
                </thead><tbody>";
                        $i=0;
                        $total = 0;
                  foreach ($salary_info as $value) {
                     //$designation = $this->payroll_model->getdesignation1($value->des_id);
                        ...
                        echo "<tr><td>".$i."</td><td>"."PF.".$value->em_code."</td><td>$value->first_name"." "."$value->middle_name"." "."$value->last_name"."</td><td>$month</td><td>$year</td><td>".number_format($value->add_amount,2)."</td><td>".number_format(($value->add_amount),2)."</td></tr>";


                  }
                  echo "<tr><td></td><td></td><td></td><td></td><td></td><td><b>".number_format($total,2)."</b></td><td><b>".number_format($total,2)."</b></td></tr>";
                  echo "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
                 echo "<tr><td></td><td><b>Total ::</b></td><td><b>".number_format($total*2,2)."</b></td><td></td><td></td><td></td><td></td></tr>";
                  echo "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
                  echo "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
                  echo "<tr><td></td><td>Signature</td><td>-----------------------------</td><td></td><td></td><td></td><td></td></tr>";
                  echo "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";echo "<tr><td></td><td></td><td></td><td></td><td></td><td></td><td></td></tr>";
