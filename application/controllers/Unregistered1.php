	...
	public function Dashboard()
  {
    ...
    public function unregistered_form()
    {
        ...
        if ($this->session->userdata('user_login_access') == 1)
            ...
            if ($this->session->userdata('user_type') == "ADMIN" || $this->session->userdata('user_type') == "ACCOUNTANT") {
...
$rec_dropp = $answer->post_office;
            ...
            if ($askfor == "MAILS") {
              ...
              @$trackNo = $source->reg_code .$billcode.$billcode.$rondom;
              ...
              $receiver = array();
             $receiver = array('sender_id'=>$last_id,'r_address'=>$r_address,'receiver_region'=>$rec_region,'reciver_branch'=>$rec_dropp,'receiver_fullname'=>$r_fname,'receiver_mobile'=>$r_mobile,'add_type'=>$addressT);
              ...
              redirect(base_url('Bill_Customer/register_bill_transaction_list'));
     ...
     public function small_packet_sender_info()
    {
        ...
        if ($this->session->userdata('user_login_access') == 1){
            ...
            if (!empty($postbill->controlno)) {
                ...
                $data['sms'] = $sms ='KARIBU POSTA KINGANJANI umepatiwa nambari ya malipo hii hapa'. ' '.$postbill->controlno.' Kwaajili ya huduma ya Small Packets  ,Kiasi unachotakiwa kulipia ni TSH.'.number_format($paidamount,2);
            ...
            //if (!empty($transaction->$controlno)) {
                ...
                $data['sms'] = $sms ='KARIBU POSTA KINGANJANI umepatiwa nambari ya malipo hii hapa'. ' '.$repostbill->controlno.' Kwaajili ya huduma ya Small Packets  ,Kiasi unachotakiwa kulipia ni TSH.'.number_format($paidamount,2);
                $this->load->view('inlandMails/small-packets-control-number-form',$data);    
            }
        ...
        if ($this->session->userdata('user_login_access') == 1){
            ...
            if (!empty($check)) {
                ...
                if(!empty($this->input->post('shiftend'))){
                    ...
                    $data['list'] = $this->unregistered_model->search_register_application_list($date,$month,$status,$branch);
                    $data['sum']  = $this->unregistered_model->get_register_sum_search($date,$month,$status,$branch);
                  }
                   $this->load->view('inlandMails/register-application-list',$data);
                }
    ...
    public function parcel_post_sender_info()
    {
        ...
        if ($this->session->userdata('user_login_access') == 1){
            ...
            if (!empty($postbill->controlno)) {
                ...
                $data['sms'] = $sms ='KARIBU POSTA KINGANJANI umepatiwa nambari ya malipo hii hapa'. ' '.$postbill->controlno.' Kwaajili ya huduma ya Parcel Post  ,Kiasi unachotakiwa kulipia ni TSH.'.number_format($paidamount,2);
            ...
            //if (!empty($transaction->$controlno)) {
                ...
                $data['sms'] = $sms ='KARIBU POSTA KINGANJANI umepatiwa nambari ya malipo hii hapa'. ' '.$repostbill->controlno.' Kwaajili ya huduma ya Parcel Post  ,Kiasi unachotakiwa kulipia ni TSH.'.number_format($paidamount,2);
                $this->load->view('inlandMails/parcel-post-control-number-form',$data);    
            }
        ...
        if ($this->session->userdata('user_login_access') == 1){
            ...
            if (!empty($check)) {
                ...
                if(!empty($this->input->post('shiftend'))){
                    ...
                    $data['list'] = $this->unregistered_model->search_application_list($date,$month,$region,$branch);
                    $data['sum']  = $this->unregistered_model->get_parcel_post_sum_search($date,$month,$region,$branch);
                  }
...
$data1 = array();
            ...
            if ($transaction->controlno != '') {
                ...
                $this->Box_Application_model->save_location($data);
                 ...
                 $data['result'] ='KARIBU POSTA KINGANJANI umepatiwa nambari ya malipo hii hapa'. ' '.$transaction->controlno.' Kwaajili ya huduma ya Registered International,Kiasi unachotakiwa kulipia ni TSH.'.number_format($price,2);

                 $total ='KARIBU POSTA KINGANJANI umepatiwa nambari ya malipo hii hapa'. ' '.$transaction->controlno.' Kwaajili ya huduma ya Registered International,Kiasi unachotakiwa kulipia ni TSH.'.number_format($price,2);
