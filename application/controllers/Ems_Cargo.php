...
$rec_dropp = $answer->post_office;
            ...
            if (!empty($transaction)) {
                ...
                $data['sms'] = $total = $sms ='KARIBU POSTA KIGANJANI umepatiwa ankara namba'. ' '.@$transaction->controlno.' Kwaajili ya huduma ya EMS-CARGO,Kiasi unachotakiwa kulipia ni TSH.'.number_format($totalPrice,2);
                ...
                $data['sms'] = $total = $sms ='KARIBU POSTA KIGANJANI umepatiwa ankara namba'. ' '.@$transaction1->controlno.' Kwaajili ya huduma ya EMS-CARGO,Kiasi unachotakiwa kulipia ni TSH.'.number_format($totalPrice,2);
