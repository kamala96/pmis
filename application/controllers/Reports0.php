        ...
        if ($this->session->userdata('user_login_access') != false) {
                ...
                $rgeion = $this->input->post('region');
                            ...
                            $DomesticDocumentvat=$getReportDomesticDocument->Totalamount * 0.18;
                              $DomesticDocumentTotal=$getReportDomesticDocument->Totalamount -  $DomesticDocumentvat;
                               $DomesticDocumentvatexlusive=$getReportDomesticDocument->Totalamount;
                            ...
                            $getPARCELCHARGEStVAT=$getPARCELCHARGESt->Totalamount * 0.18;
                              $getPARCELCHARGEStOTAL=$getPARCELCHARGESt->Totalamount -  $getPARCELCHARGEStVAT;
                            ...
                            $getLOANBOARDVAT=$getLOANBOARD->Totalamount * 0.18;
                              $getLOANBOARDTOTAL=$getLOANBOARD->Totalamount -  $getLOANBOARDVAT;
                               $getLOANBOARDVATEXCLUSIVE=$getLOANBOARD->Totalamount;
                            ...
                            $NECTAVAT=$getNECTA->Totalamount * 0.18;
                              $NECTATOTAL=$getNECTA->Totalamount -  $NECTAVAT;
                               $NECTAVATEXCLUSIVE=$getNECTA->Totalamount;
                            ...
                            $getlocalbillvat=$getlocalbill->Totalamount * 0.18;
                              $getlocalbillTotal=$getlocalbill->Totalamount -  $getlocalbillvat;
                               $getlocalbillvatexlusive=$getlocalbill->Totalamount;
                            ...
                            $getlocalbillpayedvat=$getlocalbillpayed->Totalamount * 0.18;
                              $getlocalbillpayedTotal=$getlocalbillpayed->Totalamount -  $getlocalbillpayedvat;
                               $getlocalbillpayedvatexlusive=$getlocalbillpayed->Totalamount;
                            ...
                            $getgetEMS_INTERNATIONALdvat=$getEMS_INTERNATIONAL->Totalamount * 0.18;
                              $getgetEMS_INTERNATIONALTotal=$getEMS_INTERNATIONAL->Totalamount -  $getgetEMS_INTERNATIONALdvat;
                               $getgetEMS_INTERNATIONALvatexlusive=$getEMS_INTERNATIONAL->Totalamount;
                            ...
                            echo ' <table class="display  table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>'.$getReportDomesticDocument->Itemno.'</th>
                                                <td> '.number_format($DomesticDocumentvatexlusive).' </th>
                                                <td>'.number_format($DomesticDocumentvat).'</th>
                                                <td> '.number_format($DomesticDocumentTotal).' </th>
                                            </tr>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>'.$getPARCELCHARGESt->Itemno.'</th>
                                                <td> '.number_format($getPARCELCHARGESVATEXCLUSIVE).' </th>
                                                <td>'.number_format(0).'</th>
                                                <td> '.number_format($getPARCELCHARGEStOTAL).' </th>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>'.$getLOANBOARD->Itemno.'</th>
                                                <td> '.number_format($getLOANBOARDVATEXCLUSIVE).' </th>
                                                <td>'.number_format($getLOANBOARDVAT).'</th>
                                                <td> '.number_format($getLOANBOARDTOTAL).' </th>
                                            </tr>
                                             ...
                                             <tr>
                                                <td> </th>
                                                 <td> </th>
                                                <td> NECTA</th>
                                                <td>'.$getNECTA->Itemno.'</th>
                                                <td> '.number_format($NECTAVATEXCLUSIVE).' </th>
                                                <td>'.number_format($NECTAVAT).'</th>
                                                <td> '.number_format($NECTATOTAL).' </th>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td> Document/Parcel</th>
                                                <td>'.$getlocalbill->Itemno.'</th>
                                                <td>'.number_format($getlocalbillvatexlusive).' </th>
                                                <td>'.number_format($getlocalbillvat).'</th>
                                                <td> '.number_format($getlocalbillTotal).' </th>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td> Document/Parcel</th>
                                                <td>'.$getlocalbillpayed->Itemno.'</th>
                                                <td> '.number_format($getlocalbillpayedvatexlusive).' </th>
                                                <td>'.number_format($getlocalbillpayedvat).'</th>
                                                <td> '.number_format($getlocalbillpayedTotal).' </th>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td> Document/Parcel</th>
                                                <td>'.$getEMS_INTERNATIONAL->Itemno.'</th>
                                                <td> '.number_format($getgetEMS_INTERNATIONALvatexlusive).' </th>
                                                <td>'.number_format($getgetEMS_INTERNATIONALdvat).'</th>
                                                <td> '.number_format($getgetEMS_INTERNATIONALTotal).' </th>
                                            </tr>
                                             <tr>
                                                <th>  </th>
                                                 <th>  </th>
                                            ...
                                            <tr>
                                                ...
                                                <td> Document/Parcel</th>
                                                <td>'.$getEMS_INTERNATIONALBILL->Itemno.'</th>
                                                <td> '.number_format($getgetEMS_INTERNATIONALBILLvatexlusive).' </th>
                                                <td>'.number_format($getgetEMS_INTERNATIONALBILLdvat).'</th>
                                                <td> '.number_format($getgetEMS_INTERNATIONALBILLTotal).' </th>
                                            </tr>
                                            <tr>
                                                <td>6 </th>
                                             ...
                                             <tr>
                                              ...
                                              <tr>
                                                ...
                                                <td> <b>TOTAL</b></th>
                                                <td><b>'.$sumitem.'</b></th>
                                                 <td><b>'.number_format($sumvatexclusive).'</b></th>
                                                <td> <b>'.number_format($sumvat).' </b></th>
                                                <td><b> '.number_format($sumitotal).'</b> </th>
                                            </tr>
