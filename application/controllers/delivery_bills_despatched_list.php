...
<div class="col-lg-3 col-md-6">
    ...
    <tr>
    <td><a href='get_item_list?I=<?php echo base64_encode($value->bag_number); ?>'><?php echo $value->bag_number;?></a></td>
    <td><?php echo $value->bag_region_from; ?></td>
    <td><?php echo $value->bag_region; ?></td>
    <td><?php echo $value->date_created; ?></td>
    <td>
      <?php
      $bagno = $value->bag_number;
      echo $this->Box_Application_model->count_bags_desp_list($bagno); 
      ?>
    </td>
    <td><?php
    $id = $value->bag_received_by;
    $basicinfo = $this->employee_model->GetBasic($id); 
    echo  'PF'.@$basicinfo->em_code.' '. @$basicinfo->first_name.' '.@$basicinfo->last_name; ?>
    </td>
    </tr>
  <?php } ?>
            </tbody>
